...
function run(ctx = {}) {
    ...
    s.ok(
        ...
        /Directing Rule/.test(trajectoryDoc)
            ...
            && /Nawat\/Pipil may realize spelling through the orthography bridge/.test(trajectoryDoc)
            ...
            && /does not decide whether Andrews-licensed grammar logic can generate/.test(trajectoryDoc)
    ...
    s.eq(
        ...
        },
        {
            ...
            lesson4631a: {
                ...
                puzzleStackActions: [
                    ["#2 formula", "(mich-namaka)", "-0", "build the preterit predicate layer", "(mich-namaka-0)", "user-provided-nawat-letter-source", "preterit-predicate", "", "", "", "", ""],
                    ...
                    ["#3 salida", "(mich-namaka-0-ka-n)-0-", "surface", "realize formula boundaries in Nawat/Pipil spelling", "michnamakakan", "user-provided-nawat-letter-realization", "surface-output", "", "", "", "", ""],
                ],
    ...
    s.eq(
        ...
        [
            ...
            [2, "Andrews Lesson 2.1-2.16", "source-gated", "orthography-bridge-required"],
