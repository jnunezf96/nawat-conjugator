...
/**
 * Tests for src/core/concepts/concepts.mjs
 */
...
function run(ctx) {
    ...
    s.eq(
        "concept token classifier maps formula tokens without treating them as surfaces",
        {
            ...
            positionBoundary: ctx.classifyConceptToken("+"),
            subpositionBoundary: ctx.classifyConceptToken("-"),
        ...
        },
        {
            ...
            positionBoundary: {
                ...
                normalized: "+",
                matched: true,
                conceptId: "position-boundary",
                notationRole: "formula-position-boundary",
                concept: ctx.getConceptById("position-boundary"),
                generationAllowed: false,
                diagnostics: ["concept-token-diagnostic-only"],
            },
            subpositionBoundary: {
                ...
                normalized: "-",
                matched: true,
                conceptId: "subposition-boundary",
                notationRole: "formula-subposition-boundary",
                concept: ctx.getConceptById("subposition-boundary"),
                generationAllowed: false,
                diagnostics: ["concept-token-diagnostic-only"],
            },
            nnc: {
