...
function run() {
    ...
    s.ok(
        ...
        composer.includes("parseComposerOrdinaryNncAnalogueInput")
            ...
            && composer.includes('title: "clase t: (stem)t"')
            && composer.includes('title: "clase ti: (stem)ti"')
            && composer.includes('title: "clase in: (stem)in"')
            && composer.includes('title: "clase Ø: (stem)"')
