                  ...
                  >
                    ...
                    >
                      ...
                      <label class="classical-nnc-source-guide__field">
                        <span class="classical-nnc-source-guide__label">Canvas stem example</span>
                        <select
                          ...
                          disabled
                        >
                          <option value="">Type a nounstem or choose an example</option>
                  ...
                  >
                    ...
                    <div class="classical-rule-controls-grid">
                      <input
                        ...
                        value="7"
                      />
                      <div class="classical-nnc-authority-heading" data-classical-nnc-authority-heading="output" hidden aria-hidden="true">Output</div>
                      ...
                      <div class="classical-vnc-authority-heading" data-classical-vnc-authority-heading="output" hidden aria-hidden="true">Output</div>
                      ...
                      <label class="classical-rule-control" data-classical-nnc-authority-control="output" data-classical-nnc-authority-order="output-scope" hidden>
                      ...
                      <label class="classical-rule-control" data-classical-vnc-authority-control="output" data-classical-vnc-authority-order="output-scope" hidden>
                        <span class="classical-rule-control__label">Output scope</span>
                      ...
                      <label class="classical-rule-control" data-classical-vnc-authority-order="predicate-tense">
                        ...
                        >
                          <option value="present" data-classical-authority-option-tag="cn-option-tense-present">present</option>
                          <option value="preterit" data-classical-authority-option-tag="cn-option-tense-preterit" selected>preterit</option>
                      ...
                      <label class="classical-rule-control" data-classical-vnc-authority-order="predicate-voice">
                      ...
                      <label class="classical-rule-control" data-classical-vnc-authority-order="predicate-object">
                        ...
                        >
                          ...
                          <option value="specific-projective:2sg" data-classical-authority-option-tag="cn-option-object-specific-2sg" selected>specific 2sg</option>
                          <option value="specific-projective:3sg" data-classical-authority-option-tag="cn-option-object-specific-3sg">specific 3sg</option>
