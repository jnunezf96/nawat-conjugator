// core/grammar/frame.js
// Canonical LCM grammar frame contract. Existing route-specific metadata remains
// intact; this layer gives the engine and UI one shared shape to read.
...
var ANDREWS_CNV_NAWAT_EXTENSION_TENSES = Object.freeze([
...
function freezeAndrewsFormulaSlot(slot = {}) {
    return Object.freeze({
        ...
        blockedInterpretations: Object.freeze(
            normalizeGrammarFrameArray(slot.blockedInterpretations)
                .map((entry) => String(entry || "").trim())
                .filter(Boolean)
        ),
        diagnostics: Object.freeze(
            normalizeGrammarFrameArray(slot.diagnostics)
                .map((entry) => String(entry || "").trim())
                .filter(Boolean)
        ),
    });
...
function freezeAndrewsFormulaGenerationContract(contract = {}) {
    return Object.freeze({
        ...
        generationAllowed: typeof contract.generationAllowed === "undefined" || contract.generationAllowed === null
            ? null
            : contract.generationAllowed === true,
...
function freezeAndrewsFormulaSlotSchema(schema = {}) {
    return Object.freeze({
        ...
        hasTensePosition: schema.hasTensePosition === null
            ? null
            : schema.hasTensePosition === true,
        generationBoundary: String(schema.generationBoundary || ""),
        evidenceRefs: Object.freeze(
            normalizeGrammarFrameArray(schema.evidenceRefs)
                .map((entry) => String(entry || "").trim())
                .filter(Boolean)
        ),
        slots: Object.freeze(
            normalizeGrammarFrameArray(schema.slots)
                .map((slot) => freezeAndrewsFormulaSlot(slot))
        ),
        sourceRequirements: Object.freeze(
            normalizeGrammarFrameArray(schema.sourceRequirements)
                .map((requirement) => freezeAndrewsFormulaSourceRequirement(requirement))
        ),
        generationContract: freezeAndrewsFormulaGenerationContract(schema.generationContract),
        diagnostics: Object.freeze(
            normalizeGrammarFrameArray(schema.diagnostics)
                .map((entry) => String(entry || "").trim())
                .filter(Boolean)
        ),
    });
...
var ANDREWS_FORMULA_SLOT_SCHEMAS = Object.freeze({
    "vnc-shell": freezeAndrewsFormulaSlotSchema({
        ...
        slots: [
            { id: "boundary-open", key: "boundaryOpen", token: "#", label: "limite", role: "nuclear-boundary", owner: "shell", path: "shell.boundary.open", boundary: "open", layer: "shell", position: "edge" },
            { id: "pers1-pers2", key: "pers1Pers2", token: "pers1-pers2", label: "sujeto", role: "subject-person", owner: "subject", path: "subject.pers1-pers2", boundary: "outside-predicate", layer: "subject", position: "prefix" },
            { id: "va1-va2", key: "valence", token: "va1-va2", label: "valencia", role: "object-valence", owner: "predicate", path: "predicate.valence.va1-va2", boundary: "outside-stem", layer: "predicate", position: "pre-stem", leading: "+", blockedInterpretations: ["stem", "subject-connector", "subject-number-connector", "tense"] },
            { id: "STEM", key: "predicateStem", token: "STEM", label: "predicado", role: "predicate-stem", owner: "predicate", path: "predicate.stem", boundary: "inside-parentheses", layer: "predicate", position: "stem", wrapper: "parentheses", requiredForEcho: true },
            { id: "tns", key: "tensePosition", token: "tns", label: "tiempo", role: "tense", owner: "predicate", path: "predicate.tense", boundary: "outside-stem", layer: "predicate", position: "post-stem", blockedInterpretations: ["nnc-state", "subject-number-connector", "object-valence"] },
            { id: "num1-num2", key: "num1Num2", token: "num1-num2", label: "numero", role: "subject-number-connector", owner: "subject", path: "subject.num1-num2", boundary: "outside-predicate", layer: "subject", position: "suffix", leading: "+", blockedInterpretations: ["tense", "stem-suffix", "object-valence", "predicate-state"] },
            { id: "boundary-close", key: "boundaryClose", token: "#", label: "limite", role: "nuclear-boundary", owner: "shell", path: "shell.boundary.close", boundary: "close", layer: "shell", position: "edge" },
        ],
        diagnostics: [
            "Classical VNC spelling is structural evidence only.",
            "Displayed Nawat surfaces are orthography-bridge realizations of Andrews-licensed formula logic.",
        ],
    }),
    "ordinary-nnc-shell": freezeAndrewsFormulaSlotSchema({
        ...
        slots: [
            { id: "boundary-open", key: "boundaryOpen", token: "#", label: "limite", role: "nuclear-boundary", owner: "shell", path: "shell.boundary.open", boundary: "open", layer: "shell", position: "edge" },
            { id: "pers1-pers2", key: "pers1Pers2", token: "pers1-pers2", label: "sujeto", role: "subject-person", owner: "subject", path: "subject.pers1-pers2", boundary: "outside-predicate", layer: "subject", position: "prefix" },
            { id: "STEM", key: "predicateStem", token: "STEM", label: "predicado nominal", role: "predicate-stem", owner: "predicate", path: "predicate.stem", boundary: "inside-parentheses", layer: "predicate", position: "stem", wrapper: "parentheses", requiredForEcho: true },
            { id: "num1-num2", key: "num1Num2", token: "num1-num2", label: "conector de numero", role: "subject-number-connector", owner: "subject", path: "subject.num1-num2", boundary: "outside-predicate", layer: "subject", position: "suffix", emptyDisplay: "Ø", blockedInterpretations: ["tense", "stem-suffix", "nounstem", "predicate-state"], diagnostics: ["num1-num2 belongs to subject, not predicate", "ordinary NNC/S has no tense slot"] },
            { id: "boundary-close", key: "boundaryClose", token: "#", label: "limite", role: "nuclear-boundary", owner: "shell", path: "shell.boundary.close", boundary: "close", layer: "shell", position: "edge" },
        ],
        diagnostics: [
            "Predicate stem is inside parentheses.",
            "Subject connectors are outside parentheses.",
            "No tense slot is present in ordinary NNC/S.",
        ],
    }),
    "possessive-state-nnc": freezeAndrewsFormulaSlotSchema({
        ...
        slots: [
            { id: "boundary-open", key: "boundaryOpen", token: "#", label: "limite", role: "nuclear-boundary", owner: "shell", path: "shell.boundary.open", boundary: "open", layer: "shell", position: "edge" },
            { id: "pers1-pers2", key: "pers1Pers2", token: "pers1-pers2", label: "sujeto", role: "subject-person", owner: "subject", path: "subject.pers1-pers2", boundary: "outside-predicate", layer: "subject", position: "prefix" },
            { id: "st1-st2", key: "possessiveState", token: "st1-st2", label: "estado posesivo", role: "possessive-state", owner: "predicate", path: "predicate.state.st1-st2", boundary: "predicate-state", layer: "predicate", position: "pre-stem", leading: "+", blockedInterpretations: ["subject-connector", "tense"] },
            { id: "STEM", key: "predicateStem", token: "STEM", label: "nounstem", role: "predicate-stem", owner: "predicate", path: "predicate.stem", boundary: "inside-parentheses", layer: "predicate", position: "stem", wrapper: "parentheses", requiredForEcho: true },
            { id: "num1-num2", key: "num1Num2", token: "num1-num2", label: "numero del sujeto", role: "subject-number-connector", owner: "subject", path: "subject.num1-num2", boundary: "outside-predicate", layer: "subject", position: "suffix", emptyDisplay: "Ø", blockedInterpretations: ["tense", "stem-suffix", "nounstem", "predicate-state"] },
            { id: "boundary-close", key: "boundaryClose", token: "#", label: "limite", role: "nuclear-boundary", owner: "shell", path: "shell.boundary.close", boundary: "close", layer: "shell", position: "edge" },
        ],
        diagnostics: [
            "Possessive state belongs to the predicate.",
            "num1-num2 remains a subject connector.",
        ],
    }),
    "valence-object-slots": freezeAndrewsFormulaSlotSchema({
        ...
        slots: [
            { id: "va", key: "monadicValence", token: "va", label: "objeto no especifico", role: "monadic-valence", owner: "predicate", path: "predicate.valence.va", boundary: "outside-stem", layer: "predicate", position: "pre-stem" },
            { id: "va1-va2", key: "dyadicValence", token: "va1-va2", label: "objeto especifico", role: "dyadic-valence", owner: "predicate", path: "predicate.valence.va1-va2", boundary: "outside-stem", layer: "predicate", position: "pre-stem" },
            { id: "obj1", key: "objectMainline", token: "obj1", label: "mainline", role: "object-mainline", owner: "predicate", path: "predicate.object.mainline", boundary: "object-slot", layer: "predicate", position: "pre-stem" },
            { id: "obj2-obj3", key: "objectShuntline", token: "obj2/obj3", label: "shuntline", role: "object-shuntline", owner: "predicate", path: "predicate.object.shuntline", boundary: "object-slot", layer: "predicate", position: "pre-stem" },
        ],
    }),
    "subject-number-connectors": freezeAndrewsFormulaSlotSchema({
        ...
        slots: [
            { id: "pers1-pers2", key: "pers1Pers2", token: "pers1-pers2", label: "dyada de sujeto", role: "subject-person", owner: "subject", path: "subject.pers1-pers2", boundary: "outside-predicate", layer: "subject", position: "prefix", blockedInterpretations: ["predicate-state", "tense", "object-valence"] },
            { id: "predicate-side", key: "predicateSide", token: "(STEM)", label: "lado del predicado", role: "predicate-boundary", owner: "predicate", path: "predicate.side", boundary: "inside-or-adjacent-to-predicate", layer: "predicate", position: "middle" },
            { id: "num1-num2", key: "num1Num2", token: "num1-num2", label: "dyada de numero", role: "subject-number-connector", owner: "subject", path: "subject.num1-num2", boundary: "outside-predicate", layer: "subject", position: "suffix", emptyDisplay: "Ø", blockedInterpretations: ["tense", "stem-suffix", "nounstem", "object-valence", "predicate-state"] },
        ],
        diagnostics: [
            "pers1-pers2 and num1-num2 are subject dyads.",
            "num1-num2 is not tense, object valence, predicate state, or a stem suffix.",
            "VNC may add tns; CNN formulas remain tense-free.",
        ],
    }),
    "derivational-routes": freezeAndrewsFormulaSlotSchema({
        ...
        slots: [
            { id: "SOURCE", key: "sourceFormula", token: "SOURCE", label: "formula fuente", role: "source-formula", owner: "route", path: "route.source", boundary: "route-source", layer: "route", position: "source" },
            { id: "arrow-source-operation", key: "arrowSourceOperation", token: " -> ", label: "flecha", role: "route-boundary", owner: "route", path: "route.boundary.source-operation", boundary: "route-operation", layer: "route", position: "middle" },
            { id: "OP", key: "operation", token: "OP", label: "operacion", role: "derivational-operation", owner: "route", path: "route.operation", boundary: "route-operation", layer: "route", position: "middle" },
            { id: "arrow-operation-target", key: "arrowOperationTarget", token: " -> ", label: "flecha", role: "route-boundary", owner: "route", path: "route.boundary.operation-target", boundary: "route-target", layer: "route", position: "middle" },
            { id: "TARGET", key: "targetFormula", token: "TARGET", label: "formula destino", role: "target-formula", owner: "route", path: "route.target", boundary: "route-target", layer: "route", position: "target" },
        ],
    }),
    "compound-stems": freezeAndrewsFormulaSlotSchema({
        ...
        slots: [
            { id: "EMBED", key: "embeddedStem", token: "EMBED", label: "incluido", role: "embedded-stem", owner: "stem", path: "stem.embedded", boundary: "compound-left", layer: "stem", position: "left" },
            { id: "plus", key: "compoundPlus", token: " + ", label: "union", role: "compound-boundary", owner: "stem", path: "stem.boundary", boundary: "compound", layer: "stem", position: "middle" },
            { id: "MATRIX", key: "matrixStem", token: "MATRIX", label: "matriz", role: "matrix-stem", owner: "stem", path: "stem.matrix", boundary: "compound-right", layer: "stem", position: "right" },
            { id: "arrow", key: "compoundArrow", token: " -> ", label: "flecha", role: "compound-output-boundary", owner: "stem", path: "stem.output-boundary", boundary: "compound-output", layer: "stem", position: "middle" },
            { id: "COMPOUND", key: "compoundStem", token: "COMPOUND", label: "compuesto", role: "compound-stem", owner: "stem", path: "stem.compound", boundary: "compound-output", layer: "stem", position: "output" },
        ],
    }),
    "nominalizations": freezeAndrewsFormulaSlotSchema({
        ...
        slots: [
            { id: "CNV", key: "sourceCnv", token: "CNV", label: "fuente verbal", role: "source-formula", owner: "route", path: "route.source.cnv", boundary: "route-source", layer: "route", position: "source" },
            { id: "SOURCE_CORE", key: "sourceCore", token: "SOURCE_CORE", label: "nucleo fuente", role: "source-core", owner: "stem", path: "route.source.core", boundary: "inside-source", layer: "stem", position: "source-core", wrapper: "parentheses" },
            { id: "arrow", key: "nominalizationArrow", token: " -> ", label: "flecha", role: "route-boundary", owner: "route", path: "route.boundary", boundary: "route-operation", layer: "route", position: "middle" },
            { id: "CNN", key: "targetCnn", token: "CNN", label: "destino nominal", role: "target-formula", owner: "route", path: "route.target.cnn", boundary: "route-target", layer: "route", position: "target" },
            { id: "NOMINALIZED_STEM", key: "nominalizedStem", token: "NOMINALIZED_STEM", label: "tallo nominalizado", role: "target-stem", owner: "stem", path: "route.target.stem", boundary: "route-target", layer: "stem", position: "target", wrapper: "parentheses" },
        ],
    }),
    "personal-name-embedded-nnc": freezeAndrewsFormulaSlotSchema({
        ...
        slots: [
            { id: "boundary-open", key: "boundaryOpen", token: "#", label: "limite", role: "nuclear-boundary", owner: "outer-shell", path: "outer.boundary.open", boundary: "open", layer: "outer-shell", position: "edge" },
            { id: "pers1-pers2", key: "outerSubject", token: "pers1-pers2", label: "sujeto externo", role: "outer-subject", owner: "outer-shell", path: "outer.subject", boundary: "outside-predicate", layer: "outer-shell", position: "prefix" },
            { id: "INNER_CLAUSE", key: "innerClause", token: "INNER_CLAUSE", label: "clausula interna", role: "embedded-clause-stem", owner: "predicate", path: "predicate.inner-clause", boundary: "inside-parentheses", layer: "predicate", position: "stem", wrapper: "parentheses" },
            { id: "0-0", key: "outerNumber", token: "0-0", label: "numero externo", role: "outer-number", owner: "outer-shell", path: "outer.num1-num2", boundary: "outside-predicate", layer: "outer-shell", position: "suffix", blockedInterpretations: ["tense", "inner-subject"] },
            { id: "boundary-close", key: "boundaryClose", token: "#", label: "limite", role: "nuclear-boundary", owner: "outer-shell", path: "outer.boundary.close", boundary: "close", layer: "outer-shell", position: "edge" },
        ],
    }),
    "unsupported-route-diagnostics": freezeAndrewsFormulaSlotSchema({
        ...
        slots: [
            { id: "INPUT", key: "input", token: "INPUT", label: "entrada", role: "source-input", owner: "diagnostic", path: "diagnostic.input", boundary: "source", layer: "diagnostic", position: "source" },
            { id: "arrow-input-diagnostic", key: "diagnosticArrow", token: " -> ", label: "flecha", role: "diagnostic-boundary", owner: "diagnostic", path: "diagnostic.boundary", boundary: "gate", layer: "diagnostic", position: "middle" },
            { id: "DIAGNOSTIC_ONLY", key: "diagnosticOnly", token: "DIAGNOSTIC_ONLY", label: "diagnostico", role: "blocked-output", owner: "diagnostic", path: "diagnostic.output", boundary: "output", layer: "diagnostic", position: "output" },
        ],
    }),
});

function getAndrewsLogicAuthorityPolicy() {
    return { ...ANDREWS_LOGIC_AUTHORITY_POLICY };
}

function isAndrewsLogicGenerationAuthorityEnabled() {
    return ANDREWS_LOGIC_AUTHORITY_POLICY.grammarLogicDecidesGeneration === true
        && ANDREWS_LOGIC_AUTHORITY_POLICY.orthographyExamplesDecideGrammarLogic === false;
}
...
function getAndrewsCnvTenseLogicAuthorityFrame(tenseValue = "") {
    ...
    const directFrame = cloneAndrewsCnvTenseLogicAuthorityFrame(
        ANDREWS_CNV_TENSE_LOGIC_AUTHORITY_BY_TENSE[normalizedTense]
    );
    if (directFrame) {
        return directFrame;
    }
...
function getAndrewsCnvTenseLogicGenerationGateFrame(frameOrTense = "") {
    const frame = frameOrTense && typeof frameOrTense === "object"
        ? frameOrTense
        : getAndrewsCnvTenseLogicAuthorityFrame(frameOrTense);
...
function cloneAndrewsFormulaSlotSchema(schema = null) {
    ...
    return {
        ...
        sourceRequirements: Array.from(schema.sourceRequirements || []).map((requirement) => ({ ...requirement })),
        generationContract: { ...(schema.generationContract || {}) },
...
function getAndrewsFormulaSlotDefinition(schemaOrId = "", slotId = "") {
    ...
    return (schema.slots || []).find((slot) => (
        slot.id === normalizedSlotId
        || slot.key === normalizedSlotId
        || slot.path === normalizedSlotId
        || slot.token === normalizedSlotId
    )) || null;
}

function getAndrewsFormulaGenerationContract(schemaOrId = "") {
    const schema = resolveAndrewsFormulaSlotSchema(schemaOrId);
    return schema?.generationContract ? { ...schema.generationContract } : null;
}

function getAndrewsFormulaSourceRequirements(schemaOrId = "") {
    const schema = resolveAndrewsFormulaSlotSchema(schemaOrId);
    return Array.from(schema?.sourceRequirements || []).map((requirement) => ({ ...requirement }));
}
...
function renderAndrewsFormulaSlotTemplate(slot = null, options = {}) {
    ...
    const slotTokens = options?.slotTokens && typeof options.slotTokens === "object"
        ? options.slotTokens
        : {};
    const token = String(
        slotTokens[slot.key]
        || slotTokens[slot.id]
        || slotTokens[slot.path]
        || slot.token
        || slot.id
        || ""
    );
...
function isAndrewsFormulaSlotOmitted(slot = null, options = {}) {
    ...
    const omitted = new Set([
        ...normalizeGrammarFrameArray(options.omitSlots),
        ...normalizeGrammarFrameArray(options.omitSlotIds),
        ...normalizeGrammarFrameArray(options.omitSlotKeys),
        ...normalizeGrammarFrameArray(options.omitSlotPaths),
...
function getAndrewsFormulaEchoSlotValue(slot = null, slotValues = {}) {
    ...
    if (slot.key === "num1Num2" || slot.id === "num1-num2") {
        const connector = String(
            source?.displayDyad
            || source?.dyad
            || source?.fullConnector
            || source?.displayConnector
...
function evaluateAndrewsFormulaSourceRequirements(schemaOrId = "", {
    ...
    return {
        ...
        sourceRequirements: requirements.map((requirement) => ({ ...requirement })),
...
function evaluateAndrewsFormulaGenerationAuthority(schemaOrId = "", {
    ...
    const blockedReasons = [
        policyAllows ? "" : "andrews-logic-authority-disabled",
        contractAllows ? "" : "formula-contract-blocks-generation",
        sourceAllows ? "" : "formula-source-requirement-missing",
    ].filter(Boolean);
    return {
        ...
        status: generationAllowed
            ? (contract?.generationStatus || "generated")
            : (contract?.unsupportedWhenBlocked === false ? "diagnostic" : "blocked"),
        blockedReasons,
        policy,
...
function diagnoseAndrewsFormulaSlotInterpretation(schemaOrId = "", slotId = "", interpretation = "") {
    ...
    const blockedInterpretations = Array.isArray(slot?.blockedInterpretations)
        ? slot.blockedInterpretations
        : [];
    const blocked = Boolean(
        slot
        && normalizedInterpretation
        && blockedInterpretations.includes(normalizedInterpretation)
    );
    return {
...
function normalizeGrammarSurfaceForms(value = []) {
    return normalizeGrammarFrameArray(value)
        .map((entry) => normalizeGrammarSurfaceValue(entry))
        .filter(Boolean);
}
...
function buildGrammarFormulaRecord({
    ...
    return Object.freeze({
        ...
        operationFrames: Object.freeze(normalizeGrammarFrameArray(operationFrames)
            .map((entry) => normalizeGrammarFrameObject(entry))
            .filter(Boolean)),
...
function buildGrammarFormulaRealizationRecord({
    ...
    const normalizedSegments = Object.freeze(normalizeGrammarFrameArray(segmentFrames)
        .map(normalizeGrammarFormulaSegmentFrame)
        .filter(Boolean));
    const segmentSurface = normalizedSegments
        .map((segment) => normalizeGrammarSurfaceValue(segment.surface))
        .join("");
    const providedSurfaceForms = Array.isArray(surfaceForms) ? surfaceForms : [surfaceForms].filter(Boolean);
    const normalizedSurfaceForms = deriveSurfaceFromSegments
        ? (segmentSurface ? Object.freeze([segmentSurface]) : Object.freeze([]))
        : Object.freeze(normalizeGrammarSurfaceForms(
            providedSurfaceForms.length ? providedSurfaceForms : [surface || segmentSurface]
        ));
    const primarySurface = normalizedSurfaceForms[0] || "";
    if (!primarySurface && !normalizedSegments.length) {
        return null;
    }
    const resolvedFormulaRecordId = String(
        formulaRecordId
        || formulaRecord?.id
        || formulaRecord?.formula
        || ""
    );
    const segmentIdentity = normalizedSegments
        .map((segment) => [
            segment.slot,
            segment.role,
            segment.formulaValue,
            segment.operationId,
            segment.sourceFrameId,
...
function normalizeGrammarFormulaRecords(value = []) {
    return Object.freeze(normalizeGrammarCanonicalRecordList(value)
        .map((entry) => {
...
function getGrammarCanonicalSurfaceFormsFromRealizationRecords(records = []) {
    ...
    return normalizeGrammarSurfaceForms(forms)
...
function getGrammarResultFrameCanonicalSurfaceForms(frameResult = null) {
    ...
    const records = Array.isArray(frameResult.formulaRealizationRecords) && frameResult.formulaRealizationRecords.length
        ? frameResult.formulaRealizationRecords
        : (frameResult.formulaRealizationRecord ? [frameResult.formulaRealizationRecord] : []);
...
function getGrammarCanonicalFormulaSurfacePairsFromResultFrame(frameResult = null) {
    ...
    const formulaRecords = Array.isArray(frameResult.formulaRecords) && frameResult.formulaRecords.length
        ? frameResult.formulaRecords
        : (frameResult.formulaRecord ? [frameResult.formulaRecord] : []);
    ...
    const realizationRecords = Array.isArray(frameResult.formulaRealizationRecords) && frameResult.formulaRealizationRecords.length
        ? frameResult.formulaRealizationRecords
        : (frameResult.formulaRealizationRecord ? [frameResult.formulaRealizationRecord] : []);
    return Object.freeze(realizationRecords
        .map((record) => {
            if (!record || typeof record !== "object") {
                return null;
            }
            const formulaRecord = formulaById.get(String(record.formulaRecordId || "").trim())
                || formulaRecords[0]
                || null;
            const formulaText = String(formulaRecord?.formulaText || formulaRecord?.formula || "").trim();
            const surface = normalizeGrammarSurfaceValue(
                Array.isArray(record.surfaceForms) ? record.surfaceForms[0] : record.surface
            );
...
function buildGrammarAuthorityFrame({
    ...
    const resolvedSourceContext = normalizeGrammarFrameObject(sourceContext)
        || normalizeGrammarFrameObject(sourceEvidence);
    return {
...
function buildGrammarResultFrame({
    ...
    const providedFormulaRecords = Array.isArray(formulaRecords)
        ? formulaRecords
        : (formulaRecords ? [formulaRecords] : []);
    const providedFormulaRealizationRecords = Array.isArray(formulaRealizationRecords)
        ? formulaRealizationRecords
        : (formulaRealizationRecords ? [formulaRealizationRecords] : []);
    const normalizedFormulaRecords = normalizeGrammarFormulaRecords(
        providedFormulaRecords.length ? providedFormulaRecords : (formulaRecord ? [formulaRecord] : [])
    );
    const normalizedFormulaRealizationRecords = normalizeGrammarFormulaRealizationRecords(
        providedFormulaRealizationRecords.length
            ? providedFormulaRealizationRecords
            : (formulaRealizationRecord ? [formulaRealizationRecord] : [])
    );
    const canonicalSurfaceForms = getGrammarCanonicalSurfaceFormsFromRealizationRecords(normalizedFormulaRealizationRecords);
    const resolvedSurfaceForms = canonicalSurfaceForms.length
        ? canonicalSurfaceForms
        : normalizeGrammarSurfaceForms(surfaceForms);
    const normalizedSurface = normalizeGrammarSurfaceValue(
        surface || resolvedSurfaceForms[0]
    );
    return {
...
function getGrammarResultContractSurfaceForms({
    ...
    return forms
        .flatMap((entry) => splitGrammarResultContractSurfaceText(entry))
        .filter((entry, index, list) => entry && list.indexOf(entry) === index);
}
...
function buildGrammarResultContract({
    ...
    const frames = grammarFrame && typeof grammarFrame === "object"
        ? grammarFrame
        : (output.grammarFrame && typeof output.grammarFrame === "object"
            ? output.grammarFrame
            : (output.frames && typeof output.frames === "object" ? output.frames : null));
    const frameResult = frames?.resultFrame && typeof frames.resultFrame === "object"
        ? frames.resultFrame
        : null;
    const surfaceForms = getGrammarResultContractSurfaceForms({ output, frameResult });
    ...
    const frameOk = frameResult && typeof frameResult.ok === "boolean"
        ? frameResult.ok
        : null;
    const ok = frameOk === null
        ? Boolean(surface || surfaceForms.length) && output.error !== true && output.supported !== false
        : frameOk;
    const diagnostics = [
        ...(Array.isArray(output.diagnostics) ? output.diagnostics : []),
        ...(Array.isArray(frames?.diagnosticFrame?.diagnostics) ? frames.diagnosticFrame.diagnostics : []),
...
function normalizeGrammarDiagnosticContractEntries(entries = []) {
    const normalized = normalizeGrammarFrameArray(entries)
        .map((entry) => normalizeGrammarDiagnosticContractEntry(entry))
        .filter(Boolean);
...
function buildGrammarAstContractFrame(ast = null, options = {}) {
    ...
    const lessonRefs = normalizeGrammarFrameArray(options.andrewsRefs || node.andrewsRefs)
        .map((entry) => String(entry || "").trim())
        .filter(Boolean);
    const lessons = normalizeGrammarFrameArray(options.lessons || node.lessons || (node.lesson ? [node.lesson] : []))
        .map((entry) => String(entry || "").trim())
        .filter(Boolean);
    const resolvedRefs = lessonRefs.length
        ? lessonRefs
        : (structuralSource ? [structuralSource] : lessons.map((lesson) => `Andrews Lesson ${lesson}`));
...
function buildGrammarMetadataContractFrame(record = null, options = {}) {
    ...
    const supported = options.supported !== undefined
        ...
        : (node.supported === true || node.confirmed === true);
    const generationAllowed = options.generationAllowed !== undefined
        ? options.generationAllowed === true
        : node.generationAllowed === true;
    const structuralSource = String(options.structuralSource || node.structuralSource || "").trim();
    const lessonRefs = normalizeGrammarFrameArray(options.andrewsRefs || node.andrewsRefs)
        .map((entry) => String(entry || "").trim())
        .filter(Boolean);
    const lessons = normalizeGrammarFrameArray(options.lessons || node.lessons || (node.lesson ? [node.lesson] : []))
        .map((entry) => String(entry || "").trim())
        .filter(Boolean);
    const appendices = normalizeGrammarFrameArray(options.appendices || node.appendices || (node.appendix ? [node.appendix] : []))
        .map((entry) => String(entry || "").trim())
        .filter(Boolean);
    const resolvedRefs = lessonRefs.length
        ? lessonRefs
        : [
            ...(structuralSource ? [structuralSource] : lessons.map((lesson) => `Andrews Lesson ${lesson}`)),
            ...appendices.map((appendix) => `Andrews Appendix ${appendix}`),
        ];
    ...
    return buildGrammarFrame({
        ...
        morphBoundaryFrame: Object.prototype.hasOwnProperty.call(options, "morphBoundaryFrame")
            ...
            : normalizeGrammarFrameObject(node.boundary || (metadataKind.includes("boundary") ? node : null)),
...
function buildGrammarContractFormulaSurfacePairFields({
    ...
    if (Array.isArray(source.formulaSurfacePairs) && source.formulaSurfacePairs.length) {
        const pairs = source.formulaSurfacePairs
...
function resolveGrammarContractTargetFormulaEcho(node = null, options = null, grammarFrame = null) {
    ...
    return String(
        source.targetFormulaEcho
        || source.formulaEcho
        || source.structuralFormula
        || opts.targetFormulaEcho
        || opts.formulaEcho
        || opts.nuclearClauseFrame?.formulaEcho
        || opts.nuclearClauseFrame?.structuralFormula
        || grammarFrame?.nuclearClauseFrame?.formulaEcho
        || grammarFrame?.nuclearClauseFrame?.structuralFormula
        || grammarFrame?.resultFrame?.formulaEcho
        || ""
    ).trim();
}
...
function resolveGrammarContractFormulaSourceLabel(node = null, options = null, grammarFrame = null) {
    ...
    const routeFamily = String(
        opts.routeFamily
        || grammarFrame?.routeContract?.routeFamily
        || source.generationRoute
        || source.routeFamily
        || "grammar"
    ).trim();
