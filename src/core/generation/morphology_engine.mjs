...
export function createMorphologyEngineApi(targetObject = globalThis) {
    ...
    function getMorphologyApplicationSurfaceForms(result = null, fallbackSurface = "") {
      ...
      const canonicalForms = typeof targetObject.getGrammarResultFrameCanonicalSurfaceForms === "function" ? targetObject.getGrammarResultFrameCanonicalSurfaceForms(frameResult) : [];
      ...
      if (hasResultFrame) {
        return forms.map(entry => normalizeMorphologyApplicationSurfaceValue(entry)).filter(entry => entry && !entry.includes("/")).filter((entry, index, list) => entry && list.indexOf(entry) === index);
      }
    ...
    function applyMorphologyRules({
      ...
      const buildMorphologyValencyObjectSlotMutationGate = ({
        ...
        requireFixedValenceFrame = false
      } = {}) => {
        if (typeof targetObject.buildGenerationValencyObjectSlotMutationGate !== "function") {
          return null;
        }
        return targetObject.buildGenerationValencyObjectSlotMutationGate({
          operation,
          mutationKind,
          reason,
      ...
      const returnMorphologyValencyGateBlocked = (valencyObjectSlotGate = null) => attachMorphologyApplicationGrammarContract({
        error: true,
      ...
      if (isPatientivoAdjectiveProfile) {
        ...
        if (patientivoAdjectiveSource === "tronco-verbal" && isTransitive && !objectPrefix) {
          const patientiveAdjectiveTroncoDefaultingGate = buildMorphologyValencyObjectSlotMutationGate({
            operation: "patientive-adjective-tronco-object-slot-defaulting",
          ...
          if (patientiveAdjectiveTroncoDefaultingGate?.status === "blocked") {
            return returnMorphologyValencyGateBlocked(patientiveAdjectiveTroncoDefaultingGate);
          }
          objectPrefix = "ta";
        }
      ...
      if (tense === "patientivo") {
        ...
        if (patientivoSource === "tronco-verbal" && isTransitive && !objectPrefix) {
          const patientivoTroncoDefaultingGate = buildMorphologyValencyObjectSlotMutationGate({
            operation: "patientivo-tronco-object-slot-defaulting",
            mutationKind: "create-object-slot",
            targetObjectPrefix: "ta",
            targetBaseObjectPrefix: baseObjectPrefix,
            targetObj2: indirectObjectMarker,
          ...
          if (patientivoTroncoDefaultingGate?.status === "blocked") {
            return returnMorphologyValencyGateBlocked(patientivoTroncoDefaultingGate);
          }
          objectPrefix = "ta";
        }
      ...
      const derivedMuStemInteractionSourceFrame = targetObject.buildDerivedMuStemInteractionSourceFrame({
        obj1: objectPrefix,
        tronco: verb,
        alternateForms,
        enable: hasDerivedMuPrefix
      });
      const derivedMuStemInteractionOperationFrame = targetObject.buildDerivedMuStemInteractionOperationFrame(derivedMuStemInteractionSourceFrame);
      ({
        obj1: objectPrefix,
        tronco: verb
      ...
      if (tense === "calificativo-instrumentivo") {
        ...
        const implicitActionNounSourceSubjectPossessor = actionNounStemUse === "general-use" && !possessivePrefix;
        const resolvedSourceSubjectFrame = implicitActionNounSourceSubjectPossessor ? sourceSubjectFrame && typeof sourceSubjectFrame === "object" ? sourceSubjectFrame : typeof targetObject.buildAndrewsSourceSubjectFrame === "function" ? targetObject.buildAndrewsSourceSubjectFrame({
          subjectPrefix: baseSubjectPrefix,
          subjectSuffix: baseSubjectSuffix,
          sourceUnit: "CNV",
          sourceTense: combinedMode === "nonactive" ? "distant-past-passive" : "distant-past-active"
        }) : null : sourceSubjectFrame;
        const resolvedSourceSubjectPossessorOperationFrame = implicitActionNounSourceSubjectPossessor ? sourceSubjectPossessorOperationFrame && typeof sourceSubjectPossessorOperationFrame === "object" ? sourceSubjectPossessorOperationFrame : typeof targetObject.buildSourceSubjectPossessorOperationFrame === "function" ? targetObject.buildSourceSubjectPossessorOperationFrame({
        ...
        }) : null : sourceSubjectPossessorOperationFrame;
      ...
      if (tense === "instrumentivo") {
        ...
        const implicitInstrumentivoSourceSubjectPossessor = resolvedInstrumentivoMode === targetObject.INSTRUMENTIVO_MODE.posesivo && !possessivePrefix;
        const resolvedInstrumentivoSourceSubjectFrame = implicitInstrumentivoSourceSubjectPossessor ? sourceSubjectFrame && typeof sourceSubjectFrame === "object" ? sourceSubjectFrame : typeof targetObject.buildAndrewsSourceSubjectFrame === "function" ? targetObject.buildAndrewsSourceSubjectFrame({
          subjectPrefix: baseSubjectPrefix,
          subjectSuffix: baseSubjectSuffix,
          sourceUnit: "CNV",
          sourceTense: "imperfect-active"
        }) : null : sourceSubjectFrame;
        const resolvedInstrumentivoSourceSubjectPossessorOperationFrame = implicitInstrumentivoSourceSubjectPossessor ? sourceSubjectPossessorOperationFrame && typeof sourceSubjectPossessorOperationFrame === "object" ? sourceSubjectPossessorOperationFrame : typeof targetObject.buildSourceSubjectPossessorOperationFrame === "function" ? targetObject.buildSourceSubjectPossessorOperationFrame({
      ...
      if (targetObject.isPredicateNominalTense(tense)) {
        ...
        const predicateNominalConnectorOperationFrame = typeof targetObject.buildPredicateNominalConnectorOperationFrame === "function" ? targetObject.buildPredicateNominalConnectorOperationFrame({
      ...
      if (tense === "locativo-temporal") {
        ...
        if (locativoResult?.valencyObjectSlotGate?.status === "blocked") {
          return returnMorphologyValencyGateBlocked(locativoResult.valencyObjectSlotGate);
        }
      ...
      if (tense === "activo-no-finito") {
        const nonfiniteActiveValencyGate = buildMorphologyValencyObjectSlotMutationGate({
          operation: "nonfinite-active-object-slot-clearing",
          mutationKind: "delete-object-slots",
          targetObjectPrefix: "",
          targetBaseObjectPrefix: "",
          targetObj2: "",
        ...
        if (nonfiniteActiveValencyGate?.status === "blocked") {
          return returnMorphologyValencyGateBlocked(nonfiniteActiveValencyGate);
        }
        subjectPrefix = "";
        objectPrefix = "";
        subjectSuffix = "";
      ...
      if (tense === "activo-tronco-preterito" || tense === "activo-tronco-perfecto") {
        ...
        const activeWrapperSlotClearingGate = buildMorphologyValencyObjectSlotMutationGate({
          operation: isTroncoNajActiveWrapper ? "morphology-tronco-naj-active-wrapper-object-slot-clearing" : "morphology-tronco-tik-active-wrapper-object-slot-clearing",
          mutationKind: "delete-object-slots",
          targetObjectPrefix: "",
          targetBaseObjectPrefix: "",
          targetObj2: indirectObjectMarker,
        ...
        if (activeWrapperSlotClearingGate?.status === "blocked") {
          return returnMorphologyValencyGateBlocked(activeWrapperSlotClearingGate);
        }
      ...
      if (isPotencialNounLikeTense) {
        const potentialNounLikeValencyGate = buildMorphologyValencyObjectSlotMutationGate({
          operation: "potential-noun-like-object-slot-clearing",
          mutationKind: "delete-object-slots",
          targetObjectPrefix: "",
          targetBaseObjectPrefix: "",
          targetObj2: "",
        ...
        if (potentialNounLikeValencyGate?.status === "blocked") {
          return returnMorphologyValencyGateBlocked(potentialNounLikeValencyGate);
        }
        objectPrefix = "";
      }
