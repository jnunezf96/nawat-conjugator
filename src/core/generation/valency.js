...
const VNC_VALENCE_DYADIC_SPECS = Object.freeze({
    nech: Object.freeze({ id: "1sg-specific-object", key: "nech", andrewsStructural: "n-ech", nawatFormula: "n-ech", compactDisplay: "nech", surfacePrefix: "nech", trajectory: "projective", specificity: "specific", evidenceSource: "Andrews 6.4 + current Nawat object-prefix evidence" }),
    tech: Object.freeze({ id: "1pl-specific-object", key: "tech", andrewsStructural: "t-ech", nawatFormula: "t-ech", compactDisplay: "tech", surfacePrefix: "tech", trajectory: "projective", specificity: "specific", evidenceSource: "Andrews 6.4 + current Nawat object-prefix evidence" }),
    metz: Object.freeze({ id: "2sg-specific-object", key: "metz", andrewsStructural: "m-itz", nawatFormula: "m-etz", compactDisplay: "metz", surfacePrefix: "metz", trajectory: "projective", specificity: "specific", evidenceSource: "Andrews 6.4 + current Nawat object-prefix evidence" }),
    metzin: Object.freeze({ id: "2pl-specific-object", key: "metzin", andrewsStructural: "am-ech", nawatFormula: "m-etz-in", compactDisplay: "metzin", surfacePrefix: "metzin", trajectory: "projective", specificity: "specific", evidenceSource: "Andrews 6.4 + current Nawat object-prefix evidence" }),
    ki: Object.freeze({ id: "3sg-specific-object", key: "ki", andrewsStructural: "c-0/qu-0/qui-0", nawatFormula: "ki-0", compactDisplay: "ki", surfacePrefix: "ki", trajectory: "projective", specificity: "specific", evidenceSource: "Andrews 6.4 + current Nawat object-prefix evidence" }),
    k: Object.freeze({ id: "3sg-specific-object-before-vowel", key: "k", andrewsStructural: "c-0/qu-0/qui-0", nawatFormula: "k-0", compactDisplay: "k", surfacePrefix: "k", trajectory: "projective", specificity: "specific", evidenceSource: "Andrews 6.4 + current Nawat object-prefix allomorphy evidence" }),
    kin: Object.freeze({ id: "3pl-specific-object", key: "kin", andrewsStructural: "qu-im", nawatFormula: "k-in", compactDisplay: "kin", surfacePrefix: "kin", trajectory: "projective", specificity: "specific", evidenceSource: "Andrews 6.4 + current Nawat object-prefix evidence" }),
    mu: Object.freeze({ id: "mainline-reflexive-reciprocal", key: "mu", andrewsStructural: "m-o", nawatFormula: "m-u", compactDisplay: "mu", surfacePrefix: "mu", trajectory: "reflexive-reciprocative", specificity: "specific", evidenceSource: "Andrews 6.4 + current Nawat reflexive evidence" }),
});

const VNC_VALENCE_KNOWN_FORM_INPUTS = Object.freeze({
    nemi: Object.freeze({ stem: "nemi", kind: "intransitive", valence: "" }),
    nenki: Object.freeze({ stem: "nemi", kind: "intransitive", valence: "" }),
    nemik: Object.freeze({ stem: "nemi", kind: "intransitive", valence: "" }),
    taijpiya: Object.freeze({ stem: "ijpiya", kind: "monadic", valence: "ta" }),
    taijpishki: Object.freeze({ stem: "ijpiya", kind: "monadic", valence: "ta" }),
    taijpiyak: Object.freeze({ stem: "ijpiya", kind: "monadic", valence: "ta" }),
    taijpik: Object.freeze({ stem: "ijpiya", kind: "monadic", valence: "ta" }),
    kipiya: Object.freeze({ stem: "piya", kind: "dyadic", valence: "ki" }),
    kipishki: Object.freeze({ stem: "piya", kind: "dyadic", valence: "ki" }),
    kipiyak: Object.freeze({ stem: "piya", kind: "dyadic", valence: "ki" }),
});
...
function getVncValenceFormulaSchema() {
    return typeof getAndrewsFormulaSlotSchema === "function"
        ? getAndrewsFormulaSlotSchema(VNC_VALENCE_FORMULA_SCHEMA_ID)
        : null;
}

function getVncValenceFormulaSlotDefinition(slotId = "") {
    return typeof getAndrewsFormulaSlotDefinition === "function"
        ? getAndrewsFormulaSlotDefinition(VNC_VALENCE_FORMULA_SCHEMA_ID, slotId)
        : null;
}

function getVncValenceAndrewsLogicAuthorityPolicy() {
    return typeof getAndrewsLogicAuthorityPolicy === "function"
...
function normalizeVncValenceWorkbenchRawStemForSourceFrame(value = "") {
    ...
    return String(stemSource || "")
        .trim()
        .replace(/^[-#\s]+/g, "")
        .replace(/[#()]/g, "")
        .replace(/^(?:ne|te|ta|tla|ki|k|kin|nech|tech|metz|metzin|mu)[-\s]+/i, "")
        .trim();
}
...
function isVncValenceWorkbenchSourceFrame(frame = null) {
    return Boolean(frame && typeof frame === "object"
        && frame.kind === "vnc-valence-workbench-source-frame"
        && frame.consumesRenderedInput === false
        && frame.displayStringsAuthorizeGrammar === false);
}
...
function getVncValenceDyadicSpec(key = "ki", { stem = "", subjectPrefix = "" } = {}) {
    const normalized = String(key || "ki").trim().toLowerCase();
    const directFrame = typeof getLesson6DirectNawatObjectDyadFrame === "function"
        ? getLesson6DirectNawatObjectDyadFrame(normalized, {
            stem,
            pers1: subjectPrefix,
        })
        : null;
...
function buildVncValenceNumberSlot(connector = "zero") {
    ...
    const spec = VNC_VALENCE_NUMBER_CONNECTOR_SPECS[String(connector || "zero").trim()]
        || VNC_VALENCE_NUMBER_CONNECTOR_SPECS.zero;
    ...
    return {
        ...
        blockedInterpretations: Array.isArray(slotDefinition.blockedInterpretations)
            ...
            : ["tense", "stem-suffix", "object-valence", "predicate-state"],
    };
}
...
function buildVncValenceObjectSlot({
    ...
    if (normalizedKind === "intransitive") {
        return {
            ...
            blockedInterpretations: Array.isArray(slotDefinition.blockedInterpretations)
                ? Array.from(slotDefinition.blockedInterpretations)
                : ["stem", "subject-connector", "subject-number-connector", "tense"],
        };
    }
    const isMonadic = normalizedKind === "monadic";
    const spec = isMonadic
        ? getVncValenceMonadicSpec(valence)
        : getVncValenceDyadicSpec(valence, { stem, subjectPrefix });
...
function renderVncValenceFormulaTemplate(formulaSlots = null) {
    ...
    return renderAndrewsFormulaTemplate(VNC_VALENCE_FORMULA_SCHEMA_ID, {
        slotTokens: {
...
function buildVncValenceFormulaEchoFromSlots(formulaSlots = null, {
    ...
    const displayValence = mode === "compact"
        ? (valenceSlot.compactDisplay || valenceSlot.surfacePrefix || valenceSlot.nawatDisplay || valenceSlot.structuralDisplay || "")
        : (mode === "nawat"
            ? (valenceSlot.nawatDisplay || valenceSlot.nawatRealization || valenceSlot.compactDisplay || valenceSlot.structuralDisplay || "")
            : (valenceSlot.structuralDisplay || valenceSlot.andrewsStructural || valenceSlot.display || ""));
    const displayTense = mode === "structural"
        ? (tenseSlot.structuralDisplay || tenseSlot.andrewsStructural || tenseSlot.display || "0")
        : (tenseSlot.nawatDisplay || tenseSlot.nawatRealization || tenseSlot.compactDisplay || "Ø");
    const displayNumber = expanded
        ? (mode === "structural"
            ? (numberConnector.structuralDisplay || numberConnector.displayDyad || "0-0")
            : (numberConnector.nawatDisplay || numberConnector.nawatDyad || numberConnector.displayDyad || "Ø-Ø"))
        : (numberConnector.compactDisplay || numberConnector.surface || "Ø");
    const echoSlots = {
        ...formulaSlots,
    ...
    if (typeof renderAndrewsFormulaEchoFromSchema === "function") {
        return renderAndrewsFormulaEchoFromSchema(VNC_VALENCE_FORMULA_SCHEMA_ID, echoSlots);
    }
...
function buildVncValenceFormulaWorkbenchSlotRecords(schema = null, formulaSlots = {}) {
    ...
    return slots.map((slot) => {
        ...
        const renderedValue = omitted || missing
            ? ""
            : `${slot.leading || ""}${slot.wrapper === "parentheses" ? `(${structuralValue})` : structuralValue}${slot.trailing || ""}`;
        const token = slot.key === "valence" && !omitted
            ? (sourceSlot.formulaSlot || slot.token || slot.id || "")
            : (typeof renderAndrewsFormulaSlotTemplate === "function"
                ? renderAndrewsFormulaSlotTemplate(slot, omitted ? { omitSlots: ["valence", "va1-va2"] } : {})
        ...
        return {
            ...
            compactValue,
            renderedValue,
            compactRenderedValue: omitted || missing
                ? ""
            ...
            modelFields: [
                ...
                ...(slot.key === "valence" ? [
                    { label: "Andrews", value: structuralValue || "omitted" },
                    { label: "Nawat", value: nawatValue || "omitted" },
                    { label: "kind", value: sourceSlot.valenceKind || "intransitive" },
                    { label: "not", value: "stem/subject/tense" },
                ] : []),
                ...(slot.key === "tensePosition" ? [
                    { label: "VNC-only", value: "true" },
                    { label: "not", value: "CNN/CNN posesiva" },
                ] : []),
                ...(slot.key === "num1Num2" ? [
                    { label: "dyad", value: structuralValue },
                    { label: "not", value: "tense/object" },
                ] : []),
...
function buildVncValenceExample({
    ...
    const normalizedStem = isVncValenceWorkbenchSourceFrame(sourceFrame)
        ? (String(sourceFrame.predicateStem || "") || "nemi")
        : "nemi";
    ...
    const structuralFormulaEcho = buildVncValenceFormulaEchoFromSlots(formulaSlots, { mode: "structural", expanded: true });
    const nawatFormulaEcho = buildVncValenceFormulaEchoFromSlots(formulaSlots, { mode: "nawat", expanded: true });
    const compactFormulaEcho = buildVncValenceFormulaEchoFromSlots(formulaSlots, { mode: "compact", expanded: false });
...
function buildVncValenceAndrewsLogicTargetSegmentFrames(formulaSlots = null) {
    ...
    const valencePrefix = kind === "intransitive"
        ? ""
        : normalizeVncValenceFormulaSurfacePart(
            valenceSlot.surfacePrefix
            || valenceSlot.nawatRealization
            || valenceSlot.nawatDisplay
        );
...
function getVncValenceTargetSurfaceFromSegmentFrames(targetSegmentFrames = []) {
    ...
    return targetSegmentFrames
        .map((frame) => String(frame?.surface || ""))
        .join("");
}
...
function getVncValenceFormulaSlotSignature(formulaSlots = null) {
    ...
    return targetSegmentFrames
        .map((frame) => `${frame.slot}:${frame.role}:${frame.surface}:${frame.formulaValue || ""}:${frame.valenceKind || ""}:${frame.valenceKey || ""}`)
        .join("|");
}
...
function getVncValenceAndrewsLogicSurfaceFrameMismatch({
    ...
    if (
        operationFrame.operationId !== "andrews-vnc-valence-slot-surface-realization"
        || operationFrame.routeFamily !== "vnc-valence"
        || operationFrame.operationApplied !== "realize-vnc-valence-formula-slots"
...
function getVncValenceAndrewsLogicSurfaceForSlots(formulaSlots = null, {
    ...
    void formulaSlots;
    const mismatch = getVncValenceAndrewsLogicSurfaceFrameMismatch({ sourceFrame, operationFrame });
    if (mismatch) {
        return "";
    }
...
function getVncValenceScopedNumberConnector({
    ...
    if (
        (normalizedKind === "intransitive" && normalizedStem === "nemi")
        || (normalizedKind === "monadic" && normalizedValence === "ta" && normalizedStem === "ijpiya")
        || (normalizedKind === "dyadic" && normalizedValence === "ki" && normalizedStem === "piya")
    ) {
        return "preterit3sg";
    }
    return "zero";
...
function buildVncValenceFormulaWorkbenchSlice({
    ...
    const normalizedStem = isVncValenceWorkbenchSourceFrame(sourceFrame)
        ? String(sourceFrame.predicateStem || "")
        : "";
    const blockedReason = parsedSelection.kind === "blocked"
        ? "Object combination is diagnostic-only until the valence route is explicitly supported by Andrews slot logic."
        : "";
    ...
    const sourceRequirementCheck = typeof evaluateAndrewsFormulaSourceRequirements === "function"
        ? evaluateAndrewsFormulaSourceRequirements(VNC_VALENCE_FORMULA_SCHEMA_ID, {
        ...
        : {
            ...
            missingRequirements: normalizedStem ? [] : [{ id: "vnc-predicate-stem" }],
            satisfiedRequirements: normalizedStem ? [{ id: "vnc-predicate-stem" }] : [],
        };
    const structuralFormulaEcho = buildVncValenceFormulaEchoFromSlots(formulaSlots, { mode: "structural", expanded: true });
    const nawatFormulaEcho = buildVncValenceFormulaEchoFromSlots(formulaSlots, { mode: "nawat", expanded: true });
    const compactFormulaEcho = buildVncValenceFormulaEchoFromSlots(formulaSlots, { mode: "compact", expanded: false });
    const slotBlockDiagnostics = [
        ["vnc-shell", "va1-va2", "stem"],
        ["vnc-shell", "va1-va2", "tense"],
        ["vnc-shell", "tns", "subject-number-connector"],
        ["ordinary-nnc-shell", "num1-num2", "tense"],
        ["possessive-state-nnc", "st1-st2", "tense"],
    ...
    const andrewsLogicSurfaceSourceFrame = buildVncValenceAndrewsLogicSurfaceSourceFrame({ formulaSlots });
    const andrewsLogicSurfaceOperationFrame = buildVncValenceAndrewsLogicSurfaceOperationFrame(
    ...
    const generationStatusWhenAllowed = scopedEvidenceSurface
        ? "generated-scoped"
        : "andrews-logic-generated";
    const generationAllowed = Boolean(
        normalizedStem
        && sourceRequirementCheck.ok
        && !blockedReason
        && generationSurface
    );
    const generationStatus = !normalizedStem
        ? "blocked"
        : (blockedReason ? "unsupported" : (generationAllowed ? generationStatusWhenAllowed : "blocked"));
    return {
        ...
        formulaFamilies: [
            {
                ...
                formula: typeof renderAndrewsFormulaTemplate === "function"
                    ? renderAndrewsFormulaTemplate(VNC_VALENCE_FORMULA_SCHEMA_ID, { omitSlots: ["valence", "va1-va2"] })
            ...
            },
            {
                ...
                label: "monadic",
                formula: typeof renderAndrewsFormulaTemplate === "function"
                    ? renderAndrewsFormulaTemplate(VNC_VALENCE_FORMULA_SCHEMA_ID, { slotTokens: { valence: "va" } })
            ...
            },
            {
                ...
                label: "dyadic",
                formula: typeof renderAndrewsFormulaTemplate === "function"
                    ? renderAndrewsFormulaTemplate(VNC_VALENCE_FORMULA_SCHEMA_ID, { slotTokens: { valence: "va1-va2" } })
        ...
        evidenceRefs: [
            ...
            "Andrews formula inventory: VNC valence/object slots",
            ...(scopedEvidenceSurface ? ["data/basic-data.csv scoped preterit examples"] : []),
        ].filter(Boolean),
        realizationBoundary: {
            structuralFormulaEcho,
            nawatFormulaEcho,
...
function buildVncShellFormulaWorkbenchSlice({
    ...
    const tenseSlot = (Array.isArray(slice.parsedSlots) ? slice.parsedSlots : [])
        .find((slot) => slot.key === "tensePosition") || null;
    const numberSlot = (Array.isArray(slice.parsedSlots) ? slice.parsedSlots : [])
        .find((slot) => slot.key === "num1Num2") || null;
    return {
        ...slice,
        kind: "vnc-shell-formula-workbench-slice",
        formulaSchemaId: "vnc-shell",
        formula: slice.formula || (typeof renderAndrewsFormulaTemplate === "function"
            ? renderAndrewsFormulaTemplate("vnc-shell", { omitSlots: ["valence", "va1-va2"] })
            : "#pers1-pers2(STEM)tns+num1-num2#"),
        sourceMaterial: {
        ...
        evidenceRefs: [
            ...
            "Andrews 5.1-5.3",
            "Andrews 6.1-6.4",
            ...(Array.isArray(slice.evidenceRefs) ? slice.evidenceRefs : []),
        ...
        diagnostics: [
            ...(Array.isArray(slice.diagnostics) ? slice.diagnostics : []),
            {
...
function buildLesson22ImpersonalVoicePursuitFrame() {
    ...
    const remainingGaps = [
        ...
        "Inherent impersonal verb inventory and nonanimate-versus-impersonal subject interpretation require modeled Andrews source classes and sentence metadata.",
        ...
        "Andrews 22.5 sentence moods and 22.6 derivational ta-impersonal inventory remain diagnostic or source-gated.",
    ];
    const frame = {
...
function isGenerationValencyObjectOrFusionPrefix(prefix = "") {
    ...
    return (
        ...
        || ["k", "ki", "kin", "nech", "metz", "tech", "mech", "te", "ta", "mu", "m", "t"].includes(normalized)
    );
}
...
function generationValencyEntradaGrammarObjectHasValenceObjectSignal(entradaGrammarObject = null) {
    ...
    const valenceFrame = entradaGrammarObject.valenceFrame && typeof entradaGrammarObject.valenceFrame === "object"
        ? entradaGrammarObject.valenceFrame
        : {};
    const objectFrame = entradaGrammarObject.objectFrame && typeof entradaGrammarObject.objectFrame === "object"
        ? entradaGrammarObject.objectFrame
        : {};
    return Boolean(
        objectFrame.hasObjectSlots === true
        || (Array.isArray(objectFrame.slots) && objectFrame.slots.length > 0)
        || (Array.isArray(valenceFrame.slots) && valenceFrame.slots.length > 0)
        || (Array.isArray(valenceFrame.tokens) && valenceFrame.tokens.length > 0)
    );
}
...
function generationValencyFrameHasFixedValenceEvidence(frame = null) {
    ...
    return Boolean(
        ...
        || frame.participantFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.participantFrame?.valenceFrame?.frameFixed === true
        || frame.participantFrame?.valenceFrame?.valenceFrameFixed === true
        || frame.routeFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.sourceRouteFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.incorporationRouteFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.routeContract?.sourceContract?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.routeContract?.targetContract?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.routeContract?.sourceContract?.routeFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.routeContract?.targetContract?.routeFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.routeContract?.sourceContract?.sourceRouteFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.routeContract?.targetContract?.sourceRouteFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.sourceContract?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.targetContract?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.sourceContract?.routeFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.targetContract?.routeFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.sourceContract?.sourceRouteFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.targetContract?.sourceRouteFrame?.objectSlotOwnership?.matrixValenceFrameFixed === true
    );
}
...
function generationValencyFrameHasValenceObjectSignal(frame = null) {
    ...
    return Boolean(
        String(frame.kind || "") === "andrews-incorporation-route-frame"
        || String(frame.matrixValence || "").trim()
        || String(frame.consumedObjectSlot || "").trim()
        || frame.routeFrameLicensesObjectSlotOwnership === true
        || frame.routeFrameLicensesObjectSlotOwnership === false
        || hasSlots(
            frame.remainingExternalObjectSlots,
            frame.sourceExternalObjectSlots,
            frame.objectSlotOwnership?.remainingExternalObjectSlots,
            frame.objectSlotOwnership?.sourceExternalObjectSlots,
            frame.participantFrame?.objectSlotOwnership?.remainingExternalObjectSlots,
            frame.participantFrame?.objectSlotOwnership?.sourceExternalObjectSlots,
            frame.routeFrame?.remainingExternalObjectSlots,
            frame.sourceRouteFrame?.remainingExternalObjectSlots,
            frame.incorporationRouteFrame?.remainingExternalObjectSlots,
            frame.routeContract?.sourceContract?.routeFrame?.remainingExternalObjectSlots,
            frame.routeContract?.targetContract?.routeFrame?.remainingExternalObjectSlots,
            frame.routeContract?.sourceContract?.sourceRouteFrame?.remainingExternalObjectSlots,
            frame.routeContract?.targetContract?.sourceRouteFrame?.remainingExternalObjectSlots,
            frame.sourceContract?.routeFrame?.remainingExternalObjectSlots,
            frame.targetContract?.routeFrame?.remainingExternalObjectSlots,
            frame.sourceContract?.sourceRouteFrame?.remainingExternalObjectSlots,
            frame.targetContract?.sourceRouteFrame?.remainingExternalObjectSlots
        )
        || frame.objectSlotOwnership?.matrixValenceFrameFixed === true
        || frame.objectSlotOwnership?.matrixValenceFrameFixed === false
        || frame.participantFrame?.valenceFrame
        || frame.participantFrame?.object
        || frame.routeContract?.sourceContract?.valenceFrame
        || frame.routeContract?.targetContract?.valenceFrame
        || frame.sourceContract?.valenceFrame
        || frame.targetContract?.valenceFrame
    );
}
...
function getGenerationValencyFrameCandidates(options = {}) {
    ...
    return [
        ...
        source.grammarFrame,
        source.frames,
        source.participantFrame,
        source.sourceRouteFrame,
        source.routeFrame,
        source.incorporationRouteFrame,
        source.objectSlotOwnership,
        source.routeContract,
        source.sourceContract,
        source.targetContract,
        source.grammarFrame?.participantFrame,
        source.grammarFrame?.routeContract,
        source.grammarFrame?.routeContract?.sourceContract,
        source.grammarFrame?.routeContract?.targetContract,
        source.frames?.participantFrame,
        source.frames?.routeContract,
        source.frames?.routeContract?.sourceContract,
        source.frames?.routeContract?.targetContract,
        source.routeContract?.sourceContract,
        source.routeContract?.targetContract,
...
function buildGenerationValencyObjectSlotMutationGate({
    ...
    const mutatesObjectSlot = normalizedSourceObj1 !== normalizedTargetObj1
        || normalizedSourceBaseObj1 !== normalizedTargetBaseObj1
        || normalizedSourceObj2 !== normalizedTargetObj2
        || normalizedSourceObj3 !== normalizedTargetObj3;
    ...
    const status = mutatesObjectSlot && requiresFixedValenceFrame && !valenceFrameFixed
        ? "blocked"
        : "pass";
    return {
        ...
        reason: status === "blocked"
            ? "generation-valency-source-frame-unfixed"
            : String(reason || "generation-valency-object-slot-mutation-licensed"),
...
function applyBoundMarkerSlotOverrides(parsedVerb, obj1 = "", baseObj1 = "", options = {}) {
    ...
    const dropOccupiedSourceObjectPrefix = !preserveOccupiedSourceObjectPrefix
        && shouldDropOccupiedSourceObjectPrefix(parsedVerb);
    const shouldDrop = dropBoundObjectPrefix || dropOccupiedSourceObjectPrefix;
    const reason = dropBoundObjectPrefix
        ? "bound-marker-owns-object-slot"
        : (dropOccupiedSourceObjectPrefix ? "occupied-source-object-slot" : "");
