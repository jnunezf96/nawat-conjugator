...
const ANALYSIS_ANTI_CONFLATION_RULES = Object.freeze([
...
const LESSON57_ANALYSIS_PDF_REFS = Object.freeze([
    "Andrews Lesson 57.1",
    "Andrews Lesson 57.2",
    "Andrews Lesson 57.3",
    "Andrews Lesson 57.4",
...
const LESSON57_ANALYSIS_VALIDATION_REFS = Object.freeze([
    "src/tests/analysis.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const LESSON57_ANALYSIS_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({
        range: "57.1",
...
function buildLesson57AnalysisPursuitFrame() {
    ...
    return {
        ...
        curriculumRef: { source: "Andrews", range: "57.1-57.7", role: "plan-pursue-step" },
        stepNumber: 57,
        aimStatus: "shooting",
...
const LESSON58_ANALYSIS_PDF_REFS = Object.freeze([
    "Andrews Lesson 58.1",
    "Andrews Lesson 58.2",
    "Andrews Lesson 58.3",
    "Andrews Lesson 58.4",
...
const LESSON58_ANALYSIS_VALIDATION_REFS = Object.freeze([
    "src/tests/analysis.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const LESSON58_ANALYSIS_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({
        range: "58.1",
        issue: ANALYSIS_ISSUE.miscellany,
...
function buildLesson58AnalysisPursuitFrame() {
    ...
    return {
        ...
        curriculumRef: { source: "Andrews", range: "58.1-58.8", role: "plan-pursue-step" },
        stepNumber: 58,
        aimStatus: "shooting",
...
function normalizeAnalysisIssue(value = "") {
    return normalizeAnalysisEnum(
        value,
        Object.values(ANALYSIS_ISSUE),
        ANALYSIS_ISSUE.unknown
    );
}
...
function normalizeAnalysisFalsePositiveSource(value = "") {
    return normalizeAnalysisEnum(
        value,
        Object.values(ANALYSIS_FALSE_POSITIVE_SOURCE),
        ANALYSIS_FALSE_POSITIVE_SOURCE.unknown
    );
}
...
function getAnalysisStructuralQuestions() {
    return ANALYSIS_STRUCTURAL_QUESTIONS.map((question) => ({ ...question }));
}
...
function classifyAnalysisIssueCandidate({
    ...
    const classification = {
        ...
        diagnostics: [
            ...
            normalizedFalsePositive !== ANALYSIS_FALSE_POSITIVE_SOURCE.unknown
                ? "analysis-issue-false-positive-source"
                : "analysis-issue-unconfirmed",
        ],
