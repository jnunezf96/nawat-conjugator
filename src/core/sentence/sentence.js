...
const SENTENCE_LESSON8_VALIDATION_REFS = Object.freeze([
    "src/tests/sentence.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const SENTENCE_LESSON8_PDF_REFS = Object.freeze([
    "Andrews Lesson 8.1",
    "Andrews Lesson 8.2",
    "Andrews Lesson 8.3",
    "Andrews Lesson 8.4",
...
const SENTENCE_LESSON8_EXPANDED_VNC_FRAME = Object.freeze({
    ...
    expandedConstituents: Object.freeze([
        Object.freeze({
...
const SENTENCE_LESSON8_TRANSFORM_FRAME = Object.freeze({
    ...
    unsupportedSurfaceBehavior: Object.freeze([
        "negative sentence generation",
        "emphatic sentence generation",
        "yes/no question sentence generation",
        "orthography-bridge particle realization for Lesson 8 transforms",
    ]),
});

const SENTENCE_LESSON8_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({
...
const SENTENCE_LESSON8_REMAINING_GAPS = Object.freeze([
    "No sentence generator models full Lesson 8 assertion, negative, emphatic, or yes/no question surfaces.",
    "Lesson 8 particles and prefixal carriers remain Andrews structural evidence until Andrews source models plus orthography-bridge fixtures license spelling and placement.",
    "Directional/locative CNV prefixes are not yet integrated as generative CNV slot controls with Nawat/Pipil surface validation.",
]);

const SENTENCE_LESSON9_VALIDATION_REFS = Object.freeze([
    "src/tests/sentence.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const SENTENCE_LESSON9_PDF_REFS = Object.freeze([
    "Andrews Lesson 9.1",
    "Andrews Lesson 9.2",
    "Andrews Lesson 9.3",
    "Andrews Lesson 9.4",
...
const SENTENCE_LESSON9_OPTATIVE_VNC_FRAME = Object.freeze({
    ...
    borrowedUseTenses: Object.freeze([
        Object.freeze({
    ...
    distinctiveMarkers: Object.freeze([
        Object.freeze({
...
const SENTENCE_LESSON9_WISH_SENTENCE_FRAME = Object.freeze({
    ...
    intensifiers: Object.freeze([
        Object.freeze({ andrews: "cuel", nawatCandidate: "kwel", placement: "after-ma-or-tla" }),
        Object.freeze({ andrews: "ye cuel", nawatCandidate: "ye kwel", placement: "after-ma-or-tla" }),
        Object.freeze({ andrews: "cuel eh", nawatCandidate: "kwel ej", placement: "after-ma-or-tla" }),
        Object.freeze({ andrews: "ye cuel eh", nawatCandidate: "ye kwel ej", placement: "after-ma-or-tla" }),
        Object.freeze({ andrews: "ihyo", nawatCandidate: "ijyu", placement: "before-ma-tla-or-in-tla" }),
        Object.freeze({ andrews: "ye", nawatCandidate: "ye", placement: "before-tla-for-intensification" }),
    ]),
    negativeWish: Object.freeze({
        operation: "replace-indicative-vnc-with-optative-vnc-insert-ma-or-tla-and-change-negative-prefix",
        negativePrefixChange: Object.freeze({ fromAndrews: "ah#", toAndrews: "ca#", toNawatCandidate: "ka#" }),
...
const SENTENCE_LESSON9_COMMAND_EXHORTATION_FRAME = Object.freeze({
    ...
    affirmativeCommandExhortation: Object.freeze({
        ...
        encouragingParticle: Object.freeze({ andrews: "tel", nawatCandidate: "tel", placement: "after-ma" }),
    }),
    futureCommand: Object.freeze({
        ...
        optionalParticle: Object.freeze({ andrews: "quin", nawatCandidate: "kin", placement: "after-ma" }),
    }),
    negativeCommandExhortation: Object.freeze({
        ...
        normalNegativePrefix: Object.freeze({ andrews: "ca#", nawatCandidate: "ka#" }),
        brusqueNoMaException: Object.freeze({ andrews: "ah#", nawatCandidate: "aj#" }),
    }),
});

const SENTENCE_LESSON9_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({
...
const SENTENCE_LESSON9_REMAINING_GAPS = Object.freeze([
    "No sentence generator composes ma/tla wish, command, exhortation, or negative-wish surfaces.",
    "The finite optativo key is canonical, but sentence-level optative/command UI semantics remain diagnostic until Andrews-directed sentence generation is implemented.",
    "Lesson 9 particles, intensifiers, and negative-prefix placements remain Andrews structural evidence until Andrews source models plus orthography-bridge fixtures license spelling and placement.",
]);

const SENTENCE_LESSON10_VALIDATION_REFS = Object.freeze([
    "src/tests/sentence.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const SENTENCE_LESSON10_PDF_REFS = Object.freeze([
    "Andrews Lesson 10.1",
    "Andrews Lesson 10.2",
    "Andrews Lesson 10.3",
    "Andrews Lesson 10.4",
...
const SENTENCE_LESSON10_AFFIRMATIVE_ADMONITION_FRAME = Object.freeze({
    ...
    obligatoryIntroducer: Object.freeze({ andrews: "ma", nawatCandidate: "ma" }),
    optionalStrengthener: Object.freeze({ andrews: "nen", nawatCandidate: "nen", collocation: "ma nen" }),
    subjectFunction: Object.freeze({
        secondPerson: "direct-warning",
        thirdPerson: "indirect-warning",
        firstPerson: "self-or-group-exhortative-warning",
    }),
    translationBoundaries: Object.freeze([
...
const SENTENCE_LESSON10_NEGATIVE_ADMONITION_FRAME = Object.freeze({
    ...
    obligatoryIntroducer: Object.freeze({ andrews: "ma nen", nawatCandidate: "ma nen" }),
    negativePrefix: Object.freeze({ andrews: "ah#", nawatCandidate: "aj#" }),
...
const SENTENCE_LESSON10_CONTRAST_FRAME = Object.freeze({
    ...
    comparedCategories: Object.freeze([
        "preterit-indicative",
        "nonpast-admonitive",
        "nonpast-optative",
        "present-indicative",
    ]),
    disambiguationRules: Object.freeze([
        Object.freeze({
...
const SENTENCE_LESSON10_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({
...
const SENTENCE_LESSON10_REMAINING_GAPS = Object.freeze([
    "No sentence generator composes affirmative or negative admonition surfaces.",
    "The finite optativo key is canonical, but sentence-level admonitive and optative functions remain diagnostic until Andrews-directed sentence generation is implemented.",
    "Lesson 10 ma/nen/ah# placement and class-specific admonitive surfaces remain Andrews structural evidence until Andrews source models plus orthography-bridge fixtures license spelling and placement.",
]);

const SENTENCE_LESSON17_VALIDATION_REFS = Object.freeze([
    "src/tests/sentence.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const SENTENCE_LESSON17_PDF_REFS = Object.freeze([
    "Andrews Lesson 17.1",
    "Andrews Lesson 17.2",
    "Andrews Lesson 17.3",
    "Andrews Lesson 17.4",
...
const SENTENCE_LESSON17_SHARED_REFERENT_FRAME = Object.freeze({
    ...
    roles: Object.freeze([
        Object.freeze({ id: "supplementary-subject", supplementSubjectMatches: "principal subject" }),
        Object.freeze({ id: "supplementary-object", supplementSubjectMatches: "principal object" }),
        Object.freeze({ id: "supplementary-possessor", supplementSubjectMatches: "principal possessor" }),
    ]),
...
const SENTENCE_LESSON17_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({
...
const SENTENCE_LESSON17_REMAINING_GAPS = Object.freeze([
    "Supplementation is not yet an executable clause/sentence AST over generated Nawat/Pipil surfaces.",
    "Shared-referent subject, object, and possessor examples require Andrews clause-source model plus orthography bridge before generation or UI controls.",
    "Topicalization, recursive supplementation, third-person ambiguity, and information-question transforms remain diagnostic metadata.",
    "Included-referent supplementation is deferred to Andrews Lesson 19.",
]);

const SENTENCE_LESSON18_VALIDATION_REFS = Object.freeze([
    "src/tests/sentence.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const SENTENCE_LESSON18_PDF_REFS = Object.freeze([
    "Andrews Lesson 18.1",
    "Andrews Lesson 18.2",
    "Andrews Lesson 18.3",
    "Andrews Lesson 18.4",
...
const SENTENCE_LESSON18_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({
...
const SENTENCE_LESSON18_REMAINING_GAPS = Object.freeze([
    "Lesson 18 supplementation is not yet an executable sentence AST over generated Nawat/Pipil surfaces.",
    "Integrated o# movement, marked in adjunction, discontinuity, proxy-principal deletion, and free constituent order need a distance-aware clause/sentence parser before generation.",
    "Short personal-pronominal NNCs, named-partner supplements, male-bonding supplements, agreement mismatches, and silent object heads require Andrews source models plus orthography-bridge support before UI controls or output.",
    "Real vocative formation needs orthography-bridge support for particle/prosody spelling behavior before any surface generation.",
]);

const SENTENCE_LESSON19_VALIDATION_REFS = Object.freeze([
    "src/tests/sentence.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const SENTENCE_LESSON19_PDF_REFS = Object.freeze([
    "Andrews Lesson 19.1",
    "Andrews Lesson 19.2",
    "Andrews Lesson 19.3",
    "Andrews Lesson 19.4",
...
const SENTENCE_LESSON19_INCLUDED_REFERENT_FRAME = Object.freeze({
    ...
    principalClauseTypes: Object.freeze([
        Object.freeze({ clauseType: "NNC", allowedSupplementFunctions: Object.freeze(["supplementary subject", "supplementary possessor"]) }),
        Object.freeze({ clauseType: "intransitive VNC", allowedSupplementFunctions: Object.freeze(["supplementary subject"]) }),
        Object.freeze({ clauseType: "transitive VNC", allowedSupplementFunctions: Object.freeze(["supplementary subject", "supplementary object"]) }),
    ]),
    transitivePrincipalSemanticGroups: Object.freeze([
        "saying-questioning",
        "causing",
...
const SENTENCE_LESSON19_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({
...
const SENTENCE_LESSON19_REMAINING_GAPS = Object.freeze([
    "Lesson 19 VNC supplementation and included-referent supplementation are not executable sentence ASTs over generated Nawat/Pipil surfaces.",
    "Pronominal plural formations, fused spelling warnings, and noncontiguous ac structures require Andrews source models plus orthography-bridge support and a safe pronominal route contract.",
    "Direct/indirect speech, reported questions, reported commands, wishing/needing/perception/knowing/affect complements, rumored report, and deleted saying principals require speech/complement AST support before generation.",
    "English infinitive translations and rhetorical weighting must remain diagnostics, not generation rules.",
]);
...
function cloneSentenceLessonRecord(value) {
    ...
    return Object.fromEntries(
        Object.entries(value).map(([key, entry]) => [key, cloneSentenceLessonRecord(entry)])
    );
}
