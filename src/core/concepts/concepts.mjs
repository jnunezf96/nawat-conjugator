...
export function createConceptsApi(targetObject = globalThis) {
    ...
    const LESSON_1_CONCEPTS = Object.freeze([Object.freeze({
      id: "word-output",
      lesson: 1,
    ...
    function getNuclearClauseTerminology() {
      return Object.fromEntries(Object.entries(NUCLEAR_CLAUSE_TERMINOLOGY).map(([key, value]) => [key, {
        ...value
      }]));
    }
    function getConceptRegistry({
      lesson = null,
      kind = ""
    } = {}) {
    ...
    function buildConceptGlossaryDisplayModel({
      lesson = 1
    } = {}) {
      const glossary = buildConceptGlossaryMetadata({
        lesson
      });
    ...
    const api = {};
    Object.defineProperty(api, "CONCEPT_REGISTRY_VERSION", {
        configurable: true,
        enumerable: true,
        get() { return CONCEPT_REGISTRY_VERSION; },
    });
    Object.defineProperty(api, "CONCEPT_KIND", {
        configurable: true,
        enumerable: true,
        get() { return CONCEPT_KIND; },
    });
    Object.defineProperty(api, "CONCEPT_ANTI_CONFLATION_RULES", {
        configurable: true,
        enumerable: true,
        get() { return CONCEPT_ANTI_CONFLATION_RULES; },
    });
    Object.defineProperty(api, "NUCLEAR_CLAUSE_TERMINOLOGY", {
        configurable: true,
        enumerable: true,
        get() { return NUCLEAR_CLAUSE_TERMINOLOGY; },
    });
    Object.defineProperty(api, "LESSON_1_CONCEPTS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON_1_CONCEPTS; },
    });
    Object.defineProperty(api, "CONCEPT_TOKEN_ALIASES", {
        configurable: true,
        enumerable: true,
    ...
    api.getNuclearClauseTerminology = getNuclearClauseTerminology;
    api.getConceptRegistry = getConceptRegistry;
    api.listConceptsByLesson = listConceptsByLesson;
    api.listConceptsByKind = listConceptsByKind;
    api.getConceptById = getConceptById;
    api.classifyConceptToken = classifyConceptToken;
    api.buildConceptGlossaryMetadata = buildConceptGlossaryMetadata;
    api.buildConceptGlossaryDisplayModel = buildConceptGlossaryDisplayModel;
    return api;
}
