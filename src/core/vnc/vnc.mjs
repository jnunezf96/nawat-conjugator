...
export function createVncApi(targetObject = globalThis) {
    ...
    const VNC_LESSON5_SUBJECT_FILLER_PARADIGMS = Object.freeze([Object.freeze({
      ...
      pluralConnector: "0-h",
      nawatPluralBridge: Object.freeze({
        classicalCarrier: "h",
        adaptedCarrier: "t"
      }),
      currentNawatSubjectSlots: Object.freeze([Object.freeze({
        person: "1sg",
        pers1: "ni",
        pers2: ""
      }), Object.freeze({
    ...
    const VNC_LESSON5_TENSE_MORPH_FRAME = Object.freeze({
      ...
      currentNawatTenseInventory: Object.freeze(["presente", "presente-habitual", "presente-desiderativo", "imperfecto", "futuro", "preterito", "pasado-remoto", "condicional", "optativo", "perfecto", "pluscuamperfecto", "condicional-perfecto"]),
      tenseIsNotTime: true
    });
    ...
    const VNC_LESSON6_PDF_REFS = Object.freeze(["Andrews Lesson 6.1", "Andrews Lesson 6.2", "Andrews Lesson 6.3", "Andrews Lesson 6.4", "Andrews Lesson 6.5", "Andrews Lesson 6.6", "Andrews Lesson 6.7"]);
    ...
    const VNC_LESSON6_PROJECTIVE_OBJECT_PARADIGM = Object.freeze([Object.freeze({
      person: "1sg",
      classicalDyad: "n-ech",
      currentNawatDyad: "n-ech",
      currentNawatPrefix: "nech",
      glossEs: "me"
    }), Object.freeze({
      person: "1pl",
      classicalDyad: "t-ech",
      currentNawatDyad: "t-ech",
      currentNawatPrefix: "tech",
      glossEs: "nos"
    }), Object.freeze({
      person: "2sg",
      classicalDyad: "m-itz",
      currentNawatDyad: "m-etz",
      currentNawatPrefix: "metz",
      glossEs: "te"
    }), Object.freeze({
      person: "2pl",
      classicalDyad: "am-ech",
      currentNawatDyad: "m-etz-in",
      currentNawatPrefix: "metzin",
      glossEs: "los/las a ustedes"
    }), Object.freeze({
      person: "3sg",
      classicalDyad: "c-0/qu-0/qui-0",
      currentNawatDyad: "ki-0/k-0",
      currentNawatPrefix: "ki/k",
      glossEs: "lo/la"
    }), Object.freeze({
      person: "3pl",
      classicalDyad: "qu-im",
      currentNawatDyad: "k-in",
      currentNawatPrefix: "kin",
      glossEs: "los/las"
    })]);
    ...
    const VNC_LESSON7_PDF_REFS = Object.freeze(["Andrews Lesson 7.1", "Andrews Lesson 7.2", "Andrews Lesson 7.3", "Andrews Lesson 7.4", "Andrews Lesson 7.5", "Andrews Lesson 7.6", "Andrews Lesson 7.7", "Andrews Lesson 7.8", "Andrews Lesson 7.9", "Andrews Lesson 7.10"]);
    ...
    const VNC_LESSON7_CLASS_B_CHANGE_FRAME = Object.freeze({
      ...
      classicalExamples: Object.freeze([Object.freeze({
        pattern: "k spelling",
        example: "(miqui) > (mic)",
        nawatBoundary: "Nawat realization must use repo orthography, not Classical c/qu spelling"
      }), Object.freeze({
        pattern: "s spelling",
        example: "(neci) > (nez)",
        nawatBoundary: "Nawat realization must use repo orthography"
      }), Object.freeze({
        pattern: "m to n-like nasal",
        example: "(nemi) > (nen)",
        nawatBoundary: "current preterit classes decide attested output"
      }), Object.freeze({
        pattern: "y to s/x",
    ...
    const VNC_LESSON7_CLASS_GUIDELINES = Object.freeze([Object.freeze({
      ...
      classId: "A",
      directiveEs: "Sílabas finales tla apuntan a clase A en la regla clásica; en Nawat la letra visible pasa por ta."
    }), Object.freeze({
      ...
      classId: "D",
      directiveEs: "La lista cerrada de ocho troncos clase D se conserva como regla de clasificación, no como fixture Nawat automática."
    })]);
    ...
    function generateNuclearClauseSurface(options = {}) {
      ...
      const inputAdjectivalOverride = options.override ? null : resolveAdjectivalNncFunctionOverrideFromInput(troncoControl);
    ...
    Object.defineProperty(api, "VNC_LESSON5_PDF_REFS", {
        configurable: true,
        enumerable: true,
        get() { return VNC_LESSON5_PDF_REFS; },
    });
    ...
    Object.defineProperty(api, "VNC_LESSON6_PDF_REFS", {
        configurable: true,
        enumerable: true,
        get() { return VNC_LESSON6_PDF_REFS; },
    });
    ...
    Object.defineProperty(api, "VNC_LESSON7_PDF_REFS", {
        configurable: true,
        enumerable: true,
        get() { return VNC_LESSON7_PDF_REFS; },
    });
    ...
    Object.defineProperty(api, "VNC_LESSON7_TA_FUSION_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return VNC_LESSON7_TA_FUSION_FRAME; },
    });
    ...
    api.getVncLesson5IntransitiveFormulaFrame = getVncLesson5IntransitiveFormulaFrame;
    api.getVncLesson5SubjectSlotFrame = getVncLesson5SubjectSlotFrame;
    api.getVncLesson5SubjectFillerParadigms = getVncLesson5SubjectFillerParadigms;
    api.getVncLesson5TenseMorphFrame = getVncLesson5TenseMorphFrame;
    api.getVncLesson5SubsectionInventory = getVncLesson5SubsectionInventory;
    api.buildVncLesson5PursuitFrame = buildVncLesson5PursuitFrame;
    api.getVncLesson6TransitiveFormulaFrame = getVncLesson6TransitiveFormulaFrame;
    api.getVncLesson6ObjectCategoryFrame = getVncLesson6ObjectCategoryFrame;
    api.getVncLesson6MonadicValenceFillers = getVncLesson6MonadicValenceFillers;
    api.getVncLesson6DyadicObjectFrame = getVncLesson6DyadicObjectFrame;
    ...
    api.getVncLesson7VerbstemClassFrame = getVncLesson7VerbstemClassFrame;
    api.getVncLesson7ClassBChangeFrame = getVncLesson7ClassBChangeFrame;
    api.getVncLesson7VariableClassFrame = getVncLesson7VariableClassFrame;
    api.getVncLesson7ClassGuidelines = getVncLesson7ClassGuidelines;
    api.getVncLesson7PredicateFormationFrame = getVncLesson7PredicateFormationFrame;
    api.getVncLesson7AnalysisFrame = getVncLesson7AnalysisFrame;
    api.getVncLesson7ObjectRelationshipFrame = getVncLesson7ObjectRelationshipFrame;
    api.getVncLesson7TaFusionFrame = getVncLesson7TaFusionFrame;
