...
const LESSON28_VERBAL_EMBED_VALIDATION_REFS = Object.freeze([
    "src/tests/parsing.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const LESSON28_VERBAL_EMBED_PDF_REFS = Object.freeze([
    "Andrews Lesson 28.1",
    "Andrews Lesson 28.2",
    "Andrews Lesson 28.3",
    "Andrews Lesson 28.4",
...
const LESSON28_MATRIX_EMBED_FRAME = Object.freeze({
    ...
    allowedEmbedFunctions: Object.freeze([
        "incorporated object",
...
const LESSON28_CONNECTIVE_T_FRAME = Object.freeze({
    ...
    morphs: Object.freeze([
        Object.freeze({ morph: "t", environment: "before vowel" }),
        Object.freeze({ morph: "ti", environment: "before consonant or supportive vowel" }),
    ]),
    functionsAsSeparatorAndConnector: true,
    patterns: Object.freeze([
        "intransitive-matrix",
        "intransitivized-reflexive-matrix",
        "shared-object",
    ]),
...
const LESSON28_INTRANSITIVE_MATRIX_FRAME = Object.freeze({
    ...
    matrixInventory: Object.freeze([
        Object.freeze({ id: "ca-h", andrewsStem: "ca-h", roleGlossEs: "estar en el acto de hacer algo", note: "variant ye after connective t" }),
        Object.freeze({ id: "nemi", andrewsStem: "nemi", roleGlossEs: "seguir o pasar el tiempo haciendo algo" }),
        Object.freeze({ id: "ya-uh", andrewsStem: "ya-uh", roleGlossEs: "irse haciendo algo", note: "singular present stem uh; ti-ya may syncopate to t-a" }),
        Object.freeze({ id: "hual-la-uh", andrewsStem: "hual-la-uh", roleGlossEs: "venir haciendo algo", note: "directional prefix remains part of the matrix" }),
        Object.freeze({ id: "hui-tz", andrewsStem: "hui-tz", roleGlossEs: "venir haciendo algo", note: "huica and itqui use old itz formation without connective" }),
        Object.freeze({ id: "ahci", andrewsStem: "ahci", roleGlossEs: "llegar haciendo algo", note: "often permits hysteron-proteron reversal" }),
        Object.freeze({ id: "mani", andrewsStem: "mani", roleGlossEs: "estar o extenderse en cierto estado; grupo de pie haciendo algo" }),
        Object.freeze({ id: "ihca", andrewsStem: "ihca", roleGlossEs: "estar de pie haciendo algo o en cierto estado" }),
        Object.freeze({ id: "o", andrewsStem: "o", roleGlossEs: "yacer extendido haciendo algo o en cierto estado", note: "ordinary locative on is not used as matrix here" }),
        Object.freeze({ id: "e-hua", andrewsStem: "e-hua", roleGlossEs: "empezar o moverse hacia una accion; hacerlo rapidamente", note: "Class A or Class B perfective stem possible" }),
        Object.freeze({ id: "quiza", andrewsStem: "quiza", roleGlossEs: "hacer algo rapidamente o abruptamente" }),
        Object.freeze({ id: "huetzi", andrewsStem: "huetzi", roleGlossEs: "hacer algo rapidamente o abruptamente; tambien caer" }),
        Object.freeze({ id: "tlehco", andrewsStem: "tlehco", roleGlossEs: "ascender" }),
        Object.freeze({ id: "cal-aqui", andrewsStem: "cal-aqui", roleGlossEs: "entrar", note: "itself a Lesson 30 compound" }),
        Object.freeze({ id: "pil-ca", andrewsStem: "pil-ca", roleGlossEs: "colgar o estar suspendido" }),
    ]),
});
...
const LESSON28_SPECIAL_FORMATIONS_FRAME = Object.freeze({
    ...
    formations: Object.freeze([
        Object.freeze({ id: "ca-h-as-embed", directive: "ca-h as embed unexpectedly uses perfective ye" }),
        Object.freeze({ id: "ya-uh-as-embed", directive: "ya-uh as embed uses preterit predicate on yah" }),
        Object.freeze({ id: "cac-embed-only", directive: "cac occurs only as embed and only with nonanimate subject reference" }),
        Object.freeze({ id: "itta-blocked-as-embed", directive: "te/tla-(itt-a) cannot embed; perfective itz is used instead" }),
        Object.freeze({ id: "hysteron-proteron", directive: "event order may be reversed; ahci frequently permits it" }),
        Object.freeze({ id: "connective-t-passive", directive: "embed or both embed and matrix may be nonactive" }),
        Object.freeze({ id: "connective-t-impersonal", directive: "embed, matrix, or both may be impersonal; tla impersonal must appear on embed" }),
    ]),
});
...
const LESSON28_FUTURE_EMBED_FRAME = Object.freeze({
    ...
    matrices: Object.freeze([
        Object.freeze({ id: "tla-nequi", andrewsStem: "tla-(nequi)", directive: "want or desire; passive and impersonal manifest in embed" }),
        Object.freeze({ id: "tla-qui", andrewsStem: "*tla-(qui)", directive: "will or intend; matrix-only, imperfect tense only; conditional label is translational mirage" }),
    ]),
});
...
const LESSON28_VERBAL_EMBED_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({ id: "lesson28-compounding", andrewsSection: "28.1", category: "compounding-transform", directiveEs: "La composicion combina CNV/CNN en una nueva clausula nuclear y baja relaciones sintacticas a morfologia.", engineSurface: "compoundAst parser metadata", implementationState: "partial", redirectAction: "reframe-metadata" }),
    Object.freeze({ id: "lesson28-matrix-embed", andrewsSection: "28.2", category: "matrix-embed-order", directiveEs: "La matriz siempre va despues del incrustado; la matriz decide si el compuesto es verbal o nominal.", engineSurface: "matrix/embed parser roles", implementationState: "partial", redirectAction: "refactor-engine" }),
    Object.freeze({ id: "lesson28-cohesiveness", andrewsSection: "28.3", category: "linked-integrated", directiveEs: "El compuesto puede ser ligado o integrado; NNC+VNC queda restringido al tipo integrado.", engineSurface: "compound boundary metadata", implementationState: "partial", redirectAction: "reframe-metadata" }),
    Object.freeze({ id: "lesson28-verbal-embed-valence", andrewsSection: "28.4", category: "verbal-embed-valence", directiveEs: "El incrustado verbal decide la valencia del compuesto; la matriz decide el tipo ligado o integrado.", engineSurface: "parser valency metadata", implementationState: "partial", redirectAction: "refactor-engine" }),
    Object.freeze({ id: "lesson28-connective-t", andrewsSection: "28.5", category: "connective-t", directiveEs: "El conectivo t/ti separa y conecta; el incrustado es preterito perfecto antes de t.", engineSurface: "diagnostic connective-t frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson28-intransitive-matrix", andrewsSection: "28.6", category: "intransitive-matrix", directiveEs: "Las matrices intransitivas son una lista limitada y no deben llamarse auxiliares.", engineSurface: "diagnostic matrix inventory", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson28-special-formations", andrewsSection: "28.7", category: "special-formations", directiveEs: "Las formaciones especiales gobiernan ye, yah, cac, itz, orden invertido, pasivo e impersonal.", engineSurface: "diagnostic special-formation frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson28-accompanying-possession", andrewsSection: "28.8", category: "accompanying-possession", directiveEs: "La posesion acompanante usa una CNN posesiva como sujeto suplementario de una CNV con ye incrustado.", engineSurface: "supplementation boundary metadata", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson28-reflexive-matrix", andrewsSection: "28.9", category: "intransitivized-reflexive-matrix", directiveEs: "La matriz reflexiva descarga su transitividad en m-o, que no cambia por persona del sujeto.", engineSurface: "diagnostic reflexive-matrix frame", implementationState: "partial", redirectAction: "refactor-engine" }),
    Object.freeze({ id: "lesson28-shared-object", andrewsSection: "28.10", category: "shared-object", directiveEs: "Matriz e incrustado comparten el mismo objeto; el pronombre objeto aparece una vez en el incrustado.", engineSurface: "diagnostic shared-object frame", implementationState: "partial", redirectAction: "refactor-engine" }),
    Object.freeze({ id: "lesson28-future-embed", andrewsSection: "28.11", category: "future-embed", directiveEs: "El incrustado futuro reemplaza el objeto de la matriz y su valencia se vuelve la valencia del compuesto.", engineSurface: "diagnostic future-embed frame", implementationState: "partial", redirectAction: "block-generation" }),
    Object.freeze({ id: "lesson28-recursion", andrewsSection: "28.12", category: "compound-recursion", directiveEs: "Un compuesto puede volver a servir como incrustado o matriz en otro compuesto.", engineSurface: "recursive compound metadata", implementationState: "partial", redirectAction: "reframe-metadata" }),
]);
...
function cloneLesson28CompoundRecord(record) {
    ...
    return Object.fromEntries(
        Object.entries(record).map(([key, value]) => [key, cloneLesson28CompoundRecord(value)])
    );
}
...
function buildLesson28VerbalEmbedPursuitFrame() {
    ...
    const remainingGaps = [
        "Current compoundAst is additive parser metadata, not full Andrews compound generation.",
        "Connective-t preterit-embed morphology, limited matrix inventories, and special formations are diagnostic only.",
        "Intransitivized-reflexive-matrix, shared-object, future-embed, passive/impersonal, and accompanying-possession behavior still need explicit engine routes.",
        "Nawat/Pipil spelling realization and lexical exceptions require orthography-bridge source context before finite output can expand.",
    ];
    const frame = {
    ...
    return attachLesson28CompoundGrammarContract(frame, {
        ...
        diagnostics: ["compound-verbstem-diagnostic-only", "compound-verbstem-source-gated"],
    });
}

const LESSON30_NOMINAL_EMBED_VALIDATION_REFS = Object.freeze([
    "src/tests/parsing.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const LESSON30_NOMINAL_EMBED_PDF_REFS = Object.freeze([
    "Andrews Lesson 30.1",
    "Andrews Lesson 30.2",
    "Andrews Lesson 30.3",
    "Andrews Lesson 30.4",
...
const LESSON30_NOMINAL_EMBED_OVERVIEW_FRAME = Object.freeze({
    ...
    generalUseStemExceptions: Object.freeze([
        "ti-class subclass 2-B ephemeral final a may remain in embed subposition",
        "some lexical exceptions override even the subclass 2-B exception",
    ]),
    incorporatedNncTypes: Object.freeze([
        "incorporated-object",
        "incorporated-adverb",
        "incorporated-complement",
    ]),
...
const LESSON30_INCORPORATED_OBJECT_FRAME = Object.freeze({
    ...
    valenceReduction: Object.freeze([
        Object.freeze({ sourceMatrix: "single-object VNC", compoundValence: "intransitive VNC", objectPronounPermitted: false }),
        Object.freeze({ sourceMatrix: "double-object VNC", compoundValence: "single-object VNC", objectPronounPermitted: true }),
        Object.freeze({ sourceMatrix: "triple-object VNC", compoundValence: "double-object VNC", objectPronounPermitted: true }),
    ]),
...
const LESSON30_INCORPORATED_ADVERB_FRAME = Object.freeze({
    ...
    sourceTransforms: Object.freeze([
        "adverbial NNC in a concatenate source becomes incorporated adverb",
        "supplementary subject or object becomes incorporated adverb",
    ]),
...
const LESSON30_ADVERB_ROLE_FRAME = Object.freeze({
    ...
    roles: Object.freeze([
        Object.freeze({ section: "30.7", role: "means-or-instrument", bodyPartPossessorDeletedByCoreference: true }),
        Object.freeze({ section: "30.8", role: "place", bodyPartPossessorDeletedByCoreference: true }),
        Object.freeze({ section: "30.9", role: "time-or-duration" }),
        Object.freeze({ section: "30.10", role: "cause-or-purpose" }),
        Object.freeze({ section: "30.11", role: "manner", subjectOrObjectFocus: true }),
        Object.freeze({ section: "30.12", role: "compared-manner", orientation: "subject for intransitive; subject or object for transitive" }),
        Object.freeze({ section: "30.13", role: "unique-embed-nounstems", simpleNncUseMissingOrUncertain: true }),
    ]),
...
const LESSON30_COMPLEMENT_FRAME = Object.freeze({
    ...
    complementTypes: Object.freeze([
        Object.freeze({ id: "subject-complement", relation: "embed subject corefers with matrix subject" }),
        Object.freeze({ id: "object-complement-considering", relation: "embed subject corefers with matrix object", semanticField: "considering" }),
        Object.freeze({ id: "object-complement-changing", relation: "embed subject corefers with matrix object", semanticField: "changing into" }),
    ]),
...
const LESSON30_NOMINAL_EMBED_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({ id: "lesson30-nnc-vnc-compound", andrewsSection: "30.1", category: "nnc-plus-vnc-integrated", directiveEs: "Un compuesto NNC+VNC siempre es integrado y usa el tronco nominal de uso general como incrustado.", engineSurface: "compoundAst lexical embed metadata", implementationState: "partial", redirectAction: "refactor-engine" }),
    Object.freeze({ id: "lesson30-incorporated-object-stem", andrewsSection: "30.2", category: "incorporated-object-stem", directiveEs: "El objeto incorporado solo procede de matriz transitiva y reduce la valencia del compuesto.", engineSurface: "diagnostic incorporated-object frame", implementationState: "partial", redirectAction: "block-generation" }),
    Object.freeze({ id: "lesson30-incorporated-object-vnc", andrewsSection: "30.3", category: "incorporated-object-vnc", directiveEs: "Las rutas de uno, dos y tres objetos bajan una posicion de valencia; causativos y aplicativos pueden derivarse de troncos ya incorporados.", engineSurface: "diagnostic valence-reduction frame", implementationState: "partial", redirectAction: "block-generation" }),
    Object.freeze({ id: "lesson30-exceptional-tla-fusion", andrewsSection: "30.4", category: "exceptional-tla-fusion", directiveEs: "Cuando tla ya es objeto fusionado, el nominal incorporado debe analizarse como adverbial, no como otro objeto.", engineSurface: "diagnostic exceptional frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson30-incorporated-adverb-vnc", andrewsSection: "30.5", category: "incorporated-adverb-vnc", directiveEs: "El adverbio incorporado puede venir de adjuncto adverbial o de suplemento, y conserva la valencia de la matriz.", engineSurface: "diagnostic incorporated-adverb frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson30-incorporated-adverb-stem", andrewsSection: "30.6", category: "incorporated-adverb-stem", directiveEs: "Las fuentes adverbiales son complejas y se conectan con Lecciones 44-50; no basta un signo de parser.", engineSurface: "diagnostic adverb-source frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson30-means-instrument", andrewsSection: "30.7", category: "means-instrument-adverb", directiveEs: "El incrustado puede marcar medio o instrumento; posesores de partes del cuerpo se eliminan por correferencia.", engineSurface: "diagnostic adverb-role frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson30-place", andrewsSection: "30.8", category: "place-adverb", directiveEs: "El incrustado puede marcar lugar; no debe confundirse con objeto aplicativo.", engineSurface: "diagnostic adverb-role frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson30-time-duration", andrewsSection: "30.9", category: "time-duration-adverb", directiveEs: "El incrustado puede marcar tiempo o duracion, incluso con fuente nominal compuesta.", engineSurface: "diagnostic adverb-role frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson30-cause-purpose", andrewsSection: "30.10", category: "cause-purpose-adverb", directiveEs: "El incrustado puede marcar causa o proposito de la accion.", engineSurface: "diagnostic adverb-role frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson30-manner", andrewsSection: "30.11", category: "manner-adverb", directiveEs: "El incrustado puede marcar manera, forma o estilo con foco de sujeto u objeto.", engineSurface: "diagnostic adverb-role frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson30-compared-manner", andrewsSection: "30.12", category: "compared-manner-adverb", directiveEs: "La comparacion se orienta al sujeto con matriz intransitiva y al sujeto u objeto con matriz transitiva.", engineSurface: "diagnostic comparison-role frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson30-unique-embed-nounstems", andrewsSection: "30.13", category: "unique-embed-nounstems", directiveEs: "Algunos incrustados nominales solo sobreviven en compuestos y tienen significado incierto.", engineSurface: "diagnostic unique-embed frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson30-supplement-transform", andrewsSection: "30.14", category: "supplement-to-adverb-transform", directiveEs: "Un suplemento posesivo puede transformarse en adverbio; su poseedor cambia a sujeto u objeto del compuesto.", engineSurface: "diagnostic supplement-transform frame", implementationState: "partial", redirectAction: "refactor-engine" }),
    Object.freeze({ id: "lesson30-incorporated-complement", andrewsSection: "30.15", category: "incorporated-complement", directiveEs: "El complemento incorporado conserva la valencia de matriz y borra el sujeto coreferente de la CNN fuente.", engineSurface: "diagnostic complement frame", implementationState: "partial", redirectAction: "refactor-engine" }),
    Object.freeze({ id: "lesson30-reduplication", andrewsSection: "30.16", category: "embed-reduplication", directiveEs: "El incrustado nominal, la matriz, o ambos pueden reduplicarse.", engineSurface: "diagnostic reduplication frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson30-passive-impersonal", andrewsSection: "30.17", category: "nonactive-compound-vnc", directiveEs: "Cualquier compuesto NNC+VNC puede formar no activo; la voz pasiva o impersonal depende de la valencia fuente.", engineSurface: "diagnostic nonactive frame", implementationState: "partial", redirectAction: "refactor-engine" }),
    Object.freeze({ id: "lesson30-embed-caveats", andrewsSection: "30.18", category: "embed-not-agent-or-subject", directiveEs: "El incrustado no es agente ni sujeto; la traduccion puede ocultar la estructura nahua.", engineSurface: "diagnostic anti-translation frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
]);
...
function cloneLesson30NominalEmbedRecord(record) {
    ...
    return Object.fromEntries(
        Object.entries(record).map(([key, value]) => [key, cloneLesson30NominalEmbedRecord(value)])
    );
}
...
function buildLesson30NominalEmbedPursuitFrame() {
    ...
    const remainingGaps = [
        "Current compoundAst lexical-embed metadata is not an Andrews Lesson 30 generator.",
        "Incorporated-object valence lowering, exceptional tla-fusion analysis, and incorporated-adverb source transforms are diagnostic only.",
        "Supplement-to-adverb, complement incorporation, reduplication, passive/impersonal routing, and embed caveats need explicit engine gates before finite output expands.",
        "General-use nounstem selection, subclass exceptions, unique embeds, idioms, and lexical source context plus orthography-bridge support remain evidence-needed.",
    ];
    const frame = {
    ...
    return attachLesson30NominalEmbedGrammarContract(frame, {
        ...
        diagnostics: ["nominal-embed-compound-diagnostic-only", "nominal-embed-compound-source-gated"],
    });
}
...
function getComposerDisplayExternalValenceSegments(semantic = {}) {
    ...
    const toSurface = (token = "") => (
        normalizeEntradaGrammarValenceSurfaceToken(token)
    );
    if (transitivity === COMPOSER_TRANSITIVITY.intransitive) {
...
function buildEmbeddedSlashObjectSlotSourceFrame(rawValue = "", movingTargetParsed = null, spec = null) {
    ...
    } else if (transitivity === COMPOSER_TRANSITIVITY.intransitive) {
    ...
    } else if (!blockReason && getComposerValenceFamilyToken(left)) {
        blockReason = "valence-left-boundary";
    } else if (!blockReason && REGEX_ENVELOPE_OBJECT_MARKERS.includes(left.toUpperCase())) {
        blockReason = "object-marker-left-boundary";
    }
    const normalizedEmbed = normalizeRuleBase(left);
    const normalizedMatrix = normalizeRuleBase(right);
    const specAdjacentEmbed = normalizeRuleBase(spec?.adjacentEmbed || "");
...
function buildCanonicalVerbSpecFromMovingTargetParsed(rawValue, movingTargetParsed, tiInputMetadata) {
    ...
    const valenceTokens = outerPieces
        ...
        .map((piece) => normalizeEntradaGrammarValenceSurfaceToken(piece.value))
        .filter(Boolean);
    ...
    const inlineSurface = parseInlineTiCausativeClassFromBase(collapseSerialStemDashInputFromSourceFrame(plainCore));
    ...
    const inlineRuleBase = parseInlineTiCausativeClassFromBase(collapseSerialStemDashInputFromSourceFrame(supportFreeCore));
...
const ENTRADA_GRAMMAR_OBJECT_LAYER_ORDER = Object.freeze([
...
const ENTRADA_GRAMMAR_OBJECT_ANTI_CONFLATION_RULES = Object.freeze([
    "Lesson 1 morph/allomorph evidence is staged before formula boundaries.",
    "Stem behavior is staged separately from valence behavior.",
    "Valence behavior is staged separately from object slot ownership.",
    "Object slots remain structural slots until the valence frame is fixed.",
    "Function-use is downstream and may annotate only already licensed readings.",
]);

const ENTRADA_GRAMMAR_OBJECT_EARLY_ALLOMORPH_BY_SURFACE = Object.freeze({
    nech: Object.freeze({ formulaMorph: "n-ech", morphs: Object.freeze(["n", "ech"]) }),
    tech: Object.freeze({ formulaMorph: "t-ech", morphs: Object.freeze(["t", "ech"]) }),
    metz: Object.freeze({ formulaMorph: "m-etz", morphs: Object.freeze(["m", "etz"]) }),
    metzin: Object.freeze({ formulaMorph: "m-etz-in", morphs: Object.freeze(["m", "etz", "in"]) }),
    ki: Object.freeze({ formulaMorph: "ki-0", morphs: Object.freeze(["ki", "0"]) }),
    k: Object.freeze({ formulaMorph: "k-0", morphs: Object.freeze(["k", "0"]) }),
    kin: Object.freeze({ formulaMorph: "k-in", morphs: Object.freeze(["k", "in"]) }),
});

const ENTRADA_GRAMMAR_OBJECT_SURFACE_BY_EARLY_ALLOMORPH = Object.freeze(
    Object.fromEntries(Object.entries(ENTRADA_GRAMMAR_OBJECT_EARLY_ALLOMORPH_BY_SURFACE)
        .map(([surfaceMorph, frame]) => [frame.formulaMorph, surfaceMorph]))
);
...
function hasEntradaGrammarFormulaSlotEvidence(sourceFormulaSlots = null, sourceFormulaEcho = "") {
    return Boolean(
        sourceFormulaSlots
        && typeof sourceFormulaSlots === "object"
        && Object.keys(sourceFormulaSlots).length
    ) || Boolean(String(sourceFormulaEcho || "").trim());
}
...
function normalizeEntradaGrammarValenceSurfaceToken(value = "") {
    return normalizeComposerSecondaryValenceSurfaceToken(value)
        || normalizeComposerValenceToken(value)
        || getEntradaGrammarEarlyAllomorphFrameForSurface(value)?.surfaceMorph
        || "";
}
...
function buildEntradaGrammarFormulaObjectCoverage({
    ...
    const slots = sourceFormulaSlots && typeof sourceFormulaSlots === "object"
        ? sourceFormulaSlots
        : {};
    const requiredObjectSlots = (Array.isArray(objectSlots) ? objectSlots : [])
        .filter((entry) => entry?.ownsObjectSlot === true)
        .map((entry) => ({
    ...
    const missingObjectSlots = requiredObjectSlots.filter((entry) => {
        ...
        if (
            entry.token === "mu"
            && entradaGrammarFormulaObjectValueCoversToken(
                getEntradaGrammarFormulaSlotObjectValue(slots.reflexivo),
                "mu"
            )
        ) {
            return false;
...
function buildEntradaGrammarObjectValenceSlots(spec = null) {
    const transitivity = spec?.transitivity || COMPOSER_TRANSITIVITY.intransitive;
    const tokens = Array.isArray(spec?.valenceTokens)
        ? spec.valenceTokens.map((entry) => (
            normalizeEntradaGrammarValenceSurfaceToken(entry)
        )).filter(Boolean)
        : [];
    const embeds = Array.isArray(spec?.valenceEmbeds)
        ? spec.valenceEmbeds.map((entry) => normalizeRuleBase(entry)).filter(Boolean)
        : [];
    return tokens.map((token, index) => {
        const ownsObjectSlot = transitivity !== COMPOSER_TRANSITIVITY.intransitive;
...
function buildEntradaGrammarObjectObjectVector(valenceSlots = []) {
    const vector = { obj1: "", obj2: "", obj3: "", reflexivo: "" };
    (Array.isArray(valenceSlots) ? valenceSlots : [])
        .filter((entry) => entry?.ownsObjectSlot === true)
        .forEach((entry) => {
...
function buildEntradaGrammarObjectMorphBoundaryFrame({
    ...
    const slots = sourceFormulaSlots && typeof sourceFormulaSlots === "object"
        ? sourceFormulaSlots
        : {};
    const objectMorphs = (Array.isArray(valenceSlots) ? valenceSlots : [])
        .map((slot) => {
            ...
            const formulaMorph = formulaSlotMorph
                || allomorphFrame?.formulaMorph
                || surfaceMorph;
            const governingFrame = typeof buildLesson6NawatValenceGoverningFrame === "function"
                ? buildLesson6NawatValenceGoverningFrame(surfaceMorph, {
            ...
            return {
                ...
                allomorphyKind: allomorphFrame
                    ? "lesson-1-morph-boundary-object-prefix"
                    : "lesson-1-morph-boundary-same-surface",
                governingFrame,
    ...
    const stemAllomorphs = predicateFormulaStem
        && predicateSurfaceStem
        && normalizeEntradaGrammarMorphToken(predicateFormulaStem) !== predicateSurfaceStem
        ? [{
    ...
    const objectAllomorphs = objectMorphs
        .filter((entry) => entry.formulaMorph !== entry.surfaceMorph)
        .map((entry) => ({
            slotId: entry.slotId,
            role: entry.role,
    ...
    return {
        ...
        valenceGoverningFrame: typeof getLesson6NawatValenceGoverningInventory === "function"
            ? getLesson6NawatValenceGoverningInventory()
            : null,
        objectMorphs,
...
function buildEntradaGrammarObjectFromCanonicalVerbSpec(spec = null, {
    ...
    const explicitFormulaSlots = sourceFormulaSlots && typeof sourceFormulaSlots === "object"
        ? cloneEntradaGrammarObjectRecord(sourceFormulaSlots)
        : null;
    ...
    const resolvedValenceFrameFixed = valenceFrameFixed === null
        ? formulaEvidencePresent && formulaObjectCoverage.objectSlotsCovered
    ...
    return {
        ...
        valenceFrame: {
            ...
            lexicalEmbeds: Array.isArray(spec.valenceEmbeds)
                ? spec.valenceEmbeds.map((entry) => normalizeRuleBase(entry)).filter(Boolean)
                : [],
            slots: valenceSlots,
...
function buildCompoundAstRouteFrame(compoundAst = null) {
    ...
    const remainingExternalObjectSlots = sourceExternalObjectSlots
        .map((slot) => ({ ...slot, owner: "unfixed-matrix-route-frame" }));
    const matrixValence = String(compoundAst.valency?.transitivity || "");
    const sourceFormula = lexicalEmbeds.length
        ? "NNC + VNC = compound VNC"
        : "VNC + VNC = compound VNC";
    const routeFrame = {
...
function buildVerbMetaFromCanonicalSpec(spec, rawValue, rawParsed, tiInputMetadata) {
    ...
    const embeddedSlashObjectSlotSourceFrameCandidate = buildEmbeddedSlashObjectSlotSourceFrame(
        rawValue,
        rawParsed,
        spec
    );
    const embeddedSlashObjectSlotOperationFrameCandidate = buildEmbeddedSlashObjectSlotOperationFrame(
        embeddedSlashObjectSlotSourceFrameCandidate
    );
    const embeddedValenceCount = embeddedSlashObjectSlotOperationFrameCandidate.supported === true
        ? embeddedSlashObjectSlotOperationFrameCandidate.embeddedValenceCount
        : 0;
    const embeddedSlashObjectSlotSourceFrame = embeddedValenceCount > 0
        ? embeddedSlashObjectSlotSourceFrameCandidate
        : null;
    const embeddedSlashObjectSlotOperationFrame = embeddedValenceCount > 0
        ? embeddedSlashObjectSlotOperationFrameCandidate
        : null;
...
function buildCurrentRegexShorthandSourceFrame(rawValue = "") {
    ...
    const normalizedBare = bare && !bare.startsWith("-")
        ? normalizeRegexSpecialSerialShorthandCore(bare)
        : "";
...
function getDisambiguationSourceCoreFromParsed(parsedBase = null) {
    ...
    return normalizeRuleBase(
        parsedBase.canonical?.sourceBase
        || parsedBase.sourceBase
        || parsedBase.exactBaseVerb
        || parsedBase.canonicalRuleBase
        || parsedBase.analysisVerb
        || parsedBase.verb
        || ""
    );
}
...
function buildVerbDisambiguationSourceFrame(rawValue = "", parsedBase = null) {
    ...
    const sourceDisplayMirror = stripOptionalSupportiveI(parsed?.displayVerb || "");
    const hasBoundaryMarker = parsed?.hasSlashMarker === true || parsed?.canonical?.hasSlashMarker === true;
    const coreStructuralPrefixParts = Array.isArray(parsed?.canonical?.coreStructuralPrefixParts)
        ? parsed.canonical.coreStructuralPrefixParts
        : (Array.isArray(parsed?.coreStructuralPrefixParts) ? parsed.coreStructuralPrefixParts : []);
    const sourceTokenStream = [
        ...coreStructuralPrefixParts
            .map((piece, index) => ({
            ...
            .filter((piece) => piece.role && piece.value),
        ...(sourceCore ? [{
            role: "matrix",
            value: sourceCore,
    ...
    const boundaryFreeCore = hasBoundaryMarker && sourceTokenStream.length
        ? sourceTokenStream
            .filter((piece) => piece.role !== "supportive")
...
function buildVerbDisambiguationCandidateFrames(sourceFrame = null, options = {}) {
    ...
    if (sourceFrame.hasBoundaryMarker && sourceFrame.boundaryFreeCore) {
        addCandidateFrame(
            `${hasLeadingDash ? "-" : ""}${sourceFrame.boundaryFreeCore}`,
            "boundary-free-token-stream",
            false,
            { sourceTokenStream: sourceFrame.sourceTokenStream.map((piece) => ({ ...piece })) }
        );
    }
    ...
    affixes.forEach((affix) => {
        ...
        addCandidateFrame(candidateValue, "affix-boundary", true, { affix, remainder });
    });
    ...
    prefixes.forEach((prefix) => {
        ...
        addCandidateFrame(candidateValue, "prefix-boundary", false, { prefix, remainder });
    });
...
function buildVerbDisambiguationCandidatesFromOperationFrame(rawValue = "", operationFrame = null) {
    ...
    if (mismatch) {
        return { suggestions: [], patterns: [], sourceFrame: null, operationFrame: null, blockReason: mismatch };
    }
    ...
    if (!original) {
        return { suggestions: [], patterns: [], sourceFrame, operationFrame, blockReason: "missing-original-signature" };
    }
    ...
    (Array.isArray(operationFrame.candidateFrames) ? operationFrame.candidateFrames : []).forEach((candidateFrame) => {
        if (
            !candidateFrame
            || candidateFrame.kind !== "verb-disambiguation-candidate-frame"
            || candidateFrame.routeOperation !== operationFrame.routeOperation
            || candidateFrame.sourceCore !== sourceFrame.sourceCore
        ) {
            return;
        }
        ...
        if (
            !candidateValue
            || candidateValue === sourceFrame.sourceRawInput
            || candidateValue === sourceFrame.sourceDisplayMirror
            || seen.has(candidateValue)
        ) {
            return;
        }
...
function buildVerbDisambiguationCandidates(rawValue) {
    ...
    const operationFrame = buildVerbDisambiguationOperationFrame(sourceFrame, {
        isTransitive: getBaseObjectSlots(parsedBase) > 0,
    });
