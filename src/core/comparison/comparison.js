...
const COMPARISON_ANTI_CONFLATION_RULES = Object.freeze([
...
function normalizeComparisonRelation(value = "") {
    return normalizeComparisonEnum(
        value,
        Object.values(COMPARISON_RELATION),
        COMPARISON_RELATION.unknown
    );
}
...
function normalizeComparisonFalsePositiveSource(value = "") {
    return normalizeComparisonEnum(
        value,
        Object.values(COMPARISON_FALSE_POSITIVE_SOURCE),
        COMPARISON_FALSE_POSITIVE_SOURCE.unknown
    );
}
...
const LESSON53_COMPARISON_VALIDATION_REFS = Object.freeze([
    "src/tests/comparison.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const LESSON53_COMPARISON_PDF_REFS = Object.freeze([
    "Andrews Lesson 53.1",
    "Andrews Lesson 53.2",
    "Andrews Lesson 53.3",
    "Andrews Lesson 53.4",
...
const LESSON53_SIMILARITY_FRAME = Object.freeze({
    ...
    expressionRoutes: Object.freeze([
        Object.freeze({
...
const LESSON53_COMPARATIVE_DEGREE_FRAME = Object.freeze({
    ...
    routes: Object.freeze([
        ...
        Object.freeze({
            ...
            negativeIntroducers: Object.freeze([
                "inahmo",
                "in ahmo iuh",
                "in ahmo iuhqui",
                "in ahmo mach iuh",
...
const LESSON53_COMPARISON_QUESTION_FRAME = Object.freeze({
    ...
    comparativeCollocations: Object.freeze([
        "oc yeh",
        "oc eh",
        "zan yeh",
...
const LESSON53_COMPARISON_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({ id: "lesson53-similarity-overview", andrewsSection: "53.1", category: "similarity", directiveEs: "La semejanza puede expresarse por varios recursos; ninguno autoriza por si solo una forma Nawat visible.", engineSurface: "diagnostic comparison frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-similarity-reduplicative-prefix", andrewsSection: "53.1 item 1", category: "reduplicative-similarity", directiveEs: "Un prefijo reduplicativo puede crear sentido de quasi o parecido.", engineSurface: "diagnostic similarity frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-similarity-tla-possessive-source", andrewsSection: "53.1 item 2", category: "tla-possessive-source", directiveEs: "Un predicado posesivo con poseedor no especifico tla puede bajarse a tronco nominal de semejanza.", engineSurface: "diagnostic similarity frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-similarity-tloc-relational", andrewsSection: "53.1 item 3", category: "tloc-relational-nnc", directiveEs: "Una CNN posesiva sobre el relacional tloc puede servir como clausula principal de semejanza.", engineSurface: "diagnostic similarity frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-similarity-zan-no-yehhuatl", andrewsSection: "53.1 item 4", category: "same-as-zan-no-yehhuatl", directiveEs: "La construccion con zan no yehhuatl y variantes pertenece a modificacion adjetival no prepuesta.", engineSurface: "diagnostic similarity frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-similarity-nehnequi", andrewsSection: "53.1 item 5", category: "incorporated-complement-nehnequi", directiveEs: "Mo-nehnequi puede actuar como matriz de compuesto con complemento incorporado para semejanza.", engineSurface: "diagnostic similarity frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-similarity-resemble-verbstem-nnc", andrewsSection: "53.1 item 6", category: "resemble-verbstem-nnc", directiveEs: "Una CNN formada sobre tronco de parecerse o igualarse puede ser clausula principal.", engineSurface: "diagnostic similarity frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-similarity-ihui-iuhqui", andrewsSection: "53.1 item 7", category: "ihui-iuhqui", directiveEs: "Ihui e iuhqui forman una red de semejanza con clausula principal, adjunta, impersonal, topico e ic.", engineSurface: "diagnostic similarity frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-comparison-overview", andrewsSection: "53.2", category: "comparison-architecture", directiveEs: "La comparacion separa igualdad o semejanza de diferencia, y no se reduce a salida adjetival.", engineSurface: "diagnostic comparison frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-equality-quality-manner", andrewsSection: "53.3", category: "equality-quality-manner", directiveEs: "La igualdad de cualidad o manera puede usar iuhqui o ihuan.", engineSurface: "diagnostic equality frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-size-equality", andrewsSection: "53.4", category: "size-equality", directiveEs: "La igualdad de tamano usa ixquich o correlacion quezqui...no izqui.", engineSurface: "diagnostic size-comparison frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-comparative-degree", andrewsSection: "53.5", category: "comparative-degree", directiveEs: "El grado comparativo expresa desigualdad y suele usar conjuncion de solo dos conjuntivos.", engineSurface: "diagnostic comparative frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-comparative-adversative", andrewsSection: "53.5 item 1", category: "comparative-adversative", directiveEs: "Una ruta compara dos afirmativas por conjuncion adversativa con cencah o colocaciones.", engineSurface: "diagnostic comparative frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-comparative-negative-than", andrewsSection: "53.5 item 2", category: "affirmative-negative-than", directiveEs: "Otra ruta contrapone afirmativa y negativa introducida por inahmo o in ahmo iuh/iuhqui.", engineSurface: "diagnostic comparative frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-comparative-collocations", andrewsSection: "53.5 item 2a", category: "comparative-collocations", directiveEs: "Oc achi, oc cencah, oc yeh y variantes marcan el lado afirmativo de la comparacion.", engineSurface: "diagnostic comparative frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-comparative-tachcauh-hualcah", andrewsSection: "53.5 item 2b", category: "tachcauh-hualcah", directiveEs: "Tachcauh o hualcah pueden ser clausula principal; el punto de comparacion entra por ic.", engineSurface: "diagnostic comparative frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-comparative-tlapanahuia-unspecified-object", andrewsSection: "53.5 item 2c", category: "tlapanahuia-unspecified-object", directiveEs: "Tlapanahuia o tlacempanahuia pueden comparar sin objeto especificado y con punto introducido por ic.", engineSurface: "diagnostic comparative frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-comparative-panahuia-specified-object", andrewsSection: "53.5 item 2d", category: "panahuia-specified-object", directiveEs: "Panahuia con objeto aplicativo especificado puede hacer del estandar un objeto.", engineSurface: "diagnostic comparative frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-how-much-more-question", andrewsSection: "53.6", category: "how-much-more-question", directiveEs: "La pregunta cuanto mas inserta quen antes de colocaciones comparativas.", engineSurface: "diagnostic comparison-question frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson53-superlative-degree", andrewsSection: "53.7", category: "superlative-degree", directiveEs: "El superlativo borra el contraste negativo del comparativo y usa intensificadores o tlapanahuia con ic.", engineSurface: "diagnostic superlative frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
]);
...
function cloneComparisonLessonRecord(record) {
    ...
    return Object.fromEntries(
        Object.entries(record).map(([key, value]) => [key, cloneComparisonLessonRecord(value)])
    );
}
...
function classifyComparisonCandidate({
    ...
    const classification = {
        ...
        diagnostics: [
            ...
            normalizedFalsePositive !== COMPARISON_FALSE_POSITIVE_SOURCE.unknown
                ? "comparison-false-positive-source"
                : "comparison-unconfirmed",
        ],
