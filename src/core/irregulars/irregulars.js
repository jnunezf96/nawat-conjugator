...
const IRREGULARS_LESSON11_VALIDATION_REFS = Object.freeze([
    "src/tests/irregulars.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const IRREGULARS_LESSON11_PDF_REFS = Object.freeze([
    "Andrews Lesson 11.1",
    "Andrews Lesson 11.2",
    "Andrews Lesson 11.3",
    "Andrews Lesson 11.4",
...
const IRREGULARS_LESSON11_NATURE_FRAME = Object.freeze({
    ...
    primaryIrregularityLoci: Object.freeze([
        "perfective-stem-formation",
        "tense-form-meaning-alignment",
    ]),
    occasionalIrregularityLoci: Object.freeze([
        "tense-morph-shape",
        "number-morph-shape",
    ]),
...
const IRREGULARS_LESSON11_FORM_MEANING_ALIGNMENT_FRAME = Object.freeze({
    ...
    irregularInventory: Object.freeze([
        Object.freeze({ id: "ih-ca", function: "standing", pattern: "preterit-as-present plus distant-past-as-past", classMajority: "A" }),
        Object.freeze({ id: "on-o", function: "lying", pattern: "fused locative on plus preterit-as-present plus distant-past-as-past" }),
        Object.freeze({ id: "pil-ca", function: "hanging", pattern: "preterit-as-present plus distant-past-as-past" }),
        Object.freeze({ id: "a", function: "present-or-absent", pattern: "defective perfective-only preterit-as-present" }),
        Object.freeze({ id: "itzi", function: "come-go", pattern: "defective perfective-only preterit-as-present plus distant-past-as-past; never simple VNC" }),
        Object.freeze({ id: "am-i-a", function: "exist", pattern: "defective class C preterit-as-present in quen constructions" }),
        Object.freeze({ id: "0-i-a", function: "exist", pattern: "defective class C preterit-as-present with certain pronominal NNCs" }),
...
const IRREGULARS_LESSON11_SUPPLETION_FRAME = Object.freeze({
    ...
    andrewsSuppletiveParadigms: Object.freeze([
        Object.freeze({
            id: "ye-ca",
            ...
            constraints: Object.freeze([
                "present indicative is absent from (ye)",
                "(ca-t)/(ca-h) carry preterit-as-present and distant-past-as-past",
                "(ca-h) is singular preterit-as-present only",
            ]),
        }),
        Object.freeze({
            id: "ya-hui",
            ...
            constraints: Object.freeze([
                "(ya-uh) singular/common and (hui) plural for present indicative and nonpast optative",
                "(ya) does not form present indicative or nonpast optative",
                "(yah) forms preterit and nonpast admonitive",
            ]),
        }),
        Object.freeze({
            id: "hual-la-hui",
            ...
            constraints: Object.freeze([
                "same suppletive pattern as go",
                "directional/locative hual is fused to the suppletive stems",
            ]),
        }),
    ]),
...
const IRREGULARS_LESSON11_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({
        id: "lesson11-nature",
        andrewsSection: "11.1",
        category: "irregular-vnc-nature",
...
function cloneIrregularsLessonRecord(value) {
    ...
    return Object.fromEntries(
        Object.entries(value).map(([key, entry]) => [key, cloneIrregularsLessonRecord(entry)])
    );
}
