...
export function createClassicalNahuatlVncLayerEvaluatorApi(targetObject = globalThis) {
    ...
    function getClassicalNahuatlLesson20BoundaryFreeLexicalKey(value = "") {
    ...
    function resolveClassicalNahuatlLesson20InventoryEntry(inventory = null, sourceStem = "") {
      const lexicalIdentityKey = getClassicalNahuatlLesson20BoundaryFreeLexicalKey(sourceStem);
      const entry = lexicalIdentityKey && inventory && typeof inventory === "object"
        ? Object.entries(inventory).find(([candidateSourceStem]) => getClassicalNahuatlLesson20BoundaryFreeLexicalKey(candidateSourceStem) === lexicalIdentityKey) || null
        : null;
    ...
    const CLASSICAL_NAHUATL_CROSS_LESSON_NONACTIVE_SUPPLEMENTS = Object.freeze({
      ...
      "namaca": Object.freeze([Object.freeze({
        nonactiveStem: "namaquī-lō",
        suffixFamily: "lō",
        ruleId: "cn-l26-11-namaca-hypothetical-namaqui-lo-base",
        formationAuthority: "hypothetical-applicative-source",
        andrewsSection: "26.11",
        attestationStatus: "rare-type-three-applicative-source",
        sourceValenceMode: "transitive",
        userSelectable: true
      })]),
      "nequi": Object.freeze([Object.freeze({
        nonactiveStem: "nequi-lō",
        suffixFamily: "lō",
        ruleId: "cn-l26-23-nequi-lo-ambiguous-causative-base",
        formationAuthority: "later-canvas-source-witness",
        andrewsSection: "26.23",
        attestationStatus: "causative-applicative-ambiguity-source",
        sourceValenceMode: "transitive",
        userSelectable: true
      })]),
      ...
      "huā-qui": Object.freeze([Object.freeze({
        nonactiveStem: "huā-qui-lō",
        suffixFamily: "lō",
        ruleId: "cn-l25-8-huaqui-lo-base",
        formationAuthority: "hypothetical-causative-source",
        andrewsSection: "25.8",
        attestationStatus: "presupposed-type-two-causative-source",
        sourceValenceMode: "intransitive",
        userSelectable: true
      })]),
      "hue-tz-ca": Object.freeze([Object.freeze({
        ...
        suffixFamily: "hua",
        ruleId: "cn-l25-2-huetzca-huetzquihua-base",
        formationAuthority: "hypothetical-causative-source",
        andrewsSection: "25.2 note",
        attestationStatus: "valence-sensitive-presupposed-causative-source",
        allowedSourceValences: Object.freeze(["intransitive", "specific-projective"]),
        userSelectable: true
      })]),
      ...
      "itz-ti": Object.freeze([Object.freeze({
        nonactiveStem: "itz-ti-lō",
        suffixFamily: "lō",
        ruleId: "cn-l25-4-itzti-lo-base",
        formationAuthority: "hypothetical-causative-source",
        andrewsSection: "25.4.7",
        attestationStatus: "hypothetical-denominal-causative-source",
        sourceValenceMode: "intransitive",
        userSelectable: true
      })]),
      ...
      "neci": Object.freeze([Object.freeze({
        nonactiveStem: "nēxi-hua",
        suffixFamily: "hua",
        ruleId: "cn-l25-2-neci-neexihua-quantity-base",
        formationAuthority: "hypothetical-causative-source",
        andrewsSection: "25.2.2",
        attestationStatus: "canvas-lexical-quantity-relation",
        sourceValenceMode: "intransitive",
        userSelectable: true
      })]),
      ...
      "āhui-ya": Object.freeze([Object.freeze({
        nonactiveStem: "āhui-ya-lō",
        suffixFamily: "lō",
        ruleId: "cn-l25-4-ahuiya-retained-ya-lo-base",
        formationAuthority: "hypothetical-causative-source",
        andrewsSection: "25.4.8",
        attestationStatus: "canvas-licensed-retained-ya-variant",
        sourceValenceMode: "intransitive",
        userSelectable: true
      })]),
      "panō": Object.freeze([Object.freeze({
    ...
    function buildClassicalNahuatlLesson20ActiveStemIdentityFrame(sourceStem = "", {
      ...
      const enteredLexicalIdentityKey = getClassicalNahuatlLesson20BoundaryFreeLexicalKey(enteredStem);
      const identity = CLASSICAL_NAHUATL_LESSON20_ACTIVE_STEM_IDENTITIES.find(candidate => candidate.allowedAllomorphs.some(allomorph => getClassicalNahuatlLesson20BoundaryFreeLexicalKey(allomorph) === enteredLexicalIdentityKey)) || null;
      const canonicalEnteredAllomorph = identity?.allowedAllomorphs.find(allomorph => getClassicalNahuatlLesson20BoundaryFreeLexicalKey(allomorph) === enteredLexicalIdentityKey) || enteredStem;
      ...
      const exactNonactiveFormations = identity?.exactNonactiveFormations?.[canonicalEnteredAllomorph] || [];
      ...
      const exactNonactiveLicenseStatus = exactNonactiveFormations.length && allomorphLicenseAuthorized ? "licensed" : identity?.unresolvedAllomorphs?.[canonicalEnteredAllomorph] ? "documented-unresolved" : identityResolved && !allomorphLicenseAuthorized ? "context-mismatch" : "none";
      return Object.freeze({
    ...
    function buildClassicalNahuatlLesson20NonactiveCandidateLattice(sourceStem = "", {
      ...
      const fixedFormationResolution = resolveClassicalNahuatlLesson20InventoryEntry(CLASSICAL_NAHUATL_LESSON20_FIXED_FORMATIONS, normalizedSourceStem);
      const crossLessonSupplementResolution = resolveClassicalNahuatlLesson20InventoryEntry(CLASSICAL_NAHUATL_CROSS_LESSON_NONACTIVE_SUPPLEMENTS, normalizedSourceStem);
      const contextualFixedFormations = filterClassicalNahuatlLesson20FormationsForContext(fixedFormationResolution.formations, {
        sourceValence: normalizedValence
      });
      const fixedCandidates = contextualFixedFormations.filter(option => option.formationAuthority !== "optional-variant").map(option => ({
        ...
        inventorySourceStem: fixedFormationResolution.inventorySourceStem,
        sourceBoundaryFreeLexicalIdentityKey: fixedFormationResolution.lexicalIdentityKey,
        boundaryInsensitiveSourceMatch: fixedFormationResolution.boundaryInsensitiveMatch
      }));
      ...
      const transitiveSource = isClassicalNahuatlLesson20TransitiveValence(normalizedValence);
      const fixedSupplementalCandidates = baseCandidates.length ? filterClassicalNahuatlLesson20FormationsForContext(crossLessonSupplementResolution.formations, {
        sourceValence: normalizedValence
      }).map(option => ({
        ...option,
        ...
        inventorySourceStem: crossLessonSupplementResolution.inventorySourceStem,
        sourceBoundaryFreeLexicalIdentityKey: crossLessonSupplementResolution.lexicalIdentityKey,
        boundaryInsensitiveSourceMatch: crossLessonSupplementResolution.boundaryInsensitiveMatch
      })) : [];
      ...
      return Object.freeze({
        ...
        sourceFinalShapeFrame,
        sourceBoundaryFreeLexicalIdentityKey: fixedFormationResolution.lexicalIdentityKey,
        fixedFormationResolution,
        crossLessonSupplementResolution,
    ...
    function getClassicalNahuatlLesson23PositionPreviewCarrier(position = {}, subject = "") {
      if (position.objectKind === "reflexive") {
        return position.prominence === "mainline" || normalizeClassicalNahuatlVncSlotCarrier(position.objectPerson) === normalizeClassicalNahuatlVncSlotCarrier(subject) ? `${getClassicalNahuatlLesson23ReflexiveVa1(subject)}-o` : "ne";
      }
    ...
    function buildClassicalNahuatlLesson23ObjectClusterFrame(sourceStem = "", {
      ...
      const authorized = Boolean(normalizedSourceStem && normalizedSubject && normalizedPredicateStem && requestShapeAuthorized && specificShuntlineChoiceRecognized && specificShuntlineChoiceApplies && mainlineCount === 1 && positions.every(position => position.carrier));
      ...
      return {
        ...
        causativeSpecificShuntlineRuleFrame: specificShuntlineChoiceEligible ? {
          kind: "classical-nahuatl-lesson25.3-specific-shuntline-realization-rule-frame",
          version: 1,
          sourceAuthority: "Andrews transcription",
          sourceDocument: CLASSICAL_NAHUATL_VNC_SLOT_SOURCE_DOCUMENT,
          section: "25.3",
    ...
    function isClassicalNahuatlLesson23VoiceClusterSourceMachineryFrame(sourceMachineryFrame = null, sourceObjectClusterFrame = null) {
      ...
      const sourceKindAuthorized = sourceMachineryFrame?.kind === "classical-nahuatl-lesson23-multiple-object-vnc-machinery-frame"
      ...
      return Boolean(sourceMachineryFrame
        ...
        && isClassicalNahuatlLesson23ObjectClusterFrame(embeddedObjectClusterFrame, normalizedSourceStem)
        && isClassicalNahuatlLesson23ObjectClusterFrame(sourceObjectClusterFrame, normalizedSourceStem)
    ...
    function buildClassicalNahuatlLesson23VoiceObjectClusterFrame(sourceObjectClusterFrame = null, {
      ...
      const sourceClusterAuthorized = isClassicalNahuatlLesson23ObjectClusterFrame(sourceObjectClusterFrame);
      const sourceMachineryAuthorized = sourceClusterAuthorized && isClassicalNahuatlLesson23VoiceClusterSourceMachineryFrame(sourceMachineryFrame, sourceObjectClusterFrame);
      const sourceNonactiveRecordAuthorized = sourceClusterAuthorized && isClassicalNahuatlLesson20NonactiveStemRecord(nonactiveStemRecord, sourceObjectClusterFrame.sourceStem);
    ...
    function isClassicalNahuatlLesson23VoiceObjectClusterFrame(frame = null) {
      if (!frame || frame.kind !== "classical-nahuatl-lessons21-23-voice-object-cluster-frame" || frame.version !== 1 || frame.authorizationStatus !== "authorized" || frame.formulaArtifactAuthority !== false || frame.surfaceArtifactAuthority !== false || !isClassicalNahuatlLesson23ObjectClusterFrame(frame.sourceObjectClusterFrame) || !isClassicalNahuatlLesson23VoiceClusterSourceMachineryFrame(frame.sourceMachineryFrame, frame.sourceObjectClusterFrame) || !isClassicalNahuatlLesson20NonactiveStemRecord(frame.nonactiveStemRecord, frame.sourceObjectClusterFrame.sourceStem)) {
        return false;
      }
      const rebuilt = buildClassicalNahuatlLesson23VoiceObjectClusterFrame(frame.sourceObjectClusterFrame, {
        voice: frame.voice,
        tense: frame.tense,
    ...
    function doesClassicalNahuatlLesson23VoiceClusterMatchNonactiveTargetFrame(frame = null, targetMachineryFrame = null) {
      ...
      if (!isClassicalNahuatlVncSlotFrame(targetTypedFrame) || !normalizedTargetStem || !frame || !isClassicalNahuatlLesson20NonactiveStemRecord(record, frame.sourceObjectClusterFrame?.sourceStem)) {
        return false;
      }
      ...
      // The lower Class A voice builder may expose its regular short-o
      // imperfective allomorph before a later Canvas layer restores the exact
      // printed quantity. Admit that typed lower allomorph here without using
    ...
    function applyClassicalNahuatlLesson23ObjectClusterToMachineryFrame(lowerMachineryFrame = null, objectClusterFrame = null, {
      ...
      const directClusterAuthorized = isClassicalNahuatlLesson23ObjectClusterFrame(objectClusterFrame, lowerSourceStem)
      ...
      const voiceClusterAuthorized = isClassicalNahuatlLesson23VoiceObjectClusterFrame(objectClusterFrame)
      ...
      const sentenceSurfaceFrame = lowerSentenceSurfaceFrame?.sentenceSurfaceApplies === true ? {
        ...
        finalizerInputTypedVncSlotFrame: typedSlotFrame,
        finalizerConsumesFinalTypedVnc: true,
        formulaStringAuthority: false,
      ...
      const selectedOutputLogicFrame = {
        ...
        outputFillers: {
          ...
          selectedObjectSlot: objectClusterCarrier,
          sentenceBaseVncFormula: sentenceSurfaceFrame?.baseVncFormula || "",
          sentenceFinalizerInputRole: sentenceSurfaceFrame?.finalizerInputRole || "",
          sentenceFinalizerConsumesFinalTypedVnc: sentenceSurfaceFrame?.finalizerConsumesFinalTypedVnc === true
        }
      };
      return {
    ...
    function buildClassicalNahuatlLesson242NonactiveSurfaceFrame(sourceStem = "", {
      verbClass = "",
      sourceValence = "",
      optionId = ""
    } = {}) {
      ...
      const normalizedClass = normalizeClassicalNahuatlVncSlotCarrier(verbClass).toUpperCase();
      const normalizedValence = normalizeClassicalNahuatlVncSlotCarrier(sourceValence);
      const lowerNonactiveStemRecord = deriveClassicalNahuatlLesson20NonactiveStemRecord(normalizedSourceStem, {
        verbClass: normalizedClass,
        sourceValence: normalizedValence,
        optionId
      });
      const lowerRecordAuthorized = isClassicalNahuatlLesson20NonactiveStemRecord(lowerNonactiveStemRecord, normalizedSourceStem);
      ...
      const sourceValenceTyped = normalizedValence === "intransitive"
        || isClassicalNahuatlLesson20TransitiveValence(normalizedValence);
      ...
      const surfaceOperationFrame = Object.freeze({
        kind: "classical-nahuatl-lesson24.2-nonactive-printed-surface-operation-frame",
        version: 1,
      ...
      return Object.freeze({
        kind: "classical-nahuatl-lesson24.2-nonactive-printed-surface-frame",
        version: 1,
        ...
        lowerLayerFrameKind: "classical-nahuatl-lesson20-nonactive-stem-record",
    ...
    function isClassicalNahuatlLesson242NonactiveSurfaceFrame(frame = null, sourceStem = "") {
      const normalizedSourceStem = normalizeClassicalNahuatlVncSlotStem(sourceStem || frame?.sourceStem);
      if (!frame || frame.kind !== "classical-nahuatl-lesson24.2-nonactive-printed-surface-frame" || frame.authorizationStatus !== "authorized" || frame.sourceStem !== normalizedSourceStem) {
        return false;
      }
      const rebuilt = buildClassicalNahuatlLesson242NonactiveSurfaceFrame(normalizedSourceStem, {
    ...
    const CLASSICAL_NAHUATL_LESSON24_STOCK_FORMATION_PROFILES = Object.freeze([Object.freeze({
      profileId: "cn-l24-4-patl-a-stock",
      root: "patl",
      stockFormative: "ā",
      allowedStemFormatives: Object.freeze(["", "ni"]),
      andrewsSection: "24.4"
    })]);
    const CLASSICAL_NAHUATL_LESSON24_COALESCENCE_FORMATIVE_PROFILES = Object.freeze([Object.freeze({
      stockFormative: "ō",
      stemFormative: "ni",
      ...
      stockFormative: "ē",
      stemFormative: "hua",
      andrewsSection: "24.6.2"
    })]);
    const CLASSICAL_NAHUATL_LESSON24_LONG_TO_SHORT_VOWEL = Object.freeze({
      ā: "a",
      ē: "e",
      ī: "i",
      ō: "o"
    });
    const CLASSICAL_NAHUATL_LESSON24_SYNONYM_ROUTES = Object.freeze([Object.freeze({
      optionId: "cn-l24-6-3-tep-ehua-ehui",
      sourceStem: "tep-ē-hua",
      targetStem: "tep-ē-hui",
      andrewsSection: "24.6.3"
    }), Object.freeze({
      optionId: "cn-l24-6-3-toy-ahua-ahui",
      sourceStem: "tōy-ā-hua",
      targetStem: "tōy-ā-hui",
      andrewsSection: "24.6.3"
    })]);
    function normalizeClassicalNahuatlLesson24Morpheme(value = "") {
      return normalizeClassicalNahuatlVncSlotStem(value).replace(/^\*+/u, "").replace(/^-+|-+$/gu, "").trim();
    }
    function buildClassicalNahuatlLesson24StockFormationFrame({
      root = "",
      stockFormative = "",
      stemFormative = "",
      targetStem = "",
      ...
      const normalizedRoot = normalizeClassicalNahuatlLesson24Morpheme(root);
      const normalizedStockFormative = normalizeClassicalNahuatlLesson24Morpheme(stockFormative);
      const normalizedStemFormative = normalizeClassicalNahuatlLesson24Morpheme(stemFormative);
      const profile = CLASSICAL_NAHUATL_LESSON24_STOCK_FORMATION_PROFILES.find(candidate => candidate.root === normalizedRoot && candidate.stockFormative === normalizedStockFormative) || null;
      const stemFormativeAllowed = Boolean(profile && profile.allowedStemFormatives.includes(normalizedStemFormative));
      const authorized = Boolean(normalizedRoot && normalizedStockFormative && profile && stemFormativeAllowed);
      const stockStem = authorized ? `${normalizedRoot}-${normalizedStockFormative}-` : "";
      const generatedTargetStem = authorized ? normalizedStemFormative ? `${normalizedRoot}-${normalizedStockFormative}-${normalizedStemFormative}` : stockStem : "";
      const sourceMorphologyFrame = Object.freeze({
        kind: "classical-nahuatl-lesson24-root-stock-source-morphology-frame",
        version: 1,
        authorizationStatus: authorized ? "authorized" : "blocked",
        root: Object.freeze({ role: "root", rank: "root", morph: normalizedRoot }),
        stockFormative: Object.freeze({ role: "stock-formative", rank: "stock-formative", morph: normalizedStockFormative }),
        stemFormative: normalizedStemFormative ? Object.freeze({ role: "stem-formative", rank: "stem-formative", morph: normalizedStemFormative }) : null,
        morphOrder: Object.freeze(normalizedStemFormative ? ["root", "stock-formative", "stem-formative"] : ["root", "stock-formative"])
      });
      const formationSteps = authorized ? Object.freeze([Object.freeze({
        step: 1,
        operation: "add-stock-formative",
        consumesRank: "root",
        producesRank: "stock",
        sourceMorph: normalizedRoot,
        addedMorph: normalizedStockFormative,
        output: stockStem
      }), ...(normalizedStemFormative ? [Object.freeze({
        step: 2,
        operation: "add-stem-formative",
        consumesRank: "stock",
        producesRank: "verbstem",
        sourceMorph: stockStem,
        addedMorph: normalizedStemFormative,
        output: generatedTargetStem
      })] : [])]) : Object.freeze([]);
      return Object.freeze({
        kind: "classical-nahuatl-lesson24-stock-formation-frame",
        version: 1,
        sourceAuthority: "Andrews Lesson 24.4 root to stock to stem architecture",
        sourceDocument: CLASSICAL_NAHUATL_VNC_SLOT_SOURCE_DOCUMENT,
        andrewsSection: profile?.andrewsSection || "24.4",
        authorizationStatus: authorized ? "authorized" : "blocked",
        blockReason: authorized ? "" : !normalizedRoot || !normalizedStockFormative ? "lesson24-root-and-stock-formative-required" : !profile ? "lesson24-root-stock-relation-not-licensed" : "lesson24-stem-formative-not-licensed-for-stock",
        ...
        stockStem,
        targetStem: generatedTargetStem,
        outputRank: normalizedStemFormative ? "verbstem" : "stock",
        formationSteps,
        requestedArtifactsDiscarded: Boolean(normalizeClassicalNahuatlVncSlotStem(targetStem) || normalizeClassicalNahuatlVncSlotCarrier(surfaceArtifact)),
        outputGeneratedFromTypedSource: authorized,
        callerSuppliedTargetAllowed: false,
        targetStringAuthority: false,
        surfaceStringAuthority: false,
    ...
    function isClassicalNahuatlLesson24StockFormationFrame(frame = null) {
      if (!frame || frame.kind !== "classical-nahuatl-lesson24-stock-formation-frame" || frame.authorizationStatus !== "authorized") {
        return false;
      }
      const rebuilt = buildClassicalNahuatlLesson24StockFormationFrame({
        root: frame.sourceMorphologyFrame?.root?.morph,
        stockFormative: frame.sourceMorphologyFrame?.stockFormative?.morph,
        stemFormative: frame.sourceMorphologyFrame?.stemFormative?.morph || "",
        targetStem: frame.requestedArtifactsDiscarded === true ? "discarded-caller-artifact" : ""
      });
      return rebuilt.authorizationStatus === "authorized"
        && JSON.stringify(rebuilt) === JSON.stringify(frame);
    }
    function buildClassicalNahuatlLesson24VowelCoalescenceFrame({
      root = "",
      stockFormative = "",
      stemFormative = "",
      targetStem = "",
      ...
      const normalizedStockFormative = normalizeClassicalNahuatlLesson24Morpheme(stockFormative);
      const normalizedStemFormative = normalizeClassicalNahuatlLesson24Morpheme(stemFormative);
      const formativeProfile = CLASSICAL_NAHUATL_LESSON24_COALESCENCE_FORMATIVE_PROFILES.find(candidate => candidate.stockFormative === normalizedStockFormative && candidate.stemFormative === normalizedStemFormative) || null;
      const rootUnits = Array.from(normalizedRoot);
      const rootFinalVowel = rootUnits[rootUnits.length - 1] || "";
      const shortStockVowel = CLASSICAL_NAHUATL_LESSON24_LONG_TO_SHORT_VOWEL[normalizedStockFormative] || "";
      const identicalVowels = Boolean(shortStockVowel && rootFinalVowel === shortStockVowel);
      const authorized = Boolean(normalizedRoot && formativeProfile && identicalVowels);
      const retainedRoot = authorized ? rootUnits.slice(0, -1).join("") : "";
      const generatedTargetStem = authorized ? `${retainedRoot}${normalizedStockFormative}-${normalizedStemFormative}` : "";
      const sourceMorphologyFrame = Object.freeze({
        kind: "classical-nahuatl-lesson24-identical-vowel-source-morphology-frame",
        version: 1,
        authorizationStatus: authorized ? "authorized" : "blocked",
        root: Object.freeze({ role: "root", rank: "root", morph: normalizedRoot, finalVowel: rootFinalVowel }),
        stockFormative: Object.freeze({ role: "stock-formative", rank: "stock-formative", morph: normalizedStockFormative, underlyingShortVowel: shortStockVowel }),
        stemFormative: Object.freeze({ role: "stem-formative", rank: "stem-formative", morph: normalizedStemFormative }),
        morphOrder: Object.freeze(["root", "stock-formative", "stem-formative"])
      });
      return Object.freeze({
        kind: "classical-nahuatl-lesson24-identical-vowel-coalescence-frame",
        version: 1,
        sourceAuthority: "Andrews Lesson 24 identical root-final and stock-formative vowel coalescence",
        sourceDocument: CLASSICAL_NAHUATL_VNC_SLOT_SOURCE_DOCUMENT,
        andrewsSection: formativeProfile?.andrewsSection || "",
        authorizationStatus: authorized ? "authorized" : "blocked",
        blockReason: authorized ? "" : !normalizedRoot || !normalizedStockFormative || !normalizedStemFormative ? "lesson24-complete-root-stock-stem-analysis-required" : !formativeProfile ? "lesson24-stock-stem-formative-profile-not-licensed" : "lesson24-root-final-and-stock-formative-vowels-not-identical",
        sourceMorphologyFrame,
        root: normalizedRoot,
        stockFormative: normalizedStockFormative,
        stemFormative: normalizedStemFormative,
        uncoalescedStem: normalizedRoot && normalizedStockFormative && normalizedStemFormative ? `${normalizedRoot}-${normalizedStockFormative}-${normalizedStemFormative}` : "",
        targetStem: generatedTargetStem,
        coalescenceOperationFrame: Object.freeze({
          kind: "classical-nahuatl-lesson24-identical-vowel-coalescence-operation-frame",
          version: 1,
          authorizationStatus: authorized ? "authorized" : "blocked",
          leftVowel: rootFinalVowel,
          rightVowel: normalizedStockFormative,
          sharedVowelQuality: shortStockVowel,
          outputVowel: authorized ? normalizedStockFormative : "",
          consumesTwoUnderlyingVowels: authorized,
          producesOneLongVowel: authorized
        }),
        requestedArtifactsDiscarded: Boolean(normalizeClassicalNahuatlVncSlotStem(targetStem) || normalizeClassicalNahuatlVncSlotCarrier(surfaceArtifact)),
        outputGeneratedFromTypedSource: authorized,
        callerSuppliedTargetAllowed: false,
    ...
    function isClassicalNahuatlLesson24VowelCoalescenceFrame(frame = null) {
      if (!frame || frame.kind !== "classical-nahuatl-lesson24-identical-vowel-coalescence-frame" || frame.authorizationStatus !== "authorized") {
        return false;
      }
      const rebuilt = buildClassicalNahuatlLesson24VowelCoalescenceFrame({
        root: frame.sourceMorphologyFrame?.root?.morph,
        stockFormative: frame.sourceMorphologyFrame?.stockFormative?.morph,
        stemFormative: frame.sourceMorphologyFrame?.stemFormative?.morph,
        targetStem: frame.requestedArtifactsDiscarded === true ? "discarded-caller-artifact" : ""
    ...
    function getClassicalNahuatlLesson24SynonymOptionInventory(sourceStem = "") {
      const enteredSourceStem = normalizeClassicalNahuatlVncSlotStem(sourceStem);
      const sourceLexicalKey = getClassicalNahuatlLesson20BoundaryFreeLexicalKey(enteredSourceStem);
      const routes = CLASSICAL_NAHUATL_LESSON24_SYNONYM_ROUTES.filter(route => getClassicalNahuatlLesson20BoundaryFreeLexicalKey(route.sourceStem) === sourceLexicalKey);
      const options = routes.map(route => Object.freeze({
        kind: "classical-nahuatl-lesson24-synonym-option",
        version: 1,
        optionId: route.optionId,
        sourceStem: route.sourceStem,
        targetStem: route.targetStem,
        andrewsSection: route.andrewsSection,
        operation: "select-exact-destockal-synonym",
        selectionAuthority: "engine-owned-Andrews-exact-route-id",
        callerSuppliedTargetAllowed: false
      }));
      return Object.freeze({
        kind: "classical-nahuatl-lesson24-synonym-option-inventory",
        version: 1,
        sourceAuthority: "Andrews Lesson 24.6.3 exact destockal synonym pairs",
        sourceDocument: CLASSICAL_NAHUATL_VNC_SLOT_SOURCE_DOCUMENT,
        authorizationStatus: enteredSourceStem && options.length ? "authorized" : "blocked",
        blockReason: !enteredSourceStem ? "lesson24-synonym-source-stem-required" : options.length ? "" : "lesson24-synonym-source-not-attested",
        enteredSourceStem,
        sourceLexicalKey,
        canonicalSourceStem: routes[0]?.sourceStem || "",
        boundaryInsensitiveMatch: Boolean(routes.length && enteredSourceStem !== routes[0].sourceStem),
        options: Object.freeze(options),
        callerSuppliedTargetAllowed: false,
        targetStringAuthority: false
      });
    }
    function isClassicalNahuatlLesson24SynonymOptionInventory(frame = null, sourceStem = "") {
      if (!frame || frame.kind !== "classical-nahuatl-lesson24-synonym-option-inventory" || frame.authorizationStatus !== "authorized") {
        return false;
      }
      const canonicalSource = normalizeClassicalNahuatlVncSlotStem(sourceStem || frame.enteredSourceStem);
      const rebuilt = getClassicalNahuatlLesson24SynonymOptionInventory(canonicalSource);
      return rebuilt.authorizationStatus === "authorized"
        && JSON.stringify(rebuilt) === JSON.stringify(frame);
    }
    function deriveClassicalNahuatlLesson24SynonymFrame(sourceStem = "", {
      optionId = "",
      targetStem = "",
      surfaceArtifact = ""
    } = {}) {
      const inventory = getClassicalNahuatlLesson24SynonymOptionInventory(sourceStem);
      const normalizedOptionId = normalizeClassicalNahuatlVncSlotCarrier(optionId);
      const selectedOption = inventory.options.find(option => option.optionId === normalizedOptionId) || null;
      const authorized = Boolean(inventory.authorizationStatus === "authorized" && selectedOption);
      return Object.freeze({
        kind: "classical-nahuatl-lesson24-synonym-derivation-frame",
        version: 1,
        sourceAuthority: "Andrews Lesson 24.6.3 exact destockal synonym pair",
        sourceDocument: CLASSICAL_NAHUATL_VNC_SLOT_SOURCE_DOCUMENT,
        andrewsSection: selectedOption?.andrewsSection || "24.6.3",
        authorizationStatus: authorized ? "authorized" : "blocked",
        blockReason: authorized ? "" : inventory.authorizationStatus !== "authorized" ? inventory.blockReason : "lesson24-synonym-option-selection-required",
        optionInventory: inventory,
        selectedOptionId: selectedOption?.optionId || "",
        enteredSourceStem: inventory.enteredSourceStem,
        sourceStem: selectedOption?.sourceStem || "",
        targetStem: selectedOption?.targetStem || "",
        operation: selectedOption?.operation || "",
        requestedArtifactsDiscarded: Boolean(normalizeClassicalNahuatlVncSlotStem(targetStem) || normalizeClassicalNahuatlVncSlotCarrier(surfaceArtifact)),
        outputGeneratedFromExactRoute: authorized,
        callerSuppliedTargetAllowed: false,
        targetStringAuthority: false,
        surfaceStringAuthority: false,
        grammarGenerationAllowed: authorized,
    ...
    function isClassicalNahuatlLesson24SynonymFrame(frame = null, sourceStem = "") {
      if (!frame || frame.kind !== "classical-nahuatl-lesson24-synonym-derivation-frame" || frame.authorizationStatus !== "authorized") {
        return false;
      }
      const canonicalSource = normalizeClassicalNahuatlVncSlotStem(sourceStem || frame.enteredSourceStem);
      const rebuilt = deriveClassicalNahuatlLesson24SynonymFrame(canonicalSource, {
        optionId: frame.selectedOptionId,
        targetStem: frame.requestedArtifactsDiscarded === true ? "discarded-caller-artifact" : ""
      });
      return rebuilt.authorizationStatus === "authorized"
    ...
    function getClassicalNahuatlAuthorityCapabilityFrame(surfaceFrame = null) {
      ...
      const pendingDerivationSourceMachinery = machinery.kind === "classical-nahuatl-vnc-application-presentation-block-frame"
        && machinery.authorizationStatus === "blocked"
        && machinery.vncApplicationFrame?.resultFrame?.authorizationStatus === "blocked"
        && machinery.vncApplicationFrame.resultFrame.sourceMachineryFrame?.authorizationStatus === "authorized"
        ? machinery.vncApplicationFrame.resultFrame.sourceMachineryFrame
        : null;
      const capabilityMachinery = pendingDerivationSourceMachinery || machinery;
      ...
      const hasExpandedVnc = hasLesson7 && Boolean(capabilityMachinery.expandedVncBoundaryFrame || frameKinds.has("classical-nahuatl-lesson8-expanded-vnc-boundary-frame"));
      const hasSentenceSurface = hasLesson7 && Boolean(capabilityMachinery.sentenceSurfaceFrame || frameKinds.has("classical-nahuatl-lesson8-sentence-surface-frame"));
      return {
        ...
        capabilityBasis: pendingDerivationSourceMachinery ? "authorized-source-machinery-while-derived-result-pending" : "selected-machinery",
    ...
    function installClassicalNahuatlVncLayerEvaluatorClassicGlobals() {
      ...
      Object.assign(globalTarget, {
        ...
        buildClassicalNahuatlLesson242NonactiveSurfaceFrame,
        isClassicalNahuatlLesson242NonactiveSurfaceFrame,
        buildClassicalNahuatlLesson24StockFormationFrame,
        isClassicalNahuatlLesson24StockFormationFrame,
        buildClassicalNahuatlLesson24VowelCoalescenceFrame,
        isClassicalNahuatlLesson24VowelCoalescenceFrame,
        getClassicalNahuatlLesson24SynonymOptionInventory,
        isClassicalNahuatlLesson24SynonymOptionInventory,
        deriveClassicalNahuatlLesson24SynonymFrame,
        isClassicalNahuatlLesson24SynonymFrame,
    ...
    api.buildClassicalNahuatlLesson242NonactiveSurfaceFrame = buildClassicalNahuatlLesson242NonactiveSurfaceFrame;
    api.isClassicalNahuatlLesson242NonactiveSurfaceFrame = isClassicalNahuatlLesson242NonactiveSurfaceFrame;
    api.buildClassicalNahuatlLesson24StockFormationFrame = buildClassicalNahuatlLesson24StockFormationFrame;
    api.isClassicalNahuatlLesson24StockFormationFrame = isClassicalNahuatlLesson24StockFormationFrame;
    api.buildClassicalNahuatlLesson24VowelCoalescenceFrame = buildClassicalNahuatlLesson24VowelCoalescenceFrame;
    api.isClassicalNahuatlLesson24VowelCoalescenceFrame = isClassicalNahuatlLesson24VowelCoalescenceFrame;
    api.getClassicalNahuatlLesson24SynonymOptionInventory = getClassicalNahuatlLesson24SynonymOptionInventory;
    api.isClassicalNahuatlLesson24SynonymOptionInventory = isClassicalNahuatlLesson24SynonymOptionInventory;
    api.deriveClassicalNahuatlLesson24SynonymFrame = deriveClassicalNahuatlLesson24SynonymFrame;
    api.isClassicalNahuatlLesson24SynonymFrame = isClassicalNahuatlLesson24SynonymFrame;
