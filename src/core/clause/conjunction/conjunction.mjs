...
export function createConjunctionClauseGlobals(targetObject = globalThis) {
    ...
    api.buildConjunctionSurfaceSequence = buildConjunctionSurfaceSequence;
    api.buildConjunctionClauseAst = buildConjunctionClauseAst;
...
export function installConjunctionClauseGlobals(targetObject = globalThis) {
    const api = createConjunctionClauseGlobals(targetObject);
