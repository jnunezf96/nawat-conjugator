...
const LESSON51_COMPLEMENT_VALIDATION_REFS = Object.freeze([
    "src/tests/complement.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const LESSON51_COMPLEMENT_PDF_REFS = Object.freeze([
    "Andrews Lesson 51.1",
    "Andrews Lesson 51.2",
    "Andrews Lesson 51.3",
    "Andrews Lesson 51.4",
...
const LESSON51_DOUBLE_NUCLEUS_FRAME = Object.freeze({
    ...
    complementKinds: Object.freeze([
        COMPLEMENT_CLAUSE_ROLE.objectComplement,
        COMPLEMENT_CLAUSE_ROLE.subjectComplement,
        COMPLEMENT_CLAUSE_ROLE.adverbialComplement,
    ]),
...
const LESSON51_COMPLEMENT_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({ id: "lesson51-double-nucleus-overview", andrewsSection: "51.1", category: "double-nucleus-complementation", directiveEs: "La complementacion de esta leccion usa una CNN adyacente como complemento; no es generacion de palabra.", engineSurface: "diagnostic complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-object-complement-overview", andrewsSection: "51.2", category: "object-complement", directiveEs: "El complemento de objeto enlaza el pronombre de objeto principal con el sujeto de la CNN complemento y se distingue de suplementacion.", engineSurface: "diagnostic object-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-object-change", andrewsSection: "51.2.1", category: "object-complement-change", directiveEs: "El complemento nombra el papel que asume el referente del objeto; tambien puede haber objeto reflexivo.", engineSurface: "diagnostic object-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-object-material", andrewsSection: "51.2.2", category: "object-complement-material", directiveEs: "El complemento de objeto puede nombrar el material del referente del objeto.", engineSurface: "diagnostic object-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-object-designation", andrewsSection: "51.2.3", category: "object-complement-designation", directiveEs: "El complemento puede designar nombre; con posesivo cambia a complemento de poseedor.", engineSurface: "diagnostic object-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-object-state", andrewsSection: "51.2.4", category: "object-complement-state", directiveEs: "Una CNN adjetival puede indicar el estado del referente del objeto.", engineSurface: "diagnostic object-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-subject-complement-overview", andrewsSection: "51.3", category: "subject-complement", directiveEs: "El complemento de sujeto enlaza el sujeto de la CNN complemento con el sujeto de la CNV principal.", engineSurface: "diagnostic subject-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-subject-identity", andrewsSection: "51.3.1", category: "subject-complement-identity", directiveEs: "El complemento de sujeto puede indicar identidad o naturaleza del referente.", engineSurface: "diagnostic subject-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-subject-composition", andrewsSection: "51.3.2", category: "subject-complement-composition", directiveEs: "El complemento de sujeto puede indicar material o composicion.", engineSurface: "diagnostic subject-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-subject-state", andrewsSection: "51.3.3", category: "subject-complement-state", directiveEs: "El estado de sujeto puede parecer manera adverbial, pero el enlace se centra en el pronombre de sujeto.", engineSurface: "diagnostic subject-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-subject-passive-transform", andrewsSection: "51.3.4", category: "passive-object-complement-transform", directiveEs: "Una construccion de complemento de sujeto puede ser transformacion pasiva de complemento de objeto.", engineSurface: "diagnostic subject-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-adverbial-complement-overview", andrewsSection: "51.4", category: "adverbial-complement", directiveEs: "El complemento adverbial tiene capacidad adverbial y se licencia por familias de troncos principales.", engineSurface: "diagnostic adverbial-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-adverbial-coverage", andrewsSection: "51.4.1", category: "coverage-complement", directiveEs: "Mo-ca toma complementos de cobertura o llenura; la CNN complemento suele ser singular incluso con tronco animado.", engineSurface: "diagnostic adverbial-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-adverbial-beginning", andrewsSection: "51.4.2", category: "beginning-complement", directiveEs: "Pehua toma complemento que se parece a proposito o conjuncion, pero no se asigna completamente a ninguno.", engineSurface: "diagnostic adverbial-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-adverbial-satisfaction", andrewsSection: "51.4.3", category: "satisfaction-complement", directiveEs: "Pachihui sigue el patron de pehua y normalmente lleva presente en la clausula adyacente.", engineSurface: "diagnostic adverbial-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-adverbial-daring", andrewsSection: "51.4.4", category: "daring-complement", directiveEs: "Tlahpalihui o motlahpaloa determinan el tiempo del complemento, normalmente posterior.", engineSurface: "diagnostic adverbial-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-adverbial-cessation", andrewsSection: "51.4.5", category: "cessation-complement", directiveEs: "Mocahua puede tomar complemento de cesacion.", engineSurface: "diagnostic adverbial-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-adverbial-tarrying", andrewsSection: "51.4.6", category: "tarrying-complement", directiveEs: "Huehcahua puede tomar complemento de tardanza.", engineSurface: "diagnostic adverbial-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson51-adverbial-relational-lexicalized", andrewsSection: "51.4.7", category: "relational-lexicalized-complement", directiveEs: "Una CNN relacional puede asociarse idiomaticamente con tronco compatible; se aprende como vocabulario.", engineSurface: "diagnostic adverbial-complement frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
]);
...
function cloneComplementClauseLessonRecord(record) {
    ...
    return Object.fromEntries(
        Object.entries(record).map(([key, value]) => [key, cloneComplementClauseLessonRecord(value)])
    );
}
