...
export function createAdjectivalModificationGlobals(targetObject = globalThis) {
    ...
    const ADJECTIVAL_MODIFICATION_ANTI_CONFLATION_RULES = Object.freeze(["adjectival modification boundary metadata is not generation", "modificationAst composes existing clause outputs; it does not create new Nawat word forms", "adjetivo route output is not a clause-level modification AST", "nominalizationProfile is not adjectival modification syntax", "ordinary NNC formulaSlots are not modifier/head relation metadata", "single generated words do not prove modification, supplementation, or topic relations", "Andrews modification categories are architecture, not Nawat/Pipil orthography authority"]);
    ...
    const LESSON42_ADJECTIVAL_MODIFICATION_VALIDATION_REFS = Object.freeze(["src/tests/modification.test.js", "src/tests/registry.test.js", "docs/GRAMMAR_SPEC.md"]);
    const LESSON42_ADJECTIVAL_MODIFICATION_PDF_REFS = Object.freeze(["Andrews Lesson 42.1", "Andrews Lesson 42.2", "Andrews Lesson 42.3", "Andrews Lesson 42.4", "Andrews Lesson 42.5", "Andrews Lesson 42.6", "Andrews Lesson 42.7", "Andrews Lesson 42.8", "Andrews Lesson 42.8.1", "Andrews Lesson 42.8.2", "Andrews Lesson 42.8.3", "Andrews Lesson 42.8.4", "Andrews Lesson 42.8.5", "Andrews Lesson 42.8.6", "Andrews Lesson 42.8.7", "Andrews Lesson 42.8.8", "Andrews Lesson 42.8.9", "Andrews Lesson 42.9", "Andrews Lesson 42.10"]);
    ...
    const LESSON42_SUPPLEMENTATION_AMBIGUITY_FRAME = Object.freeze({
      ...
      ambiguityPatterns: Object.freeze(["principal-plus-adjunct", "principal-plus-in-plus-adjunct", "adjunct-plus-principal", "in-plus-adjunct-plus-principal"])
    });
    ...
    const LESSON42_ADJECTIVAL_MODIFICATION_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      id: "lesson42-modification-overview",
      andrewsSection: "42.1",
      category: "modification-overview",
      directiveEs: "La modificacion puede ser de nucleo unico o multiple, adjetival o adverbial; esta leccion enfoca la modificacion adjetival multinuclear.",
      engineSurface: "diagnostic modification boundary plus partial AST",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-multiple-nucleus-modification",
      andrewsSection: "42.2",
      category: "multiple-nucleus-adjectival-modification",
      directiveEs: "Todo modificador adjetival no incrustado es clausula; el enlace viene de pronombres afijales correferentes, no de pronombre relativo.",
      engineSurface: "partial modificationAst builder",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-preposed-modifier",
      andrewsSection: "42.3",
      category: "preposed-modifier",
      directiveEs: "El modificador prepuesto no es topico y se une mas estrechamente al nucleo principal.",
      engineSurface: "partial preposed-order AST metadata",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-adjoined-unit",
      andrewsSection: "42.4",
      category: "adjoined-modification-unit",
      directiveEs: "Una estructura de modificacion puede ser unidad adjunta; in antes del modificador prepuesto subordina toda la estructura.",
      engineSurface: "partial marked-adjoined AST metadata",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-principal-unit",
      andrewsSection: "42.5",
      category: "principal-modification-unit",
      directiveEs: "Una estructura de modificacion tambien puede funcionar como unidad principal de una estructura mayor.",
      engineSurface: "diagnostic principal-unit frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-supplementation-ambiguity",
      andrewsSection: "42.6",
      category: "supplementation-modification-ambiguity",
      directiveEs: "Suplementacion y modificacion son aposicionales; la clausula principal entendida controla el significado y la ambiguedad.",
      engineSurface: "partial ambiguity diagnostics",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-compound-head-modifier",
      andrewsSection: "42.7",
      category: "compound-head-modification",
      directiveEs: "Si la cabeza es CNN compuesta, el modificador tiende a relacionarse con la matriz salvo metafora lexicalizada.",
      engineSurface: "diagnostic compound-head frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-modifier-function-types",
      andrewsSection: "42.8",
      category: "modifier-function-types",
      directiveEs: "Muchos tipos de CN pueden funcionar como adjuntos adjetivales; no se limita a CNN adjetivas.",
      engineSurface: "diagnostic modifier-type frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-intransitive-vnc-modifier",
      andrewsSection: "42.8.1",
      category: "intransitive-vnc-modifier",
      directiveEs: "Una CNV intransitiva puede modificar adjetivamente sin nominalizarse.",
      engineSurface: "diagnostic modifier-type frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-transitive-vnc-modifier",
      andrewsSection: "42.8.2",
      category: "transitive-vnc-modifier",
      directiveEs: "Una CNV transitiva puede enlazar por sujeto u objeto; la ambiguedad depende de animacidad, persona, numero y significado.",
      engineSurface: "diagnostic modifier-type frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-adverbialized-nnc-modifier",
      andrewsSection: "42.8.3",
      category: "adverbialized-nnc-modifier",
      directiveEs: "Una CNN adverbializada puede funcionar como modificador adjetival.",
      engineSurface: "diagnostic modifier-type frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-cardinal-numeral-modifier",
      andrewsSection: "42.8.4",
      category: "cardinal-numeral-modifier-or-head",
      directiveEs: "Una CNN numeral cardinal puede ser modificador o cabeza; el ingles suele ocultar la relacion interna.",
      engineSurface: "diagnostic modifier-type frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-quantitive-pronominal-modifier",
      andrewsSection: "42.8.5",
      category: "quantitive-pronominal-modifier-or-head",
      directiveEs: "Una CNN pronominal cuantitativa puede usar forma singular con referente plural y tambien servir como cabeza.",
      engineSurface: "diagnostic modifier-type frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-nnc-modifier",
      andrewsSection: "42.8.6",
      category: "nnc-modifier",
      directiveEs: "Una CNN puede modificar otra CNN; puede corresponder a un compuesto nominal de nucleo unico.",
      engineSurface: "diagnostic modifier-type frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-supplementation-structure-modifier",
      andrewsSection: "42.8.7",
      category: "supplementation-structure-modifier",
      directiveEs: "Una estructura de suplementacion completa puede funcionar como modificador.",
      engineSurface: "diagnostic modifier-type frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-pronominal-nnc-cooperation",
      andrewsSection: "42.8.8",
      category: "pronominal-nnc-cooperation",
      directiveEs: "Con CNN pronominal personal o demostrativa, la CNN comun es la aposicion modificadora aunque la traduccion sugiera otra cosa.",
      engineSurface: "diagnostic modifier-type frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-measure-nnc-head",
      andrewsSection: "42.8.9",
      category: "measure-nnc-head",
      directiveEs: "La CNN de medida es la cabeza y la cosa medida es el modificador adjetival.",
      engineSurface: "diagnostic modifier-type frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-recursion",
      andrewsSection: "42.9",
      category: "recursive-modification",
      directiveEs: "La transformacion de modificacion es recursiva: una estructura modificada puede ser cabeza de otra.",
      engineSurface: "diagnostic recursion frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson42-incorporated-modification",
      andrewsSection: "42.10",
      category: "incorporated-modification-structure",
      directiveEs: "Una estructura completa modificador+cabeza puede incrustarse en un compuesto; las CNN conservan pronombres salvo el dyad de numero de la cabeza.",
      engineSurface: "diagnostic incorporated-modification frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    })]);
    function cloneAdjectivalModificationLessonRecord(record) {
      ...
      return Object.fromEntries(Object.entries(record).map(([key, value]) => [key, cloneAdjectivalModificationLessonRecord(value)]));
    }
    ...
    function buildLesson42AdjectivalModificationPursuitFrame() {
      ...
      const remainingGaps = ["Current Lesson 42 modification support is partial and does not exhaust multiple-nucleus modification syntax, all modifier/head order patterns, all supplementation ambiguities, compound-head matrix targeting, all modifier clause types, recursion, or incorporated modification structures.", "The current modificationAst composes supplied generated surfaces and records selected order/scope diagnostics; it does not parse or generate Nawat clause examples.", "Transitive VNC modifier ambiguity, pronominal/quantitive/numeral head behavior, measure NNC head behavior, and incorporated modifier-head compounds remain diagnostic.", "A complete Andrews modifier/head clause-source model plus orthography context is still required before fixture data, parser/search detection, acciones de interfaz, or generation routing can expand."];
      const frame = {
    ...
    const LESSON43_ADJECTIVAL_MODIFICATION_VALIDATION_REFS = Object.freeze(["src/tests/modification.test.js", "src/tests/registry.test.js", "docs/GRAMMAR_SPEC.md"]);
    const LESSON43_ADJECTIVAL_MODIFICATION_PDF_REFS = Object.freeze(["Andrews Lesson 43.1", "Andrews Lesson 43.2", "Andrews Lesson 43.3", "Andrews Lesson 43.4", "Andrews Lesson 43.4.1", "Andrews Lesson 43.4.2", "Andrews Lesson 43.5", "Andrews Lesson 43.6", "Andrews Lesson 43.6.1", "Andrews Lesson 43.6.2", "Andrews Lesson 43.7", "Andrews Lesson 43.7.1", "Andrews Lesson 43.7.2", "Andrews Lesson 43.8", "Andrews Lesson 43.9"]);
    ...
    const LESSON43_ADJECTIVAL_MODIFICATION_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      id: "lesson43-nonpreposed-supplementary-elements",
      andrewsSection: "43.1 item 1",
      category: "nonpreposed-modifier-supplementation",
      directiveEs: "El modificador no prepuesto puede contener elementos suplementarios que no caben en el modificador prepuesto.",
      engineSurface: "diagnostic nonpreposed-modifier frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-nonpreposed-distant-supplement",
      andrewsSection: "43.1 item 2",
      category: "distant-supplementary-element",
      directiveEs: "Un elemento suplementario dentro del adjunto adjetival puede estar a distancia.",
      engineSurface: "diagnostic discontinuity frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-pronominal-head-nonpreposed",
      andrewsSection: "43.1 item 3",
      category: "personal-pronominal-nnc-head",
      directiveEs: "La construccion favorita combina modificador no prepuesto con una CNN pronominal personal como cabeza; la traduccion inglesa suele falsear la estructura.",
      engineSurface: "diagnostic nonpreposed-modifier frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-numeral-quantitive-head",
      andrewsSection: "43.1 item 4",
      category: "numeral-or-quantitive-head",
      directiveEs: "El adjunto no prepuesto modifica con frecuencia una cabeza numeral o cuantitativa; el ingles suele ocultar esa ponderacion.",
      engineSurface: "diagnostic nonpreposed-modifier frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-preposed-nonpreposed-cooperation",
      andrewsSection: "43.2",
      category: "modifier-position-cooperation",
      directiveEs: "Un mismo nucleo puede recibir modificadores prepuestos y no prepuestos.",
      engineSurface: "diagnostic same-head multi-position frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-discontinuous-topicalized-head",
      andrewsSection: "43.3 source transform",
      category: "discontinuous-topicalized-head",
      directiveEs: "La discontinuidad frecuente topicaliza la cabeza y deja intacto el modificador.",
      engineSurface: "partial discontinuous-order AST metadata",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-discontinuous-no-adjunctor",
      andrewsSection: "43.3 no adjunctor",
      category: "discontinuous-no-adjunctor",
      directiveEs: "A veces el modificador discontinuo no esta introducido por adjuntor.",
      engineSurface: "diagnostic discontinuity frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-discontinuous-shifted-modifier",
      andrewsSection: "43.3 shifted modifier",
      category: "discontinuous-shifted-modifier",
      directiveEs: "Menos frecuente: la cabeza queda en su sitio y el modificador se desplaza; puede funcionar como adjunto adverbial o sujeto suplementario.",
      engineSurface: "diagnostic discontinuity frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-interrogative-head-ambiguity",
      andrewsSection: "43.4",
      category: "interrogative-pronominal-head",
      directiveEs: "Ac y tleh como clausulas principales no son pronombres relativos; la estructura es ambigua entre suplementacion y modificacion.",
      engineSurface: "diagnostic interrogative-head frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-interrogative-head-in-unit",
      andrewsSection: "43.4 in warning",
      category: "adjunctor-in-unit",
      directiveEs: "La escritura solida tradicional disfraza que in forma unidad con la clausula que sigue.",
      engineSurface: "diagnostic interrogative-head frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-interrogative-supplementation",
      andrewsSection: "43.4.1",
      category: "interrogative-supplementation",
      directiveEs: "En suplementacion adjunta, ac se entiende como persona(s) y tleh como cosa(s); ac/tleh siguen siendo clausulas principales.",
      engineSurface: "diagnostic ambiguity frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-interrogative-modification",
      andrewsSection: "43.4.2",
      category: "interrogative-modification",
      directiveEs: "En modificacion adjunta, ac se entiende como alguien/cualquiera y tleh como algo/cualquier cosa; za zo ac/tleh in da valores de quienquiera/lo que sea.",
      engineSurface: "diagnostic ambiguity frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-other-interrogative-heads",
      andrewsSection: "43.4 remark",
      category: "other-interrogative-nnc-heads",
      directiveEs: "Otras CNN interrogativas tambien pueden usarse en estructuras de modificacion.",
      engineSurface: "diagnostic interrogative-head frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-oc-ce-head",
      andrewsSection: "43.5",
      category: "oc-ce-collocation-head",
      directiveEs: "La colocacion oc ce puede servir como cabeza en una estructura de modificacion.",
      engineSurface: "diagnostic oc-ce head frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-shared-referent-violation-overview",
      andrewsSection: "43.6",
      category: "shared-referent-violation",
      directiveEs: "Algunas estructuras idiomaticas violan la restriccion general de correferente compartido.",
      engineSurface: "diagnostic shared-referent violation frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-cem-pronominal-group",
      andrewsSection: "43.6.1",
      category: "cem-pronominal-group",
      directiveEs: "Con grupo pronominal, la CNN con cem puede preferir pronombre sujeto plural, aunque tercera singular tambien es posible.",
      engineSurface: "diagnostic cem group frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-cem-nnc-group",
      andrewsSection: "43.6.2",
      category: "cem-nnc-group",
      directiveEs: "Con grupo CNN, la CNN con cem tambien prefiere pronombre sujeto plural y permite tercera singular.",
      engineSurface: "diagnostic cem group frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-acah-one-of",
      andrewsSection: "43.7.1",
      category: "acah-one-of",
      directiveEs: "Una CNN con acah puede reemplazar a cemeh o cooperar con ella para expresar uno de.",
      engineSurface: "diagnostic one-of frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-ayac-none-of",
      andrewsSection: "43.7.2",
      category: "ayac-none-of",
      directiveEs: "La CNN negativa ayac puede expresar ninguno de un grupo.",
      engineSurface: "diagnostic none-of frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-male-bonding-modifier",
      andrewsSection: "43.8",
      category: "male-bonding-modifier",
      directiveEs: "La estructura con oquich usa primera plural cuando el hablante varon tiene vinculo social o familiar con el grupo; no exige acuerdo con la CNN cooperante.",
      engineSurface: "diagnostic idiomatic modifier frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson43-named-partner-modifier",
      andrewsSection: "43.9",
      category: "named-partner-modifier",
      directiveEs: "Cuando el grupo incluye entidad conocida y entidad tercera nombrada, normalmente solo se menciona la entidad tercera nombrada en el modificador.",
      engineSurface: "diagnostic idiomatic modifier frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    })]);
    ...
    function buildLesson43AdjectivalModificationPursuitFrame() {
      ...
      const remainingGaps = ["Current Lesson 43 support records Andrews' nonpreposed, cooperating, discontinuous, interrogative-head, oc ce, one-of, male-bonding, and named-partner structures as diagnostics; it does not parse full sentence distance or transform topology.", "The current modificationAst can mark discontinuous order, but it does not detect topicalized heads, absent adjunctors, interrogative-head ambiguity, oc ce heads, or idiomatic shared-referent violations from raw Nawat clauses.", "The ac/tleh and in-unit warning is recorded as structural metadata only; it does not import traditional Classical solid spellings as Nawat/Pipil fixtures.", "A complete Andrews modifier/head clause-source model plus orthography context is still required before fixture data, parser/search detection, acciones de interfaz, or generation routing can expand."];
      const frame = {
    ...
    function normalizeAdjectivalModificationOrder(value = "") {
      return normalizeAdjectivalModificationEnum(value, Object.values(ADJECTIVAL_MODIFICATION_ORDER), ADJECTIVAL_MODIFICATION_ORDER.unknown);
    }
    function normalizeAdjectivalModificationScope(value = "") {
      return normalizeAdjectivalModificationEnum(value, Object.values(ADJECTIVAL_MODIFICATION_SCOPE), ADJECTIVAL_MODIFICATION_SCOPE.unknown);
    }
    function normalizeAdjectivalModificationLinkRole(value = "") {
      return normalizeAdjectivalModificationEnum(value, Object.values(ADJECTIVAL_MODIFICATION_LINK_ROLE), ADJECTIVAL_MODIFICATION_LINK_ROLE.unknown);
    }
    ...
    function getAdjectivalModificationFormulaSlots(input = null) {
      ...
      return input.formulaSlots || input.clauseFrame?.formulaSlots || input.nncBasic?.formulaSlots || input.nuclearClauseShell?.formulaSlots || input.adjectivalNncFunctionFrame?.sourceFormulaSlots || null;
    }
    function getAdjectivalModificationFormulaEcho(input = null) {
      if (!input || typeof input !== "object") {
        return "";
      }
      return String(input.formulaEcho || input.clauseFrame?.formulaEcho || input.nncBasic?.formulaEcho || input.nuclearClauseShell?.formulaEcho || input.adjectivalNncFunctionFrame?.sourceFormulaEcho || "");
    }
    ...
    function buildAdjectivalModificationAst({
      ...
      if ((normalizedOrder === ADJECTIVAL_MODIFICATION_ORDER.headMarkedModifier || normalizedOrder === ADJECTIVAL_MODIFICATION_ORDER.markedModifierHeadAdjoined) && !markerText) {
        diagnostics.push("adjectival-modification-marked-order-requires-marker");
      }
      if (normalizedOrder === ADJECTIVAL_MODIFICATION_ORDER.markedModifierHeadAdjoined && normalizedScope === ADJECTIVAL_MODIFICATION_SCOPE.standalone) {
      ...
      const surfaceSequence = supported ? buildAdjectivalModificationSurfaceSequence({
      ...
      return targetObject.attachGrammarAstContract({
        ...
        transformations: {
          isPreposed: normalizedOrder === ADJECTIVAL_MODIFICATION_ORDER.modifierHeadPreposed || normalizedOrder === ADJECTIVAL_MODIFICATION_ORDER.markedModifierHeadAdjoined,
          isMarked: Boolean(markerText),
          isDiscontinuous: normalizedOrder === ADJECTIVAL_MODIFICATION_ORDER.discontinuous,
          isTopic: false
        },
        ambiguity: {
          withSupplementation: normalizedOrder === ADJECTIVAL_MODIFICATION_ORDER.headModifier || normalizedOrder === ADJECTIVAL_MODIFICATION_ORDER.headMarkedModifier || normalizedOrder === ADJECTIVAL_MODIFICATION_ORDER.modifierHeadPreposed,
    ...
    Object.defineProperty(api, "ADJECTIVAL_MODIFICATION_ORDER", {
        configurable: true,
        enumerable: true,
        get() { return ADJECTIVAL_MODIFICATION_ORDER; },
    });
    Object.defineProperty(api, "ADJECTIVAL_MODIFICATION_SCOPE", {
        configurable: true,
        enumerable: true,
        get() { return ADJECTIVAL_MODIFICATION_SCOPE; },
    });
    Object.defineProperty(api, "ADJECTIVAL_MODIFICATION_LINK_ROLE", {
        configurable: true,
        enumerable: true,
        get() { return ADJECTIVAL_MODIFICATION_LINK_ROLE; },
    });
    ...
    Object.defineProperty(api, "LESSON42_ADJECTIVAL_MODIFICATION_VALIDATION_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_ADJECTIVAL_MODIFICATION_VALIDATION_REFS; },
    });
    Object.defineProperty(api, "LESSON42_ADJECTIVAL_MODIFICATION_PDF_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_ADJECTIVAL_MODIFICATION_PDF_REFS; },
    });
    Object.defineProperty(api, "LESSON42_MODIFICATION_OVERVIEW_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_MODIFICATION_OVERVIEW_FRAME; },
    });
    Object.defineProperty(api, "LESSON42_MULTIPLE_NUCLEUS_ADJECTIVAL_MODIFICATION_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_MULTIPLE_NUCLEUS_ADJECTIVAL_MODIFICATION_FRAME; },
    });
    Object.defineProperty(api, "LESSON42_PREPOSED_MODIFIER_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_PREPOSED_MODIFIER_FRAME; },
    });
    Object.defineProperty(api, "LESSON42_ADJOINED_UNIT_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_ADJOINED_UNIT_FRAME; },
    });
    Object.defineProperty(api, "LESSON42_PRINCIPAL_UNIT_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_PRINCIPAL_UNIT_FRAME; },
    });
    Object.defineProperty(api, "LESSON42_SUPPLEMENTATION_AMBIGUITY_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_SUPPLEMENTATION_AMBIGUITY_FRAME; },
    });
    Object.defineProperty(api, "LESSON42_COMPOUND_HEAD_MODIFIER_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_COMPOUND_HEAD_MODIFIER_FRAME; },
    });
    Object.defineProperty(api, "LESSON42_MODIFIER_FUNCTION_TYPES_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_MODIFIER_FUNCTION_TYPES_FRAME; },
    });
    Object.defineProperty(api, "LESSON42_RECURSION_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_RECURSION_FRAME; },
    });
    Object.defineProperty(api, "LESSON42_INCORPORATED_MODIFICATION_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_INCORPORATED_MODIFICATION_FRAME; },
    });
    Object.defineProperty(api, "LESSON42_ADJECTIVAL_MODIFICATION_SUBSECTION_INVENTORY", {
        configurable: true,
        enumerable: true,
        get() { return LESSON42_ADJECTIVAL_MODIFICATION_SUBSECTION_INVENTORY; },
    });
    api.cloneAdjectivalModificationLessonRecord = cloneAdjectivalModificationLessonRecord;
    api.getLesson42AdjectivalModificationSubsectionInventory = getLesson42AdjectivalModificationSubsectionInventory;
    api.attachAdjectivalModificationPursuitGrammarContract = attachAdjectivalModificationPursuitGrammarContract;
    api.buildLesson42AdjectivalModificationPursuitFrame = buildLesson42AdjectivalModificationPursuitFrame;
    Object.defineProperty(api, "LESSON43_ADJECTIVAL_MODIFICATION_VALIDATION_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_ADJECTIVAL_MODIFICATION_VALIDATION_REFS; },
    });
    Object.defineProperty(api, "LESSON43_ADJECTIVAL_MODIFICATION_PDF_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_ADJECTIVAL_MODIFICATION_PDF_REFS; },
    });
    Object.defineProperty(api, "LESSON43_NONPREPOSED_MODIFIER_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_NONPREPOSED_MODIFIER_FRAME; },
    });
    Object.defineProperty(api, "LESSON43_PREPOSED_NONPREPOSED_COOPERATION_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_PREPOSED_NONPREPOSED_COOPERATION_FRAME; },
    });
    Object.defineProperty(api, "LESSON43_DISCONTINUOUS_MODIFIER_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_DISCONTINUOUS_MODIFIER_FRAME; },
    });
    Object.defineProperty(api, "LESSON43_INTERROGATIVE_HEAD_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_INTERROGATIVE_HEAD_FRAME; },
    });
    Object.defineProperty(api, "LESSON43_OC_CE_COLLOCATION_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_OC_CE_COLLOCATION_FRAME; },
    });
    Object.defineProperty(api, "LESSON43_SHARED_REFERENT_VIOLATION_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_SHARED_REFERENT_VIOLATION_FRAME; },
    });
    Object.defineProperty(api, "LESSON43_ONE_OF_NONE_OF_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_ONE_OF_NONE_OF_FRAME; },
    });
    Object.defineProperty(api, "LESSON43_MALE_BONDING_MODIFIER_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_MALE_BONDING_MODIFIER_FRAME; },
    });
    Object.defineProperty(api, "LESSON43_NAMED_PARTNER_MODIFIER_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_NAMED_PARTNER_MODIFIER_FRAME; },
    });
    Object.defineProperty(api, "LESSON43_ADJECTIVAL_MODIFICATION_SUBSECTION_INVENTORY", {
        configurable: true,
        enumerable: true,
        get() { return LESSON43_ADJECTIVAL_MODIFICATION_SUBSECTION_INVENTORY; },
    });
    api.getLesson43AdjectivalModificationSubsectionInventory = getLesson43AdjectivalModificationSubsectionInventory;
    api.buildLesson43AdjectivalModificationPursuitFrame = buildLesson43AdjectivalModificationPursuitFrame;
    ...
    api.normalizeAdjectivalModificationOrder = normalizeAdjectivalModificationOrder;
    api.normalizeAdjectivalModificationScope = normalizeAdjectivalModificationScope;
    api.normalizeAdjectivalModificationLinkRole = normalizeAdjectivalModificationLinkRole;
    ...
    api.getAdjectivalModificationCanonicalRealizationSurfaceForms = getAdjectivalModificationCanonicalRealizationSurfaceForms;
    api.getAdjectivalModificationSelectedRealizationVariant = getAdjectivalModificationSelectedRealizationVariant;
    ...
    api.buildAdjectivalModificationSurfaceSequence = buildAdjectivalModificationSurfaceSequence;
    api.buildAdjectivalModificationAst = buildAdjectivalModificationAst;
