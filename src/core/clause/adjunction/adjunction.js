...
const LESSON49_ADVERBIAL_ADJUNCTION_VALIDATION_REFS = Object.freeze([
    "src/tests/adjunction.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const LESSON49_ADVERBIAL_ADJUNCTION_PDF_REFS = Object.freeze([
    "Andrews Lesson 49.1",
    "Andrews Lesson 49.2",
    "Andrews Lesson 49.3",
    "Andrews Lesson 49.4",
...
const LESSON49_MULTINUCLEUS_FRAME = Object.freeze({
    ...
    simpleAdverbialModificationCanContain: Object.freeze([
...
const LESSON49_ADVERBIAL_ADJUNCTION_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({ id: "lesson49-simple-structure", andrewsSection: "49.1", category: "simple-adverbial-modification", directiveEs: "La modificacion adverbial simple tiene modificador y cabeza; normalmente el modificador precede, pero puede seguir.", engineSurface: "diagnostic adverbial-adjunction frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-first-degree-domains", andrewsSection: "49.1 first-degree", category: "first-degree-adverbialized-nnc", directiveEs: "Las CNN adverbializadas de primer grado cubren lugar, duracion, manera, manera comparada y medio sin autorizar generacion nueva.", engineSurface: "diagnostic simple frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-compared-manner", andrewsSection: "49.1 compared-manner", category: "compared-manner-ambiguity", directiveEs: "La manera comparada debe distinguirse de sujeto suplementario y construcciones metaforicas; la tercera singular puede ser ambigua.", engineSurface: "diagnostic simple frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-second-degree-domains", andrewsSection: "49.1 second-degree", category: "second-degree-adverbialized-nnc", directiveEs: "Las CNN adverbializadas de segundo grado cubren lugar, tiempo, manera y manera comparada como arquitectura de clausula.", engineSurface: "diagnostic simple frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-multiple-nucleus", andrewsSection: "49.2", category: "multiple-nucleus-simple-structure", directiveEs: "Una estructura simple puede contener modificacion adjetival, suplementacion o combinacion dentro del modificador o de la cabeza.", engineSurface: "diagnostic multiple-nucleus frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-complex-overview", andrewsSection: "49.3", category: "complex-recursive-overview", directiveEs: "La modificacion adverbial se vuelve compleja cuando modificador, cabeza o ambos son tambien modificaciones adverbiales.", engineSurface: "diagnostic recursion frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-head-recursion", andrewsSection: "49.4", category: "head-recursion", directiveEs: "La cabeza puede ser el locus de recursion: modificador mas cabeza que ya contiene modificador y cabeza.", engineSurface: "diagnostic recursion frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-interrogative-head-recursion", andrewsSection: "49.4 interrogatives", category: "interrogative-adverbial-order", directiveEs: "Un modificador adverbial interrogativo debe ir primero; cuix, mach, nel y no zo nel se tratan como alcance de pregunta, no como salida generada.", engineSurface: "diagnostic interrogative frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-modifier-recursion", andrewsSection: "49.5", category: "modifier-recursion", directiveEs: "El modificador puede ser el locus de recursion; muchas combinaciones particula mas CNN adverbializada son colocaciones lexicalizadas.", engineSurface: "diagnostic recursion frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-collocations", andrewsSection: "49.5 collocations", category: "particle-adverbial-collocations", directiveEs: "Las colocaciones con particulas como oc, quin, ye, zan, za y negativos son inventario diagnostico, no generacion automatica.", engineSurface: "diagnostic collocation frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-intensifiers", andrewsSection: "49.6", category: "intensifiers", directiveEs: "Los intensificadores preceden a la cabeza cuando intensifican y tambien pueden modificar CNN adjetivales.", engineSurface: "diagnostic interrogative-intensifier frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-modifier-internal-recursion", andrewsSection: "49.7", category: "modifier-internal-recursion", directiveEs: "El modificador de un modificador adverbial puede recursar; la ruta actual solo lo marca como estructura.", engineSurface: "diagnostic recursion frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-apposition", andrewsSection: "49.8", category: "adverbial-apposition", directiveEs: "En aposicion de lugar o tiempo, una unidad general es seguida por una unidad mas especifica; no se confunde con conjuncion.", engineSurface: "diagnostic apposition frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-both-recursion", andrewsSection: "49.9", category: "both-recursion", directiveEs: "Modificador y cabeza pueden ser recursivos al mismo tiempo; esto requiere analisis de clausula, no salida de palabra.", engineSurface: "diagnostic recursion frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson49-principal-adverbial", andrewsSection: "49.10", category: "adverbialized-principal-clause", directiveEs: "Una CNN adverbializada puede ser clausula principal; en preguntas debe ir inicial para conservar fuerza interrogativa.", engineSurface: "diagnostic principal-clause frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
]);
...
function cloneAdverbialAdjunctionLessonRecord(record) {
    ...
    return Object.fromEntries(
        Object.entries(record).map(([key, value]) => [key, cloneAdverbialAdjunctionLessonRecord(value)])
    );
}
...
function buildLesson49AdverbialAdjunctionPursuitFrame() {
    ...
    const remainingGaps = [
        "Current Lesson 49 support records Andrews' adverbial-modification part-one architecture as diagnostics and supplied-surface AST frames; it does not implement static adverbial-adjunction data, recursive parsing, or surface generation.",
        "Classical collocation examples and spelling-sensitive forms remain structural references only; Nawat/Pipil slot-scoped orthography and lexical surfaces require confirmed Nawat/Pipil evidence before visible output.",
        "Parser/search detection, multiple-nucleus resolution, compared-manner ambiguity, interrogative principal-clause analysis, intensifier routing, lexicalized collocation inventory, apposition fixtures, acciones de interfaz, and confirmed Nawat/Pipil examples remain partial or evidence-needed.",
    ];
    const frame = {
...
const LESSON50_ADVERBIAL_ADJUNCTION_VALIDATION_REFS = Object.freeze([
    "src/tests/adjunction.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const LESSON50_ADVERBIAL_ADJUNCTION_PDF_REFS = Object.freeze([
    "Andrews Lesson 50.1",
    "Andrews Lesson 50.2",
    "Andrews Lesson 50.3",
    "Andrews Lesson 50.4",
...
const LESSON50_NONADVERBIALIZED_ADJOINED_UNIT_FRAME = Object.freeze({
    ...
    meaningTypes: Object.freeze([
        ADVERBIAL_ADJUNCTION_RELATION.time,
        ADVERBIAL_ADJUNCTION_RELATION.place,
        ADVERBIAL_ADJUNCTION_RELATION.manner,
        ADVERBIAL_ADJUNCTION_RELATION.consideration,
        ADVERBIAL_ADJUNCTION_RELATION.purpose,
        ADVERBIAL_ADJUNCTION_RELATION.condition,
        ADVERBIAL_ADJUNCTION_RELATION.concession,
        ADVERBIAL_ADJUNCTION_RELATION.consequence,
        ADVERBIAL_ADJUNCTION_RELATION.proviso,
        ADVERBIAL_ADJUNCTION_RELATION.reason,
    ]),
...
const LESSON50_ADVERBIAL_ADJUNCTION_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({ id: "lesson50-nonadverbialized-overview", andrewsSection: "50.1", category: "nonadverbialized-adjoined-unit", directiveEs: "El modificador adverbial de esta leccion no esta adverbializado; es una clausula o unidad de clausula adyacente.", engineSurface: "diagnostic adverbial-adjunction frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-time-overview", andrewsSection: "50.2", category: "time", directiveEs: "La unidad adyacente puede expresar tiempo implicito o explicito; la traduccion de los tiempos no autoriza generacion nueva.", engineSurface: "diagnostic time frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-time-implicit", andrewsSection: "50.2.1", category: "implicit-time", directiveEs: "El significado temporal puede estar implicito sin CNN temporal en la clausula adyacente.", engineSurface: "diagnostic time frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-time-explicit", andrewsSection: "50.2.2", category: "explicit-time-nnc", directiveEs: "Ihcuac, ic, oc ic y otras expresiones temporales pueden indicar explicitamente el tiempo dentro de la unidad adyacente.", engineSurface: "diagnostic time frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-time-corroborating", andrewsSection: "50.2.3", category: "principal-corroborating-time", directiveEs: "La clausula principal puede contener elemento adverbial corroborante; algunas estructuras se rebajan a 49.2.", engineSurface: "diagnostic time frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-place", andrewsSection: "50.3", category: "place", directiveEs: "La unidad adyacente puede expresar lugar; las reducciones con ca o catca pueden traslaparse con la aposicion de 49.8.", engineSurface: "diagnostic place frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-manner", andrewsSection: "50.4", category: "manner", directiveEs: "La unidad adyacente puede expresar la manera en que ocurre la accion o evento.", engineSurface: "diagnostic manner frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-consideration", andrewsSection: "50.5", category: "consideration", directiveEs: "La unidad adyacente puede expresar respecto a o en relacion con; no debe confundirse con suplementacion de referente incluido.", engineSurface: "diagnostic consideration frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-purpose-unmarked", andrewsSection: "50.6.1", category: "purpose-unmarked", directiveEs: "El proposito puede carecer de marca explicita y normalmente usa CNV futura; in puede faltar y la lectura puede rozar conjuncion.", engineSurface: "diagnostic purpose frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-purpose-ma", andrewsSection: "50.6.2", category: "purpose-ma-optative-admonitive", directiveEs: "Ma o in ma con optativo sugiere proposito; ma o in ma con admonitivo expresa para que no o lest.", engineSurface: "diagnostic purpose frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-condition-overview", andrewsSection: "50.7", category: "condition", directiveEs: "Tla, con o sin in, introduce condiciones abiertas o hipoteticas; la unidad adyacente puede preceder o seguir.", engineSurface: "diagnostic condition frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-open-condition-nnc", andrewsSection: "50.7.1.a", category: "open-condition-nnc", directiveEs: "En condiciones abiertas, el centro de la unidad adyacente puede ser CNN; el tiempo lo decide la CNV principal.", engineSurface: "diagnostic condition frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-open-condition-vnc", andrewsSection: "50.7.1.b", category: "open-condition-vnc", directiveEs: "En condiciones abiertas, el centro puede ser CNV optativa o indicativa; presente indicativo puede tener valor pasado.", engineSurface: "diagnostic condition frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-hypothetical-condition", andrewsSection: "50.7.2", category: "hypothetical-condition", directiveEs: "La condicion hipotetica usa optativo pasado y una principal con compuesto de embed futuro; el prefijo antecesivo debe tratarse como regla de alcance.", engineSurface: "diagnostic condition frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-concession", andrewsSection: "50.8", category: "concession", directiveEs: "La concesion usa familias de in tla nel, in ma nel, ma zo y colocaciones relacionadas; son diagnosticas hasta tener evidencia Nawat.", engineSurface: "diagnostic concession frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-consequence", andrewsSection: "50.9", category: "consequence", directiveEs: "La consecuencia contiene iuh adverbializado con valor de resultado.", engineSurface: "diagnostic consequence frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-proviso", andrewsSection: "50.10", category: "proviso", directiveEs: "La provision contiene ahzo negativizado con valor de en caso de que.", engineSurface: "diagnostic proviso frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson50-reason", andrewsSection: "50.11", category: "reason", directiveEs: "Ca introduce una clausula principal explicativa; no significa porque y no es conjuncion.", engineSurface: "diagnostic reason frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
]);
...
function buildLesson50AdverbialAdjunctionPursuitFrame() {
    ...
    const remainingGaps = [
        "Current Lesson 50 support records Andrews' nonadverbialized adjoined-clause architecture as diagnostics and relation contracts; it does not implement static adjoined-clause data, parser/search detection, or surface generation.",
        "Classical collocation examples and spelling-sensitive forms remain structural references only; Nawat/Pipil slot-scoped orthography and lexical surfaces require confirmed Nawat/Pipil evidence before visible output.",
