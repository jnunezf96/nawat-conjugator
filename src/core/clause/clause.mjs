...
export function createClauseApi(targetObject = globalThis) {
...
export function installClauseGlobals(targetObject = globalThis) {
    const api = createClauseApi(targetObject);
