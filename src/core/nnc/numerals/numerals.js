// core/nnc/numerals/numerals.js
// Lesson 34 and Appendix D numeral-NNC boundary metadata. This keeps ordinary
// NNC open-stem output and UI number labels separate from Andrews source-gated
// numeral NNC generation. Scoped Andrews-licensed numeral generation starts
// only where the PDF formula has a concrete slot contract and then crosses the
...
const BASIC_CARDINAL_NUMERAL_NNC_STEMS = Object.freeze([
    Object.freeze({
        value: 1,
        id: "one",
        andrewsSection: "34.3",
...
const NUMERAL_NNC_ANTI_CONFLATION_RULES = Object.freeze([
...
const NUMERAL_NNC_STRUCTURAL_QUESTIONS = Object.freeze([
    Object.freeze({
        field: "numeralBase",
...
const LESSON34_CARDINAL_NUMERAL_NNC_VALIDATION_REFS = Object.freeze([
    "src/tests/nnc_numerals.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const LESSON34_CARDINAL_NUMERAL_NNC_PDF_REFS = Object.freeze([
    "Andrews Lesson 34.1",
    "Andrews Lesson 34.2",
    "Andrews Lesson 34.3",
    "Andrews Lesson 34.4",
...
const LESSON34_HIGH_ORDER_FRAME = Object.freeze({
    ...
    orderMatrices: Object.freeze([
        Object.freeze({ value: 20, matrixStem: "(pohu-a-l)-li-", meaning: "score or counted set" }),
        Object.freeze({ value: 400, matrixStem: "(tzon)-tli-", meaning: "set of feather barbs or large number" }),
        Object.freeze({ value: 8000, matrixStem: "(xiqu-ipil)-li-", meaning: "bagful or enclosed stack" }),
    ]),
...
const LESSON34_CLASSIFIER_SET_FRAME = Object.freeze({
    ...
    unitClassifierSets: Object.freeze([
        Object.freeze({ id: "rock", sourceSection: "34.9", matrixStem: "(te)-tl-", counts: "round plump things and books", ordinaryPluralDyad: "m-eh", rightwardConjunctOmitsClassifierMatrix: true }),
        Object.freeze({ id: "row", sourceSection: "34.10", matrixStem: "(pan)-tli-", counts: "rows of things or people", rightwardConjunctOmitsClassifierMatrix: true }),
        Object.freeze({ id: "thing", sourceSection: "34.11", matrixStem: "(tla-man)-tli-", counts: "folded or stacked things", grossCountOnlyWithPluralSubject: true, rightwardConjunctOmitsClassifierMatrix: true }),
        Object.freeze({ id: "maize-cob", sourceSection: "34.12", matrixStem: "(olo)-tl-", counts: "roundish or oblong things", countsOnlyThroughNineteen: true, rightwardConjunctOmitsClassifierMatrix: true }),
    ]),
    ...
    specialTwentySets: Object.freeze([
        Object.freeze({ id: "tecpan", sourceSection: "34.13.1", matrixStem: "(tecpan)-tli-", countsByTwenties: "people animals houses rocks" }),
        Object.freeze({ id: "ipil", sourceSection: "34.13.2", matrixStem: "(ipil)-li-", countsByTwenties: "blankets paper tortillas hides" }),
        Object.freeze({ id: "quimil", sourceSection: "34.13.3", matrixStem: "(quimil)-li-", countsByTwenties: "blankets" }),
    ]),
...
const LESSON34_CARDINAL_NUMERAL_NNC_SUBSECTION_INVENTORY = Object.freeze([
    Object.freeze({ id: "lesson34-number-system", andrewsSection: "34.1", category: "vigesimal-cardinal-nnc-system", directiveEs: "El sistema es vigesimal; una cardinal es CNN absolutiva, no posesiva ordinaria, y el total en ix exige sujeto plural.", engineSurface: "diagnostic numeral system frame", implementationState: "partial", redirectAction: "block-generation" }),
    Object.freeze({ id: "lesson34-basic-set", andrewsSection: "34.2", category: "basic-numeral-set", directiveEs: "La serie basica cuenta animados, cosas planas y cosas largas cilindricas; sus elementos gobiernan las series derivadas.", engineSurface: "diagnostic basic set frame", implementationState: "partial", redirectAction: "block-generation" }),
    Object.freeze({ id: "lesson34-one", andrewsSection: "34.3", category: "one-stem", directiveEs: "Uno usa tronco nominal cem/ce, plural m-eh, incrustacion en compuestos y lecturas adverbiales incorporadas.", engineSurface: "diagnostic one-stem frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson34-two-three-four", andrewsSection: "34.4", category: "two-three-four-stems", directiveEs: "Dos, tres y cuatro son pronominales; el conteo ordinario pluraliza el tronco con n y usa dyadas plurales especificas.", engineSurface: "diagnostic two-three-four frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson34-five", andrewsSection: "34.5", category: "five-and-six-through-nine", directiveEs: "Cinco tiene tronco nominal y seis a nueve se forman como cinco mas uno a cuatro con el incrustado especial chicua/chic.", engineSurface: "diagnostic five frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson34-ten-fifteen", andrewsSection: "34.6", category: "ten-fifteen-stems", directiveEs: "Diez y quince son troncos nominales con plural animado t-in; las formas posesivas de total son excepcionales y no regla ordinaria.", engineSurface: "diagnostic ten/fifteen frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson34-high-orders", andrewsSection: "34.7", category: "twenty-four-hundred-eight-thousand", directiveEs: "Multiplos de veinte, cuatrocientos y ocho mil son compuestos con matriz pohua-l, tzon o xiquipil y un incrustado de uno a diecinueve.", engineSurface: "diagnostic high-order frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson34-conjoined-numerals", andrewsSection: "34.8", category: "conjoined-numeral-nncs", directiveEs: "La suma usa conjuncion sin conjunctor: numero mayor antes del menor, con om adicional en el segundo conjuncionado.", engineSurface: "diagnostic conjoined numeral frame", implementationState: "partial", redirectAction: "refactor-engine" }),
    Object.freeze({ id: "lesson34-rock-set", andrewsSection: "34.9", category: "rock-classifier-set", directiveEs: "La serie te cuenta cosas redondas o abultadas y libros; el conjuncionado derecho omite la matriz clasificadora.", engineSurface: "diagnostic rock classifier frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson34-row-set", andrewsSection: "34.10", category: "row-classifier-set", directiveEs: "La serie pan cuenta filas de cosas o personas y tambien omite la matriz clasificadora en el conjuncionado derecho.", engineSurface: "diagnostic row classifier frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson34-thing-set", andrewsSection: "34.11", category: "thing-classifier-set", directiveEs: "La serie tlaman cuenta cosas plegadas o apiladas; el total usa solo sujeto plural.", engineSurface: "diagnostic thing classifier frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson34-maize-cob-set", andrewsSection: "34.12", category: "maize-cob-classifier-set", directiveEs: "La serie olo cuenta cosas redondeadas u oblongas solo hasta diecinueve; de veinte a treinta y nueve usa tlamic.", engineSurface: "diagnostic maize-cob classifier frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson34-special-twenty-sets", andrewsSection: "34.13", category: "special-twenty-classifier-sets", directiveEs: "Hay series especiales por veintenas con matrices tecpan, ipil y quimil para clases concretas de entidades.", engineSurface: "diagnostic special-twenty classifier frame", implementationState: "partial", redirectAction: "source-gated" }),
    Object.freeze({ id: "lesson34-reduplication", andrewsSection: "34.14", category: "numeral-reduplication", directiveEs: "La reduplicacion numeral distingue afinidad y distribucion/variedad; algunos troncos cambian el punto de reduplicacion.", engineSurface: "diagnostic reduplication frame", implementationState: "partial", redirectAction: "refactor-engine" }),
    Object.freeze({ id: "lesson34-approximately-more", andrewsSection: "34.15", category: "approximation-more", directiveEs: "Canah, quen y ahzo quen anteponen aproximacion; oc antepuesto expresa otro o mas.", engineSurface: "diagnostic numeral modifier frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
    Object.freeze({ id: "lesson34-measures", andrewsSection: "34.16", category: "measure-nncs", directiveEs: "Un compuesto con numeral incrustado puede expresar medida o longitud y se combina con lo medido por modificacion adjetival.", engineSurface: "diagnostic measure frame", implementationState: "partial", redirectAction: "diagnostic-only" }),
]);
...
function cloneNumeralNncLessonRecord(record) {
    ...
    return Object.fromEntries(
        Object.entries(record).map(([key, value]) => [key, cloneNumeralNncLessonRecord(value)])
    );
}
...
function buildLesson34CardinalNumeralNncPursuitFrame() {
    ...
    const remainingGaps = [
        "Basic simple-count cardinal one-through-four target stems now generate from Andrews slots; the rest of the numeral system remains diagnostic.",
        "Gross counts, high-order compounds, conjoined numerals, classifier sets, reduplication, approximation, and measure formations remain diagnostic.",
        "Exceptional gross-count possessive-state formations are documented but do not license ordinary possessive numeral generation.",
...
function normalizeNumeralNncKind(value = "") {
    return normalizeNumeralNncEnum(
        value,
        Object.values(NUMERAL_NNC_KIND),
        NUMERAL_NNC_KIND.unknown
    );
}
...
function normalizeNumeralNncFalsePositiveSource(value = "") {
    return normalizeNumeralNncEnum(
        value,
        Object.values(NUMERAL_NNC_FALSE_POSITIVE_SOURCE),
        NUMERAL_NNC_FALSE_POSITIVE_SOURCE.unknown
    );
}
...
function getBasicCardinalNumeralNncStem(value = "") {
    ...
    return BASIC_CARDINAL_NUMERAL_NNC_STEMS.find((entry) => (
        entry.id === normalized
        || entry.classicalStem === normalized
        || entry.structuralStem === normalized
        || entry.value === numericValue
    )) || null;
}

function getBasicCardinalNumeralNncStemInventory() {
    return BASIC_CARDINAL_NUMERAL_NNC_STEMS.map((entry) => ({ ...entry }));
}
...
function buildBasicCardinalNumeralNncFormulaSlots({
    ...
    return Object.freeze({
        ...
        num1Num2: Object.freeze({
            ...
            surface: (num1Slot === "0" && num2Slot === "0")
                ? ""
                : normalizeNumeralNncCandidateSurface(`${num1Slot}-${num2Slot}`),
            owner: "subject",
...
function getBasicCardinalNumeralNncOperationFrameMismatch({
    ...
    if (
        ...
        || operationFrame.operationId !== "andrews-34-basic-cardinal-numeral-nnc-realization"
        || operationFrame.routeFamily !== "basic-cardinal-numeral-nnc"
    ...
    if (
        ...
        || Number(operationFrame.sourceValue) !== Number(sourceFrame.value)
        || String(operationFrame.sourceNumeralId || "") !== String(sourceFrame.numeralId || "")
        || String(operationFrame.sourceStructuralFormula || "") !== String(sourceFrame.structuralFormula || "")
        || String(operationFrame.sourceStructuralStem || "") !== String(sourceFrame.structuralStem || "")
    ) {
...
function buildAndrewsBasicCardinalNumeralNnc({
    ...
    const generated = {
        ...
        diagnostics: [
            ...
            "cardinal-numeral-nnc-absolutive-state",
...
function classifyNumeralNncCandidate({
    ...
    const resolvedSourceFrame = sourceFrame && typeof sourceFrame === "object" ? sourceFrame : null;
    const mayGenerate = (
        (normalizedKind === NUMERAL_NNC_KIND.cardinal || normalizedKind === NUMERAL_NNC_KIND.numeralNnc)
        && normalizedFalsePositive === NUMERAL_NNC_FALSE_POSITIVE_SOURCE.unknown
    );
    const blockedDiagnostic = mayGenerate
        ? getBasicCardinalNumeralNncBlockedDiagnostic({
            sourceFrame: resolvedSourceFrame,
            operationFrame,
        })
        : "";
    const andrewsGeneration = !blockedDiagnostic && mayGenerate
        ? buildAndrewsBasicCardinalNumeralNnc({
            value: numeralBase,
            numeralBase,
            sourceFrame: resolvedSourceFrame,
            operationFrame,
        ...
        : null;
    const generatedCandidate = andrewsGeneration?.generationAllowed === true
        ? andrewsGeneration.targetStemClassical
        : "";
    const sourceSurface = andrewsGeneration?.generationAllowed === true
        ? andrewsGeneration.surface
        : "";
    const canGenerate = Boolean(
        sourceSurface
        && andrewsGeneration?.generationAllowed === true
        && normalizedKind !== NUMERAL_NNC_KIND.unknown
        && normalizedFalsePositive === NUMERAL_NNC_FALSE_POSITIVE_SOURCE.unknown
    );
    const classification = {
        ...
        diagnostics: [
            andrewsGeneration?.generationAllowed === true
                ? "basic-cardinal-numeral-nnc-andrews-generated"
                : (canGenerate
                ? "numeral-nnc-andrews-source-generated"
                : (blockedDiagnostic || (hasEvidence ? "numeral-nnc-needs-validation" : "numeral-nnc-source-gate-required"))),
            normalizedKind !== NUMERAL_NNC_KIND.unknown
                ? "numeral-nnc-category-recognized"
                : "numeral-nnc-category-unconfirmed",
            normalizedFalsePositive !== NUMERAL_NNC_FALSE_POSITIVE_SOURCE.unknown
                ? "numeral-nnc-false-positive-source"
                : (canGenerate ? "numeral-nnc-structured-source" : "numeral-nnc-unconfirmed"),
        ],
