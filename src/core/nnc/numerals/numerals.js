...
// NNC open-stem output and UI number labels separate from confirmed numeral
// NNC generation until Nawat/Pipil evidence supports it.
...
const LESSON34_CARDINAL_NUMERAL_NNC_SUBSECTION_INVENTORY = Object.freeze([
    ...
    Object.freeze({ id: "lesson34-one", andrewsSection: "34.3", category: "one-stem", directiveEs: "Uno usa tronco nominal cem/ce, plural m-eh, incrustacion en compuestos y lecturas adverbiales incorporadas.", engineSurface: "diagnostic one-stem frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson34-two-three-four", andrewsSection: "34.4", category: "two-three-four-stems", directiveEs: "Dos, tres y cuatro son pronominales; el conteo ordinario pluraliza el tronco con n y usa dyadas plurales especificas.", engineSurface: "diagnostic two-three-four frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson34-five", andrewsSection: "34.5", category: "five-and-six-through-nine", directiveEs: "Cinco tiene tronco nominal y seis a nueve se forman como cinco mas uno a cuatro con el incrustado especial chicua/chic.", engineSurface: "diagnostic five frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson34-ten-fifteen", andrewsSection: "34.6", category: "ten-fifteen-stems", directiveEs: "Diez y quince son troncos nominales con plural animado t-in; las formas posesivas de total son excepcionales y no regla ordinaria.", engineSurface: "diagnostic ten/fifteen frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson34-high-orders", andrewsSection: "34.7", category: "twenty-four-hundred-eight-thousand", directiveEs: "Multiplos de veinte, cuatrocientos y ocho mil son compuestos con matriz pohua-l, tzon o xiquipil y un incrustado de uno a diecinueve.", engineSurface: "diagnostic high-order frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    ...
    Object.freeze({ id: "lesson34-rock-set", andrewsSection: "34.9", category: "rock-classifier-set", directiveEs: "La serie te cuenta cosas redondas o abultadas y libros; el conjuncionado derecho omite la matriz clasificadora.", engineSurface: "diagnostic rock classifier frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson34-row-set", andrewsSection: "34.10", category: "row-classifier-set", directiveEs: "La serie pan cuenta filas de cosas o personas y tambien omite la matriz clasificadora en el conjuncionado derecho.", engineSurface: "diagnostic row classifier frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson34-thing-set", andrewsSection: "34.11", category: "thing-classifier-set", directiveEs: "La serie tlaman cuenta cosas plegadas o apiladas; el total usa solo sujeto plural.", engineSurface: "diagnostic thing classifier frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson34-maize-cob-set", andrewsSection: "34.12", category: "maize-cob-classifier-set", directiveEs: "La serie olo cuenta cosas redondeadas u oblongas solo hasta diecinueve; de veinte a treinta y nueve usa tlamic.", engineSurface: "diagnostic maize-cob classifier frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
...
function buildLesson34CardinalNumeralNncPursuitFrame() {
    ...
    const remainingGaps = [
        "Current numeral-NNC metadata is not cardinal numeral generation.",
        "Basic numerals, gross counts, high-order compounds, conjoined numerals, classifier sets, reduplication, approximation, and measure formations remain diagnostic.",
...
function classifyNumeralNncCandidate({
    ...
    const classification = {
        ...
        generationAllowed: false,
        diagnostics: [
            hasEvidence ? "numeral-nnc-needs-validation" : "numeral-nnc-needs-nawat-evidence",
