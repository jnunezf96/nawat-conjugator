...
export function createAdjectivalNncApi(targetObject = globalThis) {
    ...
    const ADJECTIVAL_NNC_ANTI_CONFLATION_RULES = Object.freeze(["adjectival NNC function boundary metadata is not generation", "adjetivo route output is a generated surface, not complete Lessons 40-41 coverage", "nominalizationProfile adjectivalFunction is explanatory metadata, not modifier/head syntax", "Lessons 40-41 adjectival function is separate from Lessons 42-43 modification AST", "single generated words do not prove adjectival modification, supplementation, or topic relations", "Andrews adjectival categories are architecture, not Nawat/Pipil form authority"]);
