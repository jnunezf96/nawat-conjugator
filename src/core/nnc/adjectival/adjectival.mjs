...
export function createAdjectivalNncModule(targetObject = globalThis) {
    ...
    const ADJECTIVAL_NNC_STRUCTURAL_QUESTIONS = Object.freeze([Object.freeze({
      ...
      asks: "Does Andrews license adjectival function, modifier/head behavior, or only an adjective-like word output?"
    }), Object.freeze({
      field: "evidenceSource",
      asks: "Which Andrews source gate or structured route licenses adjectival function before Nawat/Pipil orthography realizes it?"
    })]);
    const LESSON40_ADJECTIVAL_NNC_VALIDATION_REFS = Object.freeze(["src/tests/nnc_adjectival.test.js", "src/tests/registry.test.js", "docs/GRAMMAR_SPEC.md"]);
    const LESSON40_ADJECTIVAL_NNC_PDF_REFS = Object.freeze(["Andrews Lesson 40.1", "Andrews Lesson 40.2", "Andrews Lesson 40.2.1", "Andrews Lesson 40.2.2", "Andrews Lesson 40.2.3", "Andrews Lesson 40.3", "Andrews Lesson 40.3.1", "Andrews Lesson 40.3.2", "Andrews Lesson 40.4", "Andrews Lesson 40.4.1", "Andrews Lesson 40.4.2", "Andrews Lesson 40.5", "Andrews Lesson 40.6", "Andrews Lesson 40.7", "Andrews Lesson 40.8", "Andrews Lesson 40.8.1", "Andrews Lesson 40.8.2", "Andrews Lesson 40.8.3", "Andrews Lesson 40.8.4", "Andrews Lesson 40.8.5", "Andrews Lesson 40.8.6", "Andrews Lesson 40.9", "Andrews Lesson 40.9.1", "Andrews Lesson 40.9.2", "Andrews Lesson 40.10", "Andrews Lesson 40.10.1", "Andrews Lesson 40.10.2", "Andrews Lesson 40.10.3", "Andrews Lesson 40.11", "Andrews Lesson 40.12"]);
    ...
    const LESSON40_ADJECTIVAL_NNC_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      id: "lesson40-adjectival-nuclear-clause",
      andrewsSection: "40.1",
      category: "adjectival-nnc-function",
      directiveEs: "Adjetivo es funcion sintactica; la CNN adjetiva modifica otra CNN y normalmente exige estado absolutivo.",
      engineSurface: "partial opt-in adjectival NNC output plus boundary metadata",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-exceptional-adjectival-nncs",
      andrewsSection: "40.2",
      category: "exceptional-adjectival-nnc",
      directiveEs: "Las CNN adjetivas excepcionales tienen paradigmas peculiares; no se generan como reglas ordinarias sin evidencia.",
      engineSurface: "diagnostic exceptional adjectival frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson40-huei",
      andrewsSection: "40.2.1",
      category: "huei-pronominal-like",
      directiveEs: "El tipo wey tiene comportamiento parecido a pronombre y alternancias de numero que no deben aplanarse.",
      engineSurface: "diagnostic exceptional adjectival frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      ...
      category: "nepapan-relational-source",
      directiveEs: "Nepapan viene de fuente relacional y posesiva reciproca; no es solo una etiqueta de adjetivo.",
      engineSurface: "diagnostic exceptional adjectival frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson40-possessor-included",
      andrewsSection: "40.2.3",
      category: "possessor-included-adjectival",
      directiveEs: "Ce-l y el incluyen poseedor dentro del tronco pero siguen con sujeto 3a y no son estado posesivo normal.",
      engineSurface: "diagnostic exceptional adjectival frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson40-nnc-vnc-adjective",
      andrewsSection: "40.3",
      category: "nnc-vnc-adjective-function",
      directiveEs: "Casi cualquier CNN absolutiva y cualquier CNV pueden funcionar adjetivamente; la estructura de modificacion queda diferida.",
      engineSurface: "partial ordinary NNC/VNC adjectival routes",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-nnc-predicate-adjective",
      andrewsSection: "40.3.1",
      category: "nnc-predicate-adjective",
      directiveEs: "Solo el predicado de la CNN se traduce como adjetivo; la CNN completa mantiene su arquitectura.",
      engineSurface: "partial ordinary NNC adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-vnc-predicate-adjective",
      andrewsSection: "40.3.2",
      category: "vnc-predicate-adjective",
      directiveEs: "Solo el predicado de la CNV se traduce como adjetivo; no se convierte automaticamente en tronco nominal.",
      engineSurface: "partial VNC adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-derived-nounstems",
      andrewsSection: "40.4",
      category: "derived-nounstem-adjective",
      directiveEs: "Patientivos y potenciales-paciente pueden traducirse adjetivamente, pero la forma estricta sigue siendo sustantiva.",
      engineSurface: "partial patientive/nominalized VNC adjectival routes",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-patientive-adjective",
      andrewsSection: "40.4.1",
      category: "patientive-adjective",
      directiveEs: "El patientivo nombra una entidad por proceso, impacto o estado resultante; la glosa adjetiva es libre.",
      engineSurface: "partial patientive adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-potential-patient-adjective",
      andrewsSection: "40.4.2",
      category: "potential-patient-adjective",
      directiveEs: "El potencial-paciente con z/liz puede glosarse como adjetivo; la negacion puede estar dentro o fuera del tronco.",
      engineSurface: "partial nominalized VNC adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-nominalized-vnc-adjective",
      andrewsSection: "40.5",
      category: "nominalized-vnc-adjective",
      directiveEs: "Los predicados de CNV nominalizadas pueden glosarse como adjetivos; el analisis nominalizado se conserva por incrustacion afectiva.",
      engineSurface: "partial nominalized VNC adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-customary-agentive",
      andrewsSection: "40.6",
      category: "customary-present-agentive-adjective",
      directiveEs: "El agentivo presente habitual activo puede funcionar adjetivamente; compuestos con t pueden reanalizarse.",
      engineSurface: "partial nominalized VNC adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-customary-patientive",
      andrewsSection: "40.7",
      category: "customary-present-patientive-adjective",
      directiveEs: "El patientivo presente habitual pasivo puede funcionar adjetivamente y puede coincidir o diferir del potencial-paciente.",
      engineSurface: "partial nominalized VNC adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-preterit-agentive-adjective",
      andrewsSection: "40.8",
      category: "preterit-agentive-adjective",
      directiveEs: "El agentivo preterito puede funcionar adjetivamente, sobre todo desde fuentes intransitivas.",
      engineSurface: "partial nominalized VNC adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      ...
      category: "class-a-preterit-agentive-adjective",
      directiveEs: "La clase A incluye pasivos y denominales ti frecuentes; las glosas de cualidad pueden ocultar estructura.",
      engineSurface: "diagnostic class frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-class-b",
      andrewsSection: "40.8.2",
      category: "class-b-preterit-agentive-adjective",
      directiveEs: "La clase B suele usar qui-0 o 0-0 en numero singular/comun y tambien acepta fuentes transitivas.",
      engineSurface: "diagnostic class frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-class-c",
      andrewsSection: "40.8.3",
      category: "class-c-preterit-agentive-adjective",
      directiveEs: "La clase C usa 0-0 en singular/comun y normalmente tiene fuente transitiva.",
      engineSurface: "diagnostic class frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-class-d",
      andrewsSection: "40.8.4",
      category: "class-d-preterit-agentive-adjective",
      directiveEs: "La clase D usa 0-0 en singular/comun y no debe mezclarse con otras clases.",
      engineSurface: "diagnostic class frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-compound-preterit-agentive",
      andrewsSection: "40.8.5",
      category: "compound-preterit-agentive-adjective",
      directiveEs: "Un predicado de CNN compuesta tambien puede traducirse adjetivamente.",
      engineSurface: "partial compound source metadata",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-unused-source-ownerhood",
      andrewsSection: "40.8.6",
      category: "unused-source-ownerhood-adjective",
      directiveEs: "Algunas fuentes ya no se usan; formas de posesion e/yo-a/wa pueden glosarse como adjetivos.",
      engineSurface: "diagnostic ownerhood adjective frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-obsolete-preterit-root-ya",
      andrewsSection: "40.9",
      category: "obsolete-preterit-root-ya-adjective",
      directiveEs: "Los intransitivos raiz+ya pueden formar adjetivos desde un preterito obsoleto sobre la raiz sola.",
      engineSurface: "partial root-plus-ya adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-hueiya-exception",
      andrewsSection: "40.9.1",
      category: "hueiya-exception",
      directiveEs: "Weya usa la base parecida a pronombre y distingue honor metaforico de longitud; no se inventa un preterito obsoleto.",
      engineSurface: "diagnostic root-plus-ya exception",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson40-tlaocoya-exception",
      andrewsSection: "40.9.2",
      category: "tlaocoya-exception",
      directiveEs: "Tlaocoya solo usa el tronco de clase B documentado para esta funcion.",
      engineSurface: "diagnostic root-plus-ya exception",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson40-synonymous-pairs",
      andrewsSection: "40.10",
      category: "synonymous-pairs",
      directiveEs: "Los pares sinonimos vienen de una raiz comun; no se generan hermanos sin fuente Andrews concreta y puente ortografico.",
      engineSurface: "diagnostic synonym-set frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-ni-hui-pairs",
      andrewsSection: "40.10.1",
      category: "ni-hui-ctiya-pairs",
      directiveEs: "Destockales ni y raramente hui tienen sinonimos c-tiya segun reglas 40.8.2 y 40.9.",
      engineSurface: "diagnostic synonym-set frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-hua-pairs",
      andrewsSection: "40.10.2",
      category: "hua-ctiya-pairs",
      directiveEs: "Destockales wa tienen sinonimos c-tiya desde nounstems 39.4.2.",
      engineSurface: "diagnostic synonym-set frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-ihui-ahui-pairs",
      andrewsSection: "40.10.3",
      category: "ihui-ahui-tiya-pairs",
      directiveEs: "Destockales iwi/awi tienen sinonimos tiya desde nounstems 39.4.3.",
      engineSurface: "diagnostic synonym-set frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-synonymous-triplets",
      andrewsSection: "40.11",
      category: "synonymous-triplets",
      directiveEs: "Los tripletes agregan un miembro z-tiya; diferencias de traduccion no autorizan generacion automatica.",
      engineSurface: "diagnostic synonym-set frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson40-predicate-adjective-sentence",
      andrewsSection: "40.12",
      category: "predicate-adjective-sentence",
      directiveEs: "La CNN traducible como adjetivo puede ser clausula principal en construccion multinuclear; esto es sintaxis, no palabra nueva.",
    ...
    function cloneAdjectivalNncLessonRecord(record) {
      ...
      return Object.fromEntries(Object.entries(record).map(([key, value]) => [key, cloneAdjectivalNncLessonRecord(value)]));
    }
    function buildLesson41CompoundSourceObjectSlotOwnershipFrame({
      ...
      return {
        ...
        objectSlotLicensingOrder: ["source-compound-vnc", "source-adjunct-nnc", "matrix-valence-frame", "route-frame", "function-use-annotation"]
      };
    }
    ...
    function buildLesson40AdjectivalNncPursuitFrame() {
      ...
      const remainingGaps = ["Current Lesson 40 adjectival NNC support is partial and does not exhaust exceptional adjectival NNCs, all NNC/VNC adjectival functions, all derived nounstem adjective paths, all nominalized VNC adjective paths, synonym sets, or predicate-adjective sentences.", "Exceptional adjectival NNCs, possessor-included stems, class-specific preterit-agentive adjective behavior, root-plus-ya exceptions, and source-synonym sets remain diagnostic or evidence-needed.", "Predicate-adjective sentence syntax and Lessons 42-43 modifier/head AST behavior remain outside word generation.", "Finite output expansion must stay tied to Andrews section evidence and orthography-bridge spelling support."];
      const frame = {
      ...
      return attachAdjectivalNncPursuitGrammarContract(frame, {
        ...
        diagnostics: ["adjectival-nnc-diagnostic-partial", "adjectival-nnc-source-gated"]
      });
    }
    const LESSON41_ADJECTIVAL_NNC_VALIDATION_REFS = Object.freeze(["src/tests/nnc_adjectival.test.js", "src/tests/registry.test.js", "docs/GRAMMAR_SPEC.md"]);
    const LESSON41_ADJECTIVAL_NNC_PDF_REFS = Object.freeze(["Andrews Lesson 41.1", "Andrews Lesson 41.1.1", "Andrews Lesson 41.1.2", "Andrews Lesson 41.1.2.a", "Andrews Lesson 41.1.2.b", "Andrews Lesson 41.1.2.c", "Andrews Lesson 41.1.2.d", "Andrews Lesson 41.1.2.e", "Andrews Lesson 41.1.3", "Andrews Lesson 41.1.4", "Andrews Lesson 41.1.4.a", "Andrews Lesson 41.1.4.b", "Andrews Lesson 41.1.5", "Andrews Lesson 41.2", "Andrews Lesson 41.2.1", "Andrews Lesson 41.2.1.a", "Andrews Lesson 41.2.1.b", "Andrews Lesson 41.2.1.b.i", "Andrews Lesson 41.2.1.b.ii", "Andrews Lesson 41.2.2", "Andrews Lesson 41.2.3", "Andrews Lesson 41.3", "Andrews Lesson 41.4"]);
    ...
    const LESSON41_ADJECTIVAL_NNC_SUBSECTION_INVENTORY = Object.freeze([Object.freeze({
      id: "lesson41-intensified-adjectival-nncs",
      andrewsSection: "41.1",
      category: "intensified-adjectival-nnc",
      directiveEs: "La intensificacion adjetiva tiene varias fuentes; no se reduce a una sola ruta de reduplicacion.",
      engineSurface: "partial intensified adjectival route plus diagnostic frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson41-reduplicative-intensification",
      andrewsSection: "41.1.1",
      category: "reduplicative-intensification",
      directiveEs: "Si el tronco adjetivo viene de fuente verbal o deverbal, puede intensificarse con reduplicacion de 27.2.2, no con la nominal de 14.3.",
      engineSurface: "partial intensified route from generated formula slots",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson41-pah-matrix",
      andrewsSection: "41.1.2",
      category: "pah-matrix-intensification",
      directiveEs: "La matriz pah-ti-c expresa potencia y el incrustado aporta forma o respecto; las subclases quedan separadas.",
      engineSurface: "diagnostic matrix frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-pah-adjective-stem-embed",
      andrewsSection: "41.1.2.a",
      category: "pah-adjective-stem-embed",
      directiveEs: "El incrustado puede ser un nounstem que forma adjetivo ti-c, incluidos patientivos destockales.",
      engineSurface: "diagnostic matrix frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-pah-root-plus-ya-embed",
      andrewsSection: "41.1.2.b",
      category: "pah-root-plus-ya-embed",
      directiveEs: "El incrustado puede ser la raiz de un agentivo preterito de fuente raiz+ya.",
      engineSurface: "diagnostic matrix frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-pah-general-use-embed",
      andrewsSection: "41.1.2.c",
      category: "pah-general-use-embed",
      directiveEs: "El incrustado puede ser la forma de uso general del agentivo preterito adjetival.",
      engineSurface: "diagnostic matrix frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-pah-reduplicated-embed",
      andrewsSection: "41.1.2.d",
      category: "pah-reduplicated-embed",
      directiveEs: "El incrustado tambien puede intensificarse por la reduplicacion de 41.1.1.",
      engineSurface: "diagnostic matrix frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-pah-internal-expansion",
      andrewsSection: "41.1.2.e",
      category: "pah-internal-expansion",
      directiveEs: "La matriz puede expandirse internamente por simbolismo sonoro; mas peso fonologico sugiere mas peso semantico.",
      engineSurface: "diagnostic sound-symbolic matrix frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-other-preterit-agentive-matrices",
      andrewsSection: "41.1.3",
      category: "other-intensifying-matrices",
      directiveEs: "Otras matrices agentivas preteritas como cal, calalah y tzon tambien intensifican, pero no son regla general.",
      engineSurface: "diagnostic matrix frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-affective-matrices",
      andrewsSection: "41.1.4",
      category: "affective-intensification",
      directiveEs: "Las matrices afectivas pol, pil, ton y tzin modulan intensidad; los agentivos preteritos incrustados usan forma general.",
      engineSurface: "diagnostic affective matrix frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-pol-increase",
      andrewsSection: "41.1.4.a",
      category: "pol-increase",
      directiveEs: "Pol aumenta la intensidad y puede llevar prefijo reduplicativo.",
      engineSurface: "diagnostic affective matrix frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-pil-ton-tzin-decrease",
      andrewsSection: "41.1.4.b",
      category: "pil-ton-tzin-decrease",
      directiveEs: "Pil, ton y tzin disminuyen la intensidad; ton puede mostrar tli inesperado.",
      engineSurface: "diagnostic affective matrix frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-metaphor-simile",
      andrewsSection: "41.1.5",
      category: "metaphor-simile-intensification",
      directiveEs: "La intensidad tambien puede venir de metafora o simil; intensificadores sintacticos quedan para 49.6.",
      engineSurface: "diagnostic intensification frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-compound-verbstem-nominal-embed",
      andrewsSection: "41.2",
      category: "compound-verbstem-nominal-embed",
      directiveEs: "Un compuesto verbal con incrustado nominal puede reanalizar o derivar su matriz como nounstem y funcionar adjetivamente.",
      engineSurface: "partial compound-source adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson41-incorporated-adverb-source",
      andrewsSection: "41.2.1",
      category: "incorporated-adverb-source",
      directiveEs: "Los compuestos con adverbio incorporado son la fuente mas frecuente y tienen dos construcciones.",
      engineSurface: "partial compound-source adjectival route plus diagnostic frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson41-incorporated-adverb-30-7-12",
      andrewsSection: "41.2.1.a",
      category: "lesson30-7-12-adverb-source",
      directiveEs: "El adverbio incorporado puede expresar medio, instrumento, lugar, tiempo, duracion, causa, proposito, modo o modo comparado.",
      engineSurface: "diagnostic source frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson41-incorporated-adverb-30-14",
      andrewsSection: "41.2.1.b",
      category: "lesson30-14-supplementation-source",
      directiveEs: "La fuente tambien puede venir de suplementacion con sujeto suplementario en CNN posesiva.",
      engineSurface: "diagnostic source frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-different-entity-subtype",
      andrewsSection: "41.2.1.b.i",
      category: "different-entity-subtype",
      directiveEs: "Un subtipo tiene incrustado de entidad distinta; el sujeto puede ser animado o no animado.",
      engineSurface: "diagnostic source frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-same-entity-subtype",
      andrewsSection: "41.2.1.b.ii",
      category: "same-entity-subtype",
      directiveEs: "Otro subtipo tiene incrustado de la misma entidad; el sujeto es no animado y el ingles invierte gobernador y gobernado.",
      engineSurface: "diagnostic source frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    }), Object.freeze({
      id: "lesson41-incorporated-complement-source",
      andrewsSection: "41.2.2",
      category: "incorporated-complement-source",
      directiveEs: "Solo pocas CNN muestran la fuente de compuesto con complemento incorporado.",
      engineSurface: "diagnostic source frame",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson41-incorporated-object-source",
      andrewsSection: "41.2.3",
      category: "incorporated-object-source",
      directiveEs: "La fuente de objeto incorporado exige conocer el compuesto subyacente; la morfologia sola no distingue patientivo impersonal y pasivo.",
      engineSurface: "partial compound-source/patientive metadata",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson41-denominal-compound-nounstem",
      andrewsSection: "41.3",
      category: "denominal-compound-nounstem",
      directiveEs: "Un nounstem compuesto puede formar un verbstem con ti y luego un agentivo preterito adjetival.",
      engineSurface: "partial denominal-compound adjectival route",
      implementationState: "partial",
      redirectAction: "source-gated"
    }), Object.freeze({
      id: "lesson41-adjectival-embed-compound-nnc",
      andrewsSection: "41.4",
      category: "adjectival-embed-compound-nnc",
      directiveEs: "Un nounstem adjetival puede incrustarse como modificador de la matriz; los agentivos preteritos usan forma general y los numerales tambien pueden incrustarse.",
      engineSurface: "diagnostic compound NNC embed frame",
      implementationState: "partial",
      redirectAction: "diagnostic-only"
    })]);
    ...
    function buildLesson41AdjectivalNncPursuitFrame() {
      ...
      compoundVerbstemNominalEmbedFrame.routeFrames = [incorporatedAdverbRouteFrame, incorporatedComplementRouteFrame, incorporatedObjectRouteFrame];
      const remainingGaps = ["Current Lesson 41 adjectival NNC support is partial and does not exhaust intensified-stem families, pah/cal/tzon/affective matrix intensification, metaphor or simile intensification, all compound-verbstem source subtypes, or adjectival nounstems embedded in compound-stemmed NNCs.", "The current intensified route only works from generated formula slots and does not implement every Andrews matrix, internal expansion, sound-symbolic, affective, metaphorical, or syntactic-intensifier path.", "Compound-source and denominal-compound routes preserve generated Nawat surfaces only when source frames are present; full source disambiguation and orthography-bridge examples remain evidence-needed.", "Adjectival embeds in compound-stemmed NNCs and Lessons 42-43 modifier/head syntax remain outside current word generation."];
      const frame = {
      ...
      return attachAdjectivalNncPursuitGrammarContract(frame, {
        ...
        orthographyFrame: {
          ...
          noClassicalSurfaceImport: true,
          orthographyStatus: "orthography-bridge-plus-source-gate-required",
          matrixSpellingsNeedOrthographyBridge: Object.freeze(["pah", "cal", "tzon", "pol", "pil", "ton", "tzin"])
        },
        morphBoundaryFrame: {
          intensifiedAdjectivalNncFrame,
          compoundVerbstemNominalEmbedFrame,
        ...
        participantFrame: {
          ...
          compoundSourceRouteFrames: [incorporatedAdverbRouteFrame, incorporatedComplementRouteFrame, incorporatedObjectRouteFrame]
        },
        targetContract: {
          metadataKind: "lesson-41-adjectival-nnc-pursuit-frame",
          generationAllowed: false,
        ...
        diagnostics: ["adjectival-nnc-lesson-41-diagnostic-partial", "adjectival-nnc-source-gated"]
      });
    }
    ...
    function normalizeAdjectivalNncCandidateSurface(value = "") {
      ...
      const conversion = typeof targetObject.convertClassicalLettersToNawat === "function" ? targetObject.convertClassicalLettersToNawat(source, {
        source: "Andrews adjectival NNC candidate formula",
        slot: "adjectival-nnc-stem"
      }) : {
        output: source,
        diagnostics: []
      };
    ...
    function hasAdjectivalNncAndrewsSourceGate({
      sourceGate = "",
      structuredSource = false
    } = {}) {
      return structuredSource === true || Boolean(String(sourceGate || "").trim());
    }
    function buildAdjectivalNncFunctionCandidateSourceFrame({
      candidate = "",
      functionKind = "",
      sourceCategory = "",
      adjectivalRole = "",
      ...
      if (normalizedFunction === ADJECTIVAL_NNC_FUNCTION.unknown) {
        return null;
      }
      ...
      return Object.freeze({
        kind: "adjectival-nnc-function-candidate-source-frame",
        version: ADJECTIVAL_NNC_BOUNDARY_VERSION,
        routeFamily: "adjectival-nnc-function-candidate",
        ...
        targetSurface,
        authority: "Andrews Lessons 40-41 adjectival NNC function route",
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false
      });
    }
    function buildAdjectivalNncFunctionCandidateOperationFrame(sourceFrame = null) {
      if (!sourceFrame || sourceFrame.kind !== "adjectival-nnc-function-candidate-source-frame") {
        return null;
      }
      return Object.freeze({
        kind: "andrews-typed-operation-frame",
        operationId: "andrews-40-41-adjectival-function-candidate-realization",
        routeFamily: "adjectival-nnc-function-candidate",
        routeStage: "execute-typed-operation-frame",
        operationApplied: "realize-adjectival-function-candidate-from-source-frame",
        sourceFrameKind: sourceFrame.kind,
        sourceFunctionKind: sourceFrame.functionKind,
        sourceCategory: sourceFrame.sourceCategory,
        sourceAdjectivalRole: sourceFrame.adjectivalRole,
    ...
    function getAdjectivalNncFunctionCandidateOperationFrameMismatch({
      sourceFrame = null,
      operationFrame = null
    } = {}) {
      if (!sourceFrame || sourceFrame.kind !== "adjectival-nnc-function-candidate-source-frame") {
      ...
      if (!operationFrame || operationFrame.kind !== "andrews-typed-operation-frame" || operationFrame.operationId !== "andrews-40-41-adjectival-function-candidate-realization" || operationFrame.routeFamily !== "adjectival-nnc-function-candidate" || operationFrame.consumesRenderedInput !== false || operationFrame.displayStringsAuthorizeGrammar !== false) {
        return "operation-frame-required";
      }
      if (String(operationFrame.sourceFrameKind || "") !== sourceFrame.kind || String(operationFrame.sourceFunctionKind || "") !== String(sourceFrame.functionKind || "") || String(operationFrame.sourceCategory || "") !== String(sourceFrame.sourceCategory || "") || String(operationFrame.sourceAdjectivalRole || "") !== String(sourceFrame.adjectivalRole || "")) {
    ...
    function getAdjectivalNncFunctionCandidateBlockedDiagnostic({
      sourceFrame = null,
      operationFrame = null
    } = {}) {
      const mismatch = getAdjectivalNncFunctionCandidateOperationFrameMismatch({
        sourceFrame,
        operationFrame
      });
      return mismatch ? `adjectival-nnc-function-${mismatch}` : "";
    }
    ...
    function classifyAdjectivalNncFunctionCandidate({
      ...
      const requiresTypedOperation = normalizedFunction !== ADJECTIVAL_NNC_FUNCTION.unknown && normalizedFalsePositive === ADJECTIVAL_NNC_FALSE_POSITIVE_SOURCE.unknown;
      const blockedDiagnostic = requiresTypedOperation ? getAdjectivalNncFunctionCandidateBlockedDiagnostic({
        sourceFrame: resolvedSourceFrame,
        operationFrame
      }) : "";
      const sourceSurface = blockedDiagnostic ? "" : String(operationFrame?.targetSurface || "");
      const canGenerate = Boolean(sourceSurface && !blockedDiagnostic && normalizedFunction !== ADJECTIVAL_NNC_FUNCTION.unknown && normalizedFalsePositive === ADJECTIVAL_NNC_FALSE_POSITIVE_SOURCE.unknown);
      ...
      return {
        ...
        diagnostics: [canGenerate ? "adjectival-nnc-andrews-source-generated" : blockedDiagnostic || (hasEvidence ? "adjectival-nnc-needs-validation" : "adjectival-nnc-source-gate-required"), normalizedFunction !== ADJECTIVAL_NNC_FUNCTION.unknown ? "adjectival-nnc-function-recognized" : "adjectival-nnc-function-unconfirmed", hasNominalizationProfile ? "nominalization-profile-adjectival-function-is-metadata" : "nominalization-profile-absent", normalizedFalsePositive !== ADJECTIVAL_NNC_FALSE_POSITIVE_SOURCE.unknown ? "adjectival-nnc-false-positive-source" : canGenerate ? "adjectival-nnc-structured-source" : "adjectival-nnc-unconfirmed"],
    ...
    function resolveAdjectivalNncSourceRouteFrame(output = null, functionFrame = null) {
      const result = output && typeof output === "object" ? output : {};
      const frame = functionFrame && typeof functionFrame === "object" ? functionFrame : {};
      const inheritedGrammarFrame = result.grammarFrame && typeof result.grammarFrame === "object" ? result.grammarFrame : result.frames && typeof result.frames === "object" ? result.frames : null;
      const functionGrammarFrame = frame.grammarFrame && typeof frame.grammarFrame === "object" ? frame.grammarFrame : frame.frames && typeof frame.frames === "object" ? frame.frames : null;
      const candidates = [result.incorporationRouteFrame, result.compoundRouteFrame, result.routeFrame, result.denominalCompoundSourceFrame?.incorporationRouteFrame, result.denominalCompoundSourceFrame?.compoundRouteFrame, result.denominalCompoundSourceFrame?.routeFrame, result.rootPlusYaAdjectivalNncFrame?.denominalCompoundSourceFrame?.incorporationRouteFrame, result.rootPlusYaAdjectivalNncFrame?.denominalCompoundSourceFrame?.compoundRouteFrame, result.rootPlusYaAdjectivalNncFrame?.denominalCompoundSourceFrame?.routeFrame, frame.incorporationRouteFrame, frame.compoundRouteFrame, frame.routeFrame, frame.denominalCompoundSourceFrame?.incorporationRouteFrame, frame.denominalCompoundSourceFrame?.compoundRouteFrame, frame.denominalCompoundSourceFrame?.routeFrame, frame.sourceCompoundFrame?.incorporationRouteFrame, frame.sourceCompoundFrame?.compoundRouteFrame, frame.sourceCompoundFrame?.routeFrame, frame.sourceDenominalCompoundFrame?.incorporationRouteFrame, frame.sourceDenominalCompoundFrame?.compoundRouteFrame, frame.sourceDenominalCompoundFrame?.routeFrame, inheritedGrammarFrame?.routeContract?.sourceContract?.sourceRouteFrame, inheritedGrammarFrame?.routeContract?.sourceContract?.routeFrame, inheritedGrammarFrame?.routeContract?.sourceContract?.incorporationRouteFrame, inheritedGrammarFrame?.routeContract?.targetContract?.sourceRouteFrame, inheritedGrammarFrame?.routeContract?.targetContract?.routeFrame, inheritedGrammarFrame?.routeContract?.targetContract?.incorporationRouteFrame, inheritedGrammarFrame?.participantFrame?.sourceRouteFrame, inheritedGrammarFrame?.participantFrame?.routeFrame, inheritedGrammarFrame?.participantFrame?.incorporationRouteFrame, inheritedGrammarFrame?.stemFrame?.sourceRouteFrame, inheritedGrammarFrame?.stemFrame?.routeFrame, inheritedGrammarFrame?.stemFrame?.incorporationRouteFrame, inheritedGrammarFrame?.morphBoundaryFrame?.sourceRouteFrame, inheritedGrammarFrame?.morphBoundaryFrame?.routeFrame, inheritedGrammarFrame?.morphBoundaryFrame?.incorporationRouteFrame, functionGrammarFrame?.routeContract?.sourceContract?.sourceRouteFrame, functionGrammarFrame?.routeContract?.sourceContract?.routeFrame, functionGrammarFrame?.routeContract?.sourceContract?.incorporationRouteFrame, functionGrammarFrame?.participantFrame?.sourceRouteFrame, functionGrammarFrame?.participantFrame?.routeFrame, functionGrammarFrame?.participantFrame?.incorporationRouteFrame];
      return cloneAdjectivalNncSourceRouteFrame(candidates.find(candidate => candidate && typeof candidate === "object") || null);
    }
    function buildAdjectivalNncGrammarFrame(result = null) {
      ...
      const canonicalFormulaBundle = buildAdjectivalNncCanonicalFormulaRecordBundle({
        output,
        functionFrame,
        routeContract,
      ...
      const resultFrame = typeof targetObject.buildGrammarResultFrame === "function" ? targetObject.buildGrammarResultFrame({
        ...
        generationRoute: output.generationRoute || "adjectival-nnc",
        sourceInput,
        formulaRecord: canonicalFormulaBundle.formulaRecord,
        formulaRecords: canonicalFormulaBundle.formulaRecords,
        formulaRealizationRecord: canonicalFormulaBundle.formulaRealizationRecord,
        formulaRealizationRecords: canonicalFormulaBundle.formulaRealizationRecords
      }) : null;
    ...
    function attachAdjectivalNncGrammarContract(result = null) {
      ...
      const formulaSurfaceFields = buildAdjectivalNncFormulaSurfacePairFields({
        output,
        resultContract
      });
      return {
        ...output,
        ...formulaSurfaceFields,
        grammarFrame,
        ...resultContract
      };
    }
    function buildAdjectivalNncFormulaSurfacePairs({
      output = null,
      resultContract = null
    } = {}) {
      ...
      if (Array.isArray(source.formulaSurfacePairs) && source.formulaSurfacePairs.length) {
        return Object.freeze(source.formulaSurfacePairs.map(entry => entry && typeof entry === "object" ? {
      ...
      const frame = source.adjectivalNncFunctionFrame && typeof source.adjectivalNncFunctionFrame === "object" ? source.adjectivalNncFunctionFrame : {};
      const targetFormulaEcho = String(source.formulaEcho || frame.sourceFormulaEcho || source.clauseFrame?.fullFormulaEcho || source.clauseFrame?.formulaEcho || source.nncBasic?.formulaEcho || "").trim();
      if (!targetFormulaEcho) {
        return Object.freeze([]);
      }
      const surfaces = (Array.isArray(resultContract?.surfaceForms) && resultContract.surfaceForms.length ? resultContract.surfaceForms : getAdjectivalNncSurfaceForms(source)).flatMap(entry => splitAdjectivalNncSurfaceText(entry)).map(entry => String(entry || "").trim()).filter(Boolean);
      const sourceStem = String(frame.sourcePredicateStem || source.sourceStem || source.stem || "STEM").trim() || "STEM";
      const seen = new Set();
      return Object.freeze(surfaces.filter(surface => {
        ...
        surface,
        targetFormulaEcho,
        sourceToTargetFormulaEcho: `ADJ(${sourceStem}) -> ${targetFormulaEcho}`
      })));
    }
    function buildAdjectivalNncFormulaSurfacePairFields({
      output = null,
      resultContract = null
    } = {}) {
      const formulaSurfacePairs = buildAdjectivalNncFormulaSurfacePairs({
        output,
        resultContract
      });
      return {
    ...
    function buildAdjectivalNncFormulaRealizationSegmentFrames(formulaSlots = null) {
      if (!formulaSlots || typeof formulaSlots !== "object") {
        return [];
      }
      const subject = formulaSlots.pers1Pers2 || {};
      ...
      return [{
        slot: "pers1-pers2",
        role: "subject-person",
        formulaValue: subject.displayPrefix || subject.displayDyad || subject.prefix || "",
        surface: subject.prefix || subject.surface || "",
        orthographyBridge: "Nawat/Pipil orthography bridge"
      }, {
        slot: "STEM",
        role: "predicate",
        formulaValue: predicate.stem || predicate.formulaValue || predicate.structural || "",
        surface: predicate.surface || predicate.stem || "",
        orthographyBridge: "Nawat/Pipil orthography bridge"
      }, {
        slot: "num1-num2",
        role: "subject-number-connector",
        formulaValue: connector.displayDyad || connector.connector || connector.structural || "",
        surface: connector.surface || connector.compactSurface || connector.connector || "",
        orthographyBridge: "Nawat/Pipil orthography bridge"
      }];
    }
    function buildAdjectivalNncCanonicalFormulaRecordBundle({
      output = null,
      functionFrame = null,
      routeContract = null,
      formulaSlots = null,
      ...
      const formulaText = buildAdjectivalNncFormulaEchoFromSlots(slots);
      if (!slots || !formulaText || typeof targetObject.buildGrammarFormulaRecord !== "function") {
        return {
          formulaRecord: null,
          formulaRecords: [],
      ...
      const source = output && typeof output === "object" ? output : {};
      const frame = functionFrame && typeof functionFrame === "object" ? functionFrame : {};
      const sourceFrameId = ["adjectival-nnc-source", frame.sourceClauseKind || source.clauseKind || "nnc", slots.predicateStem?.stem || source.stem || "stem"].map(entry => String(entry || "").trim()).filter(Boolean).join(":");
      const defaultOperationFrame = {
        operationId: "andrews-40-adjectival-nnc-function",
        family: "adjectival-nnc",
        andrewsSection: frame.lessonRef || "Andrews 40.1",
        sourceFrameId,
        routeFamily: "adjectival-nnc",
        operationApplied: "use-licensed-nnc-as-adjectival-function",
        requestedPredicateState: frame.requestedPredicateState || source.state || "",
        requiredPredicateState: frame.requiredPredicateState || "absolutive",
        sourceClauseKind: frame.sourceClauseKind || source.clauseKind || "",
        targetOutputKind: source.outputKind || "adjectival-nnc-function"
      };
      const operationFrame = Object.freeze(source.operationFrame && typeof source.operationFrame === "object" ? source.operationFrame : frame.operationFrame && typeof frame.operationFrame === "object" ? frame.operationFrame : defaultOperationFrame);
      const formulaRecord = targetObject.buildGrammarFormulaRecord({
        id: ["adjectival-nnc", source.outputKind || "function", formulaText].map(entry => String(entry || "").trim()).filter(Boolean).join(":"),
        unit: "NNC",
        formula: formulaText,
        formulaSlots: slots,
        routeContract,
        sourceFrame: {
          id: sourceFrameId,
          label: String(sourceFormulaEcho || formulaText || "").trim(),
          formula: formulaText,
          formulaSlots: slots,
          sourceClauseKind: frame.sourceClauseKind || source.clauseKind || "",
          sourceCategory: frame.sourceCategory || ""
        },
        operationFrames: [operationFrame],
        source: "adjectival-nnc-structured-formula-slots"
      });
      const segmentFrames = buildAdjectivalNncFormulaRealizationSegmentFrames(slots).map(segment => ({
        ...segment,
        operationId: operationFrame.operationId,
        sourceFrameId
      }));
      const segmentSurface = segmentFrames.map(segment => String(segment?.surface || "").trim()).join("");
      const seen = new Set();
      const formulaRealizationRecords = (Array.isArray(surfaceForms) ? surfaceForms : []).map(surface => normalizeAdjectivalNncSurfaceValue(surface)).filter(surface => {
        if (!surface || seen.has(surface)) {
          return false;
        }
        seen.add(surface);
        return true;
      }).map((surface, index) => typeof targetObject.buildGrammarFormulaRealizationRecord === "function" ? targetObject.buildGrammarFormulaRealizationRecord({
        id: `${formulaRecord.id}:realization-${index}`,
        formulaRecord,
        unit: "NNC",
        segmentFrames,
        surfaceForms: [surface],
        deriveSurfaceFromSegments: segmentSurface === surface,
        source: "adjectival-nnc-structured-segment-frames"
      }) : null).filter(Boolean);
      return {
        formulaRecord,
        formulaRecords: formulaRecord ? [formulaRecord] : [],
        formulaRealizationRecord: formulaRealizationRecords[0] || null,
        formulaRealizationRecords
      };
    }
    ...
    function buildRootPlusYaAdjectivalNncSubjectFrame(subject = null) {
      const slot = subject && typeof subject === "object" ? subject : {};
      return Object.freeze({
        kind: "root-plus-ya-adjectival-nnc-subject-frame",
        subjectPrefix: String(slot.subjectPrefix || ""),
        subjectSuffix: String(slot.subjectSuffix || ""),
        personSubKey: String(slot.personSubKey || slot.subjectKey || "3sg")
      });
    }
    function buildRootPlusYaAdjectivalNncSourceFrame({
      parsedVerb = null,
      subject = null,
      state = "absolutive",
      ...
      const subjectFrame = buildRootPlusYaAdjectivalNncSubjectFrame(subject);
      const sourceRawStem = String(parsedVerb.sourceRawVerb || parsedVerb.displayVerb || parsedVerb.verb || "").trim();
      const rootPlusYaBase = String(source.rootPlusYaBase || "").trim();
      return Object.freeze({
        kind: "root-plus-ya-adjectival-nnc-source-frame",
        version: 1,
        routeFamily: "adjectival-nnc",
        routeSubtype: "root-plus-ya-obsolete-preterit",
        andrewsSection: "Andrews 40.9",
        sourceRawStem,
        sourceVerb: String(parsedVerb.verb || ""),
        ...
        sourceSupported: source.supported === true,
        diagnosticId: source.diagnosticId || "",
        requestedState,
        role,
        subjectFrame,
        sourceFormationFrame: resolveAdjectivalNncSourceFormationFrame({
          parsedVerb,
          rootPlusYaBase,
          sourceFormationSubtype: source.sourceFormationSubtype
        }),
        denominalCompoundSourceFrame: resolveDenominalCompoundAdjectivalNncSourceFrame({
          parsedVerb,
          rootPlusYaBase,
          sourceFormationSubtype: source.sourceFormationSubtype
        }),
        parsedVerbSnapshot: Object.freeze({
          sourceRawVerb: String(parsedVerb.sourceRawVerb || ""),
          displayVerb: String(parsedVerb.displayVerb || ""),
          displayCore: String(parsedVerb.displayCore || ""),
          verb: String(parsedVerb.verb || ""),
          analysisVerb: String(parsedVerb.analysisVerb || "")
        }),
        sourceSignature: [sourceRawStem, rootPlusYaBase, source.sourceFormationSubtype || "", requestedState, subjectFrame.subjectPrefix, subjectFrame.subjectSuffix, subjectFrame.personSubKey].join("|"),
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false
      });
    }
    function buildRootPlusYaAdjectivalNncOperationFrame(sourceFrame = null) {
      if (!sourceFrame || sourceFrame.kind !== "root-plus-ya-adjectival-nnc-source-frame" || sourceFrame.sourceSupported !== true || !sourceFrame.rootPlusYaBase) {
        return null;
      }
      const subject = sourceFrame.subjectFrame || {};
      const formulaSlots = buildRootPlusYaAdjectivalNncFormulaSlots({
        ...
        subject: {
          ...
          personSubKey: subject.personSubKey || "3sg"
        },
        sourceFormationSubtype: sourceFrame.sourceFormationSubtype
      });
      const connector = resolveAdjectivalNncFormulaSlotText(formulaSlots.num1Num2, ["connector", "surface"]) || "k";
      const targetSegmentFrames = Object.freeze([Object.freeze({
        slot: "pers1-pers2",
        role: "subject-person",
        surface: subject.subjectPrefix || ""
      }), Object.freeze({
        slot: "STEM",
        role: "predicate",
        surface: sourceFrame.rootPlusYaBase
      }), Object.freeze({
        slot: "num1-num2",
        role: "subject-number-connector",
        surface: connector === "Ø" ? "" : connector
      })]);
      const targetSurface = targetSegmentFrames.map(segment => segment.surface).join("");
      return Object.freeze({
        kind: "andrews-typed-operation-frame",
        operationId: "andrews-40-9-root-plus-ya-adjectival-nnc-realization",
        family: "adjectival-nnc",
        routeFamily: "adjectival-nnc",
        routeSubtype: "root-plus-ya-obsolete-preterit",
        routeStage: "execute-typed-operation-frame",
        ...
        sourceRawStem: sourceFrame.sourceRawStem,
        sourceVerb: sourceFrame.sourceVerb,
        rootPlusYaBase: sourceFrame.rootPlusYaBase,
        sourceFormationSubtype: sourceFrame.sourceFormationSubtype,
        operationApplied: "derive-obsolete-preterit-root-plus-ya-adjectival-nnc-from-source-frame",
        targetFormulaSlots: formulaSlots,
        targetSegmentFrames,
        targetSurface,
        targetSignature: [sourceFrame.sourceSignature, targetSurface].join("|"),
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false
      });
    }
    function isRootPlusYaAdjectivalNncOperationFrame(operationFrame = null, sourceFrame = null) {
      if (!operationFrame || typeof operationFrame !== "object") {
        return false;
      }
      if (!sourceFrame || sourceFrame.kind !== "root-plus-ya-adjectival-nnc-source-frame" || sourceFrame.sourceSupported !== true) {
        return false;
      }
      const segmentSurface = Array.isArray(operationFrame.targetSegmentFrames) ? operationFrame.targetSegmentFrames.map(segment => String(segment?.surface || "")).join("") : "";
      const targetSlots = operationFrame.targetFormulaSlots && typeof operationFrame.targetFormulaSlots === "object" ? operationFrame.targetFormulaSlots : null;
      const targetStem = resolveAdjectivalNncFormulaSlotText(targetSlots?.predicateStem, ["stem", "surface"]);
      return operationFrame.kind === "andrews-typed-operation-frame" && operationFrame.operationId === "andrews-40-9-root-plus-ya-adjectival-nnc-realization" && operationFrame.routeFamily === "adjectival-nnc" && operationFrame.routeSubtype === "root-plus-ya-obsolete-preterit" && operationFrame.operationApplied === "derive-obsolete-preterit-root-plus-ya-adjectival-nnc-from-source-frame" && operationFrame.sourceFrameKind === sourceFrame.kind && operationFrame.sourceSignature === sourceFrame.sourceSignature && operationFrame.rootPlusYaBase === sourceFrame.rootPlusYaBase && operationFrame.sourceFormationSubtype === sourceFrame.sourceFormationSubtype && operationFrame.consumesRenderedInput === false && operationFrame.displayStringsAuthorizeGrammar === false && targetSlots && targetStem === sourceFrame.rootPlusYaBase && segmentSurface && segmentSurface === String(operationFrame.targetSurface || "");
    }
    ...
    function buildIntensifiedAdjectivalStemFromFormulaSlot(predicateSlot = null) {
      const sourceStem = resolveAdjectivalNncFormulaSlotText(predicateSlot, ["stem", "surface"]);
      if (!sourceStem) {
        return "";
      }
      const syllables = typeof targetObject.splitVerbSyllables === "function" ? targetObject.splitVerbSyllables(sourceStem) : [];
      const first = syllables?.[0] || null;
      if (!first || !first.nucleus) {
        return sourceStem;
      }
      return `${first.onset || ""}${first.nucleus || ""}j${sourceStem}`;
    }
    function buildIntensifiedAdjectivalNncOperationFrame({
      sourceContinuationFrame = null,
      sourceFormulaSlots = null,
      role = "predicate-surface"
    } = {}) {
      const resolvedSourceFormulaSlots = sourceContinuationFrame?.formulaRecord?.formulaSlots || sourceContinuationFrame?.formulaSlots || sourceFormulaSlots || null;
      const sourceFormulaRecord = sourceContinuationFrame?.formulaRecord || null;
      const sourcePredicateStem = resolveAdjectivalNncFormulaSlotText(resolvedSourceFormulaSlots?.predicateStem, ["stem", "surface"]);
      const intensifiedStem = buildIntensifiedAdjectivalStemFromFormulaSlot(resolvedSourceFormulaSlots?.predicateStem);
      const targetFormulaSlots = intensifiedStem ? buildIntensifiedAdjectivalNncFormulaSlots({
        sourceFormulaSlots: resolvedSourceFormulaSlots,
        intensifiedStem
      }) : null;
      const targetConnector = resolveAdjectivalNncFormulaSlotText(targetFormulaSlots?.num1Num2, ["connector", "surface"]);
      const targetSubjectPrefix = String(targetFormulaSlots?.pers1Pers2?.prefix || targetFormulaSlots?.pers1Pers2?.subjectPrefix || "");
      const targetSegmentFrames = targetFormulaSlots ? Object.freeze([Object.freeze({
        slot: "pers1-pers2",
        role: "subject-person",
        surface: targetSubjectPrefix
      }), Object.freeze({
        slot: "STEM",
        role: "predicate",
        surface: intensifiedStem
      }), Object.freeze({
        slot: "num1-num2",
        role: "subject-number-connector",
        surface: targetConnector === "Ø" ? "" : targetConnector
      })]) : Object.freeze([]);
      const targetSurface = targetSegmentFrames.map(segment => String(segment?.surface || "")).join("");
      return Object.freeze({
        kind: "andrews-typed-operation-frame",
        operationId: "andrews-41-1-intensified-adjectival-reduplication",
        family: "adjectival-nnc",
        routeFamily: "adjectival-nnc",
        routeStage: "execute-typed-operation-frame",
        andrewsSection: "Andrews 41.1",
        sourceFrameKind: sourceContinuationFrame?.kind || "",
        sourceFormulaRecordId: String(sourceFormulaRecord?.id || "").trim(),
        sourceUnit: String(sourceContinuationFrame?.unit || sourceFormulaRecord?.unit || "NNC").trim(),
        targetUnit: "NNC",
        operationApplied: "derive-intensified-adjectival-nnc-from-source-formula-frame",
        reduplicationKind: "adjectival-intensification",
        sourcePredicateStem,
        targetPredicateStem: intensifiedStem,
        sourceFormulaSlots: resolvedSourceFormulaSlots,
        targetFormulaSlots,
        targetSegmentFrames,
        targetSurface,
        ...
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false,
        outputPolicy: "source-formula-frame-plus-andrews-41-1-operation-authorizes-intensified-adjectival-function"
      });
    }
    function isIntensifiedAdjectivalNncOperationFrame(operationFrame = null, sourceContinuationFrame = null) {
      if (!operationFrame || typeof operationFrame !== "object") {
        return false;
      }
      const sourceFormulaRecordId = String(sourceContinuationFrame?.formulaRecord?.id || "").trim();
      const operationSourceFormulaRecordId = String(operationFrame.sourceFormulaRecordId || "").trim();
      const targetFormulaSlots = operationFrame.targetFormulaSlots && typeof operationFrame.targetFormulaSlots === "object" ? operationFrame.targetFormulaSlots : null;
      const expectedSourceStem = resolveAdjectivalNncFormulaSlotText(sourceContinuationFrame?.formulaRecord?.formulaSlots?.predicateStem || sourceContinuationFrame?.formulaSlots?.predicateStem, ["stem", "surface"]);
      const expectedTargetStem = buildIntensifiedAdjectivalStemFromFormulaSlot(sourceContinuationFrame?.formulaRecord?.formulaSlots?.predicateStem || sourceContinuationFrame?.formulaSlots?.predicateStem);
      const operationTargetStem = String(operationFrame.targetPredicateStem || "").trim();
      const slotTargetStem = resolveAdjectivalNncFormulaSlotText(targetFormulaSlots?.predicateStem, ["stem", "surface"]);
      const segmentSurface = Array.isArray(operationFrame.targetSegmentFrames) ? operationFrame.targetSegmentFrames.map(segment => String(segment?.surface || "")).join("") : "";
      return operationFrame.kind === "andrews-typed-operation-frame" && operationFrame.operationId === "andrews-41-1-intensified-adjectival-reduplication" && operationFrame.routeFamily === "adjectival-nnc" && operationFrame.operationApplied === "derive-intensified-adjectival-nnc-from-source-formula-frame" && operationFrame.consumesRenderedInput === false && operationFrame.displayStringsAuthorizeGrammar === false && targetFormulaSlots && expectedSourceStem && expectedTargetStem && String(operationFrame.sourcePredicateStem || "").trim() === expectedSourceStem && operationTargetStem === expectedTargetStem && slotTargetStem === expectedTargetStem && segmentSurface && segmentSurface === String(operationFrame.targetSurface || "") && (!sourceFormulaRecordId || operationSourceFormulaRecordId === sourceFormulaRecordId);
    }
    ...
    function getDenominalCompoundAdjectivalNncSourceSurface(parsedVerb = null, compoundParts = []) {
      const rawInput = String(parsedVerb?.sourceRawVerb || parsedVerb?.displayVerb || parsedVerb?.displayCore || "").trim();
      if (rawInput) {
        return rawInput;
      }
      const parts = Array.isArray(compoundParts) ? compoundParts.map(part => normalizeAdjectivalNncText(part)).filter(Boolean) : [];
    ...
    function buildDenominalCompoundAdjectivalNncObjectSlotOwnershipFrame({
      ...
      return {
        ...
        objectSlotLicensingOrder: ["source-principal-nnc", "denominal-verbstem-route", "matrix-valence-frame", "route-frame", "function-use-annotation"]
      };
    }
    function buildDenominalCompoundAdjectivalNncRouteFrame({
      ...
      const embedRole = sourceAdjunctNncs.length === 1 ? sourceAdjunctNncs[0].role : sourceAdjunctNncs.length ? "multiple-compound-noun-embeds" : "";
    ...
    function buildRootPlusYaAdjectivalNncFunctionFrame({
      ...
      const sourceFormationFrame = sourceFrame?.sourceFormationFrame || resolveAdjectivalNncSourceFormationFrame({
        parsedVerb,
        rootPlusYaBase,
        sourceFormationSubtype
      });
      const denominalCompoundSourceFrame = sourceFrame?.denominalCompoundSourceFrame || resolveDenominalCompoundAdjectivalNncSourceFrame({
        parsedVerb,
        rootPlusYaBase,
        sourceFormationSubtype
      });
      return {
        ...
        ...(sourceFrame && typeof sourceFrame === "object" ? {
          sourceFrame
        } : {}),
    ...
    function buildRootPlusYaAdjectivalNncUnsupportedOutput({
      ...
      const framedParsedVerb = parsedVerb || sourceFrame?.parsedVerbSnapshot || null;
      const framedRootPlusYaBase = rootPlusYaBase || sourceFrame?.rootPlusYaBase || framedParsedVerb?.rootPlusYaBasePronounceable || framedParsedVerb?.rootPlusYaBase || "";
      const frame = buildRootPlusYaAdjectivalNncFunctionFrame({
        parsedVerb: framedParsedVerb,
        rootPlusYaBase: framedRootPlusYaBase,
        formulaSlots: null,
        requestedState,
        sourceFormationSubtype: sourceFormationSubtype || sourceFrame?.sourceFormationSubtype || "",
        sourceFrame,
        operationFrame
      });
    ...
    function buildAdjectivalNncFunctionFrame({
      ...
      const resolvedSourceFormulaSlots = sourceFormulaSlots && typeof sourceFormulaSlots === "object" ? sourceFormulaSlots : sourceNnc?.nncBasic?.formulaSlots || sourceNnc?.clauseFrame?.formulaSlots || null;
      const resolvedSourceFormulaEcho = String(sourceFormulaEcho || sourceNnc?.nncBasic?.formulaEcho || sourceNnc?.clauseFrame?.formulaEcho || "");
      return {
        version: ADJECTIVAL_NNC_GENERATION_VERSION,
        ...
        ...(sourceContinuationFrame && typeof sourceContinuationFrame === "object" ? {
          sourceContinuationFrame
        } : {}),
        ...(targetContinuationFrame && typeof targetContinuationFrame === "object" ? {
    ...
    function isAdjectivalNncGeneratedOutputTypedContinuationFrame(frame = null) {
    ...
    function getStructuredOrdinaryAdjectivalNncSourceFormulaSlots({
      sourceFormulaSlots = null,
      sourceContinuationFrame = null
    } = {}) {
      if (sourceFormulaSlots && typeof sourceFormulaSlots === "object") {
        return sourceFormulaSlots;
      }
      if (sourceContinuationFrame?.formulaSlots && typeof sourceContinuationFrame.formulaSlots === "object") {
        return sourceContinuationFrame.formulaSlots;
      }
      if (sourceContinuationFrame?.formulaRecord?.formulaSlots && typeof sourceContinuationFrame.formulaRecord.formulaSlots === "object") {
        return sourceContinuationFrame.formulaRecord.formulaSlots;
      }
      return null;
    }
    function buildStructuredOrdinaryAdjectivalNncOperationFrame({
      sourceContinuationFrame = null,
      sourceFormulaSlots = null,
      requestedState = "absolutive",
      role = "modifier-candidate"
    ...
    function realizeStructuredOrdinaryAdjectivalNncSurfaceFromSlots(formulaSlots = null) {
      const segmentFrames = buildAdjectivalNncFormulaRealizationSegmentFrames(formulaSlots);
      const surface = segmentFrames.map(segment => {
        const explicitSurface = normalizeAdjectivalNncSurfaceValue(segment?.surface || "");
        if (explicitSurface) {
          return explicitSurface;
        }
        const formulaValue = normalizeAdjectivalNncSurfaceValue(segment?.formulaValue || "");
        if (!formulaValue || formulaValue === "Ø" || formulaValue === "0") {
          return "";
        }
        return typeof targetObject.convertClassicalLettersToNawat === "function" ? targetObject.convertClassicalLettersToNawat(formulaValue, {
    ...
    function getAdjectivalNncTypedFrameRealizationSurfaces(frame = null) {
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(frame)) {
        return [];
      }
      const record = frame.formulaRealizationRecord || {};
      return [...(Array.isArray(record.surfaceForms) ? record.surfaceForms : []), record.surface || ""].map(entry => normalizeAdjectivalNncSurfaceValue(entry)).filter((entry, index, list) => entry && list.indexOf(entry) === index);
    }
    function getStructuredOrdinaryAdjectivalNncTargetOperationFrame(frame = null) {
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(frame)) {
        return null;
      }
      const operationFrames = Array.isArray(frame.formulaRecord?.operationFrames) ? frame.formulaRecord.operationFrames : [];
      return operationFrames.find(operationFrame => String(operationFrame?.operationId || "").trim() === "andrews-40-ordinary-nnc-adjectival-function") || null;
    }
    function isStructuredOrdinaryAdjectivalNncTargetOperationFrame(operationFrame = null, sourceContinuationFrame = null) {
      if (!operationFrame || typeof operationFrame !== "object") {
        return false;
      }
      const sourceFormulaRecordId = String(sourceContinuationFrame?.formulaRecord?.id || "").trim();
      const operationSourceFormulaRecordId = String(operationFrame.sourceFormulaRecordId || "").trim();
      return operationFrame.kind === "andrews-typed-operation-frame" && operationFrame.operationId === "andrews-40-ordinary-nnc-adjectival-function" && operationFrame.routeFamily === "adjectival-nnc" && operationFrame.operationApplied === "use-ordinary-nnc-as-adjectival-function" && operationFrame.consumesRenderedInput === false && operationFrame.displayStringsAuthorizeGrammar === false && (!sourceFormulaRecordId || operationSourceFormulaRecordId === sourceFormulaRecordId);
    }
    function buildVncAdjectivalNncOperationFrame({
      sourceContinuationFrame = null,
      targetContinuationFrame = null,
      role = "predicate-surface"
    } = {}) {
      const sourceFormulaRecord = sourceContinuationFrame?.formulaRecord || null;
      const targetFormulaRecord = targetContinuationFrame?.formulaRecord || sourceFormulaRecord || null;
      return Object.freeze({
        kind: "andrews-typed-operation-frame",
        operationId: "andrews-40-3-vnc-adjectival-function",
        family: "adjectival-nnc",
        routeFamily: "adjectival-nnc",
        routeStage: "execute-typed-operation-frame",
        andrewsSection: "Andrews 40.3",
        sourceFrameKind: sourceContinuationFrame?.kind || "",
        targetFrameKind: targetContinuationFrame?.kind || "",
        sourceFormulaRecordId: String(sourceFormulaRecord?.id || "").trim(),
        targetFormulaRecordId: String(targetFormulaRecord?.id || "").trim(),
        sourceUnit: String(sourceContinuationFrame?.unit || sourceFormulaRecord?.unit || "VNC").trim(),
        targetUnit: String(targetContinuationFrame?.unit || targetFormulaRecord?.unit || "VNC").trim(),
        operationApplied: "use-vnc-as-adjectival-function",
        role,
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false,
        outputPolicy: "source-vnc-formula-realization-authorizes-adjectival-function"
      });
    }
    function getVncAdjectivalNncTargetOperationFrame(frame = null) {
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(frame)) {
        return null;
      }
      if (frame.operationFrame?.operationId === "andrews-40-3-vnc-adjectival-function") {
        return frame.operationFrame;
      }
      const operationFrames = Array.isArray(frame.formulaRecord?.operationFrames) ? frame.formulaRecord.operationFrames : [];
      return operationFrames.find(operationFrame => String(operationFrame?.operationId || "").trim() === "andrews-40-3-vnc-adjectival-function") || null;
    }
    function isVncAdjectivalNncOperationFrame(operationFrame = null, sourceContinuationFrame = null) {
      if (!operationFrame || typeof operationFrame !== "object") {
        return false;
      }
      const sourceFormulaRecordId = String(sourceContinuationFrame?.formulaRecord?.id || "").trim();
      const operationSourceFormulaRecordId = String(operationFrame.sourceFormulaRecordId || "").trim();
      return operationFrame.kind === "andrews-typed-operation-frame" && operationFrame.operationId === "andrews-40-3-vnc-adjectival-function" && operationFrame.routeFamily === "adjectival-nnc" && operationFrame.operationApplied === "use-vnc-as-adjectival-function" && operationFrame.consumesRenderedInput === false && operationFrame.displayStringsAuthorizeGrammar === false && (!sourceFormulaRecordId || operationSourceFormulaRecordId === sourceFormulaRecordId);
    }
    function buildPatientivoAdjectivalNncOperationFrame({
      sourceContinuationFrame = null,
      targetContinuationFrame = null,
      patientivoSource = "",
      role = "predicate-surface"
      ...
      return Object.freeze({
        kind: "andrews-typed-operation-frame",
        operationId: "andrews-40-4-patientive-adjectival-function",
        family: "adjectival-nnc",
        routeFamily: "adjectival-nnc",
        routeStage: "execute-typed-operation-frame",
        andrewsSection: "Andrews 40.4",
        sourceFrameKind: sourceContinuationFrame?.kind || "",
        targetFrameKind: targetContinuationFrame?.kind || "",
        sourceFormulaRecordId: String(sourceFormulaRecord?.id || "").trim(),
        targetFormulaRecordId: String(targetFormulaRecord?.id || "").trim(),
        sourceUnit: String(sourceContinuationFrame?.unit || sourceFormulaRecord?.unit || "NNC").trim(),
        targetUnit: String(targetContinuationFrame?.unit || targetFormulaRecord?.unit || "NNC").trim(),
        patientivoSource: String(patientivoSource || "").trim(),
        operationApplied: "use-patientive-nnc-as-adjectival-function",
        role,
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false,
        outputPolicy: "source-patientive-formula-realization-authorizes-adjectival-function"
      });
    }
    function getPatientivoAdjectivalNncTargetOperationFrame(frame = null) {
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(frame)) {
        return null;
      }
      if (frame.operationFrame?.operationId === "andrews-40-4-patientive-adjectival-function") {
        return frame.operationFrame;
      }
      const operationFrames = Array.isArray(frame.formulaRecord?.operationFrames) ? frame.formulaRecord.operationFrames : [];
      return operationFrames.find(operationFrame => String(operationFrame?.operationId || "").trim() === "andrews-40-4-patientive-adjectival-function") || null;
    }
    function isPatientivoAdjectivalNncOperationFrame(operationFrame = null, sourceContinuationFrame = null) {
      if (!operationFrame || typeof operationFrame !== "object") {
        return false;
      }
      const sourceFormulaRecordId = String(sourceContinuationFrame?.formulaRecord?.id || "").trim();
      const operationSourceFormulaRecordId = String(operationFrame.sourceFormulaRecordId || "").trim();
      return operationFrame.kind === "andrews-typed-operation-frame" && operationFrame.operationId === "andrews-40-4-patientive-adjectival-function" && operationFrame.routeFamily === "adjectival-nnc" && operationFrame.operationApplied === "use-patientive-nnc-as-adjectival-function" && operationFrame.consumesRenderedInput === false && operationFrame.displayStringsAuthorizeGrammar === false && (!sourceFormulaRecordId || operationSourceFormulaRecordId === sourceFormulaRecordId);
    }
    function buildCompoundSourceAdjectivalNncOperationFrame({
      sourceContinuationFrame = null,
      targetContinuationFrame = null,
      ...
      return Object.freeze({
        kind: "andrews-typed-operation-frame",
        operationId: "andrews-41-2-compound-source-adjectival-function",
        family: "adjectival-nnc",
        routeFamily: "adjectival-nnc",
        routeStage: "execute-typed-operation-frame",
        andrewsSection: "Andrews 41.2",
        sourceFrameKind: sourceContinuationFrame?.kind || "",
        targetFrameKind: targetContinuationFrame?.kind || "",
        sourceFormulaRecordId: String(sourceFormulaRecord?.id || "").trim(),
        targetFormulaRecordId: String(targetFormulaRecord?.id || "").trim(),
        sourceUnit: String(sourceContinuationFrame?.unit || sourceFormulaRecord?.unit || "NNC").trim(),
        targetUnit: String(targetContinuationFrame?.unit || targetFormulaRecord?.unit || "NNC").trim(),
        sourceCompoundFrameKind: String(sourceCompoundFrame?.kind || "").trim(),
        nominalizationKind: normalizeAdjectivalNncText(nominalizationKind) || "adjectival-surface",
        operationApplied: "use-compound-source-nnc-as-adjectival-function",
        role,
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false,
        outputPolicy: "compound-source-formula-realization-authorizes-adjectival-function"
      });
    }
    function getCompoundSourceAdjectivalNncTargetOperationFrame(frame = null) {
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(frame)) {
        return null;
      }
      if (frame.operationFrame?.operationId === "andrews-41-2-compound-source-adjectival-function") {
        return frame.operationFrame;
      }
      const operationFrames = Array.isArray(frame.formulaRecord?.operationFrames) ? frame.formulaRecord.operationFrames : [];
      return operationFrames.find(operationFrame => String(operationFrame?.operationId || "").trim() === "andrews-41-2-compound-source-adjectival-function") || null;
    }
    function isCompoundSourceAdjectivalNncOperationFrame(operationFrame = null, sourceContinuationFrame = null) {
      if (!operationFrame || typeof operationFrame !== "object") {
        return false;
      }
      const sourceFormulaRecordId = String(sourceContinuationFrame?.formulaRecord?.id || "").trim();
      const operationSourceFormulaRecordId = String(operationFrame.sourceFormulaRecordId || "").trim();
      return operationFrame.kind === "andrews-typed-operation-frame" && operationFrame.operationId === "andrews-41-2-compound-source-adjectival-function" && operationFrame.routeFamily === "adjectival-nnc" && operationFrame.operationApplied === "use-compound-source-nnc-as-adjectival-function" && operationFrame.consumesRenderedInput === false && operationFrame.displayStringsAuthorizeGrammar === false && (!sourceFormulaRecordId || operationSourceFormulaRecordId === sourceFormulaRecordId);
    }
    function buildDenominalCompoundAdjectivalNncOperationFrame({
      sourceContinuationFrame = null,
      targetContinuationFrame = null,
      ...
      return Object.freeze({
        kind: "andrews-typed-operation-frame",
        operationId: "andrews-41-3-denominal-compound-adjectival-function",
        family: "adjectival-nnc",
        routeFamily: "adjectival-nnc",
        routeStage: "execute-typed-operation-frame",
        andrewsSection: "Andrews 41.3",
        ...
        sourceUnit: String(sourceContinuationFrame?.unit || sourceFormulaRecord?.unit || "NNC").trim(),
        targetUnit: String(targetContinuationFrame?.unit || targetFormulaRecord?.unit || "NNC").trim(),
        sourceDenominalCompoundFrameKind: String(sourceDenominalCompoundFrame?.kind || "").trim(),
        nominalizationKind: "preterit-agentive",
        operationApplied: "use-denominal-compound-nnc-as-adjectival-function",
        role,
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false,
        outputPolicy: "denominal-compound-formula-realization-authorizes-adjectival-function"
      });
    }
    function getDenominalCompoundAdjectivalNncTargetOperationFrame(frame = null) {
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(frame)) {
        return null;
      }
      if (frame.operationFrame?.operationId === "andrews-41-3-denominal-compound-adjectival-function") {
        return frame.operationFrame;
      }
      const operationFrames = Array.isArray(frame.formulaRecord?.operationFrames) ? frame.formulaRecord.operationFrames : [];
      return operationFrames.find(operationFrame => String(operationFrame?.operationId || "").trim() === "andrews-41-3-denominal-compound-adjectival-function") || null;
    }
    function isDenominalCompoundAdjectivalNncOperationFrame(operationFrame = null, sourceContinuationFrame = null) {
      if (!operationFrame || typeof operationFrame !== "object") {
        return false;
      }
      const sourceFormulaRecordId = String(sourceContinuationFrame?.formulaRecord?.id || "").trim();
      const operationSourceFormulaRecordId = String(operationFrame.sourceFormulaRecordId || "").trim();
      return operationFrame.kind === "andrews-typed-operation-frame" && operationFrame.operationId === "andrews-41-3-denominal-compound-adjectival-function" && operationFrame.routeFamily === "adjectival-nnc" && operationFrame.operationApplied === "use-denominal-compound-nnc-as-adjectival-function" && operationFrame.consumesRenderedInput === false && operationFrame.displayStringsAuthorizeGrammar === false && (!sourceFormulaRecordId || operationSourceFormulaRecordId === sourceFormulaRecordId);
    }
    function buildNominalizedVncAdjectivalNncOperationFrame({
      sourceContinuationFrame = null,
      targetContinuationFrame = null,
      nominalizationKind = "",
      ...
      const sourceFormulaRecord = sourceContinuationFrame?.formulaRecord || null;
      const targetFormulaRecord = targetContinuationFrame?.formulaRecord || sourceFormulaRecord || null;
      const resolvedNominalizationKind = normalizeAdjectivalNncText(nominalizationKind || nominalizationProfile?.role?.nominalizationKind || "");
      const lessonSpec = resolveNominalizedVncAdjectivalLessonSpec(resolvedNominalizationKind) || {};
      return Object.freeze({
        kind: "andrews-typed-operation-frame",
        operationId: "andrews-40-5-40-8-nominalized-vnc-adjectival-function",
        family: "adjectival-nnc",
        routeFamily: "adjectival-nnc",
        routeStage: "execute-typed-operation-frame",
        andrewsSection: lessonSpec.lessonRef || "Andrews 40.5-40.8",
        sourceFrameKind: sourceContinuationFrame?.kind || "",
        targetFrameKind: targetContinuationFrame?.kind || "",
        sourceFormulaRecordId: String(sourceFormulaRecord?.id || "").trim(),
        targetFormulaRecordId: String(targetFormulaRecord?.id || "").trim(),
        ...
        operationApplied: "use-nominalized-vnc-nnc-as-adjectival-function",
        role,
        consumesRenderedInput: false,
        displayStringsAuthorizeGrammar: false,
        outputPolicy: "nominalized-vnc-formula-realization-authorizes-adjectival-function"
      });
    }
    function getNominalizedVncAdjectivalNncTargetOperationFrame(frame = null) {
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(frame)) {
        return null;
      }
      if (frame.operationFrame?.operationId === "andrews-40-5-40-8-nominalized-vnc-adjectival-function") {
        return frame.operationFrame;
      }
      const operationFrames = Array.isArray(frame.formulaRecord?.operationFrames) ? frame.formulaRecord.operationFrames : [];
      return operationFrames.find(operationFrame => String(operationFrame?.operationId || "").trim() === "andrews-40-5-40-8-nominalized-vnc-adjectival-function") || null;
    }
    function isNominalizedVncAdjectivalNncOperationFrame(operationFrame = null, sourceContinuationFrame = null) {
      if (!operationFrame || typeof operationFrame !== "object") {
        return false;
      }
      const sourceFormulaRecordId = String(sourceContinuationFrame?.formulaRecord?.id || "").trim();
      const operationSourceFormulaRecordId = String(operationFrame.sourceFormulaRecordId || "").trim();
      return operationFrame.kind === "andrews-typed-operation-frame" && operationFrame.operationId === "andrews-40-5-40-8-nominalized-vnc-adjectival-function" && operationFrame.routeFamily === "adjectival-nnc" && operationFrame.operationApplied === "use-nominalized-vnc-nnc-as-adjectival-function" && operationFrame.consumesRenderedInput === false && operationFrame.displayStringsAuthorizeGrammar === false && (!sourceFormulaRecordId || operationSourceFormulaRecordId === sourceFormulaRecordId);
    }
    function buildStructuredOrdinaryAdjectivalNncUnsupportedOutput({
      requestedState = "absolutive",
      sourceFormulaSlots = null,
      sourceContinuationFrame = null,
      targetContinuationFrame = null,
      ...
      const frame = buildAdjectivalNncFunctionFrame({
        sourceFormulaSlots,
        sourceFormulaEcho: buildAdjectivalNncFormulaEchoFromSlots(sourceFormulaSlots),
        sourceContinuationFrame,
        targetContinuationFrame,
        operationFrame,
        requestedState,
      ...
      return attachAdjectivalNncGrammarContract({
        ...
        generationRoute: "adjectival-nnc",
        formulaSlots: sourceFormulaSlots,
        formulaEcho: buildAdjectivalNncFormulaEchoFromSlots(sourceFormulaSlots),
        operationFrame,
        sourceContinuationFrame,
        targetContinuationFrame,
        adjectivalNncFunctionFrame: frame,
    ...
    function buildStructuredOrdinaryAdjectivalNncFunctionOutput({
      sourceContinuationFrame = null,
      targetContinuationFrame = null,
      sourceFormulaSlots = null,
      state = "absolutive",
      ...
      const requestedState = normalizeAdjectivalNncState(state);
      const resolvedSourceFormulaSlots = getStructuredOrdinaryAdjectivalNncSourceFormulaSlots({
        sourceFormulaSlots,
        sourceContinuationFrame
      });
      const operationFrame = buildStructuredOrdinaryAdjectivalNncOperationFrame({
        sourceContinuationFrame,
        sourceFormulaSlots: resolvedSourceFormulaSlots,
        requestedState,
        role
      ...
      if (requestedState !== "absolutive") {
        return buildStructuredOrdinaryAdjectivalNncUnsupportedOutput({
          requestedState,
          sourceFormulaSlots: resolvedSourceFormulaSlots,
          sourceContinuationFrame,
          targetContinuationFrame,
          operationFrame,
          role,
          diagnostic: buildAdjectivalNncDiagnostic(ADJECTIVAL_NNC_DIAGNOSTIC_IDS.requiresAbsolutiveState, "Structured adjectival NNC function follows Andrews 40.1 and requires absolutive predicate state.")
        });
      }
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(sourceContinuationFrame)) {
        return buildStructuredOrdinaryAdjectivalNncUnsupportedOutput({
          requestedState,
          sourceFormulaSlots: resolvedSourceFormulaSlots,
          sourceContinuationFrame,
          ...
          operationFrame,
          role,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-requires-typed-source-frame", "Structured adjectival NNC function requires a typed source formula frame; rendered words cannot authorize this route.")
        });
      }
      if (!resolvedSourceFormulaSlots?.predicateStem || !resolvedSourceFormulaSlots?.num1Num2) {
        return buildStructuredOrdinaryAdjectivalNncUnsupportedOutput({
          requestedState,
          sourceFormulaSlots: resolvedSourceFormulaSlots,
          sourceContinuationFrame,
          ...
          operationFrame,
          role,
          diagnostic: buildAdjectivalNncDiagnostic(ADJECTIVAL_NNC_DIAGNOSTIC_IDS.requiresFormulaSlots, "Structured adjectival NNC function requires ordinary NNC formula slots from the source frame.")
        });
      }
      const {
        surface,
        segmentFrames
      } = realizeStructuredOrdinaryAdjectivalNncSurfaceFromSlots(resolvedSourceFormulaSlots);
      if (!surface) {
        return buildStructuredOrdinaryAdjectivalNncUnsupportedOutput({
          requestedState,
          sourceFormulaSlots: resolvedSourceFormulaSlots,
          ...
          operationFrame,
          role,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-structured-realization-empty", "Structured adjectival NNC function could not realize the formula slots through segment frames.")
        });
      }
      if (targetContinuationFrame) {
        if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(targetContinuationFrame)) {
          return buildStructuredOrdinaryAdjectivalNncUnsupportedOutput({
            requestedState,
            sourceFormulaSlots: resolvedSourceFormulaSlots,
            sourceContinuationFrame,
            ...
            operationFrame,
            role,
            diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-requires-typed-target-frame", "Structured adjectival NNC function requires a typed target frame when continuing from a prior generated target.")
          });
        }
        const targetOperationFrame = getStructuredOrdinaryAdjectivalNncTargetOperationFrame(targetContinuationFrame);
        if (!isStructuredOrdinaryAdjectivalNncTargetOperationFrame(targetOperationFrame, sourceContinuationFrame)) {
          return buildStructuredOrdinaryAdjectivalNncUnsupportedOutput({
            requestedState,
            sourceFormulaSlots: resolvedSourceFormulaSlots,
            sourceContinuationFrame,
            ...
            operationFrame,
            role,
            diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-structured-operation-frame-required", "Structured adjectival NNC continuation requires the target formula frame to carry the Andrews typed operation frame.")
          });
        }
        const targetFormula = String(targetContinuationFrame.formulaRecord?.formula || targetContinuationFrame.formulaRecord?.formulaText || "").trim();
        const sourceFormula = buildAdjectivalNncFormulaEchoFromSlots(resolvedSourceFormulaSlots);
        const targetSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(targetContinuationFrame);
        if (targetFormula && sourceFormula && targetFormula !== sourceFormula) {
          return buildStructuredOrdinaryAdjectivalNncUnsupportedOutput({
            requestedState,
            sourceFormulaSlots: resolvedSourceFormulaSlots,
            sourceContinuationFrame,
            ...
            operationFrame,
            role,
            diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-contradictory-target-frame", "Structured adjectival NNC target formula contradicts the source formula slots.")
          });
        }
        if (targetSurfaces.length && !targetSurfaces.includes(surface)) {
          return buildStructuredOrdinaryAdjectivalNncUnsupportedOutput({
            requestedState,
            sourceFormulaSlots: resolvedSourceFormulaSlots,
            sourceContinuationFrame,
            ...
            operationFrame,
            role,
            diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-contradictory-target-frame", "Structured adjectival NNC target realization contradicts the source formula realization.")
          });
        }
      }
      const formulaEcho = buildAdjectivalNncFormulaEchoFromSlots(resolvedSourceFormulaSlots);
      const frame = buildAdjectivalNncFunctionFrame({
        sourceFormulaSlots: resolvedSourceFormulaSlots,
        sourceFormulaEcho: formulaEcho,
        sourceContinuationFrame,
      ...
      return attachAdjectivalNncGrammarContract({
        ...
        result: surface,
        surfaceForms: [surface],
        stem: resolveAdjectivalNncFormulaSlotText(resolvedSourceFormulaSlots.predicateStem, ["stem", "surface"]),
        state: "absolutive",
        generationRoute: "adjectival-nnc",
        formulaSlots: resolvedSourceFormulaSlots,
        formulaEcho,
        sourceContinuationFrame,
        targetContinuationFrame,
        operationFrame,
    ...
    function buildPatientivoAdjectivalNncFunctionOutput({
      ...
      const requestedState = normalizeAdjectivalNncState(state);
      void requireStructuredContinuation;
      const requiresStructuredContinuation = true;
      ...
      if (requiresStructuredContinuation && !isAdjectivalNncGeneratedOutputTypedContinuationFrame(sourceContinuationFrame)) {
        return buildPatientivoAdjectivalNncUnsupportedOutput({
          patientivoSurface: "",
          patientivoSource: resolvedPatientivoSource,
          sourceTenseValue,
          ...
          targetContinuationFrame,
          operationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-patientive-source-frame-required", "Patientive adjectival function requires a typed source patientive NNC frame; display surface strings cannot authorize Andrews 40.4.")
        });
      }
      if (requiresStructuredContinuation && !isAdjectivalNncGeneratedOutputTypedContinuationFrame(targetContinuationFrame)) {
        return buildPatientivoAdjectivalNncUnsupportedOutput({
          patientivoSurface: "",
          patientivoSource: resolvedPatientivoSource,
          sourceTenseValue,
          ...
          targetContinuationFrame,
          operationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-patientive-target-frame-required", "Patientive adjectival function requires a typed target patientive NNC frame before continuing into adjectival use.")
        });
      }
      const resolvedOperationFrame = operationFrame && typeof operationFrame === "object" ? operationFrame : getPatientivoAdjectivalNncTargetOperationFrame(targetContinuationFrame);
      if (requiresStructuredContinuation && !isPatientivoAdjectivalNncOperationFrame(resolvedOperationFrame, sourceContinuationFrame)) {
        return buildPatientivoAdjectivalNncUnsupportedOutput({
          patientivoSurface: "",
          patientivoSource: resolvedPatientivoSource,
          sourceTenseValue,
          ...
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-patientive-structured-operation-frame-required", "Patientive adjectival function requires the typed Andrews 40.4 operation frame; surface strings cannot substitute for it.")
        });
      }
      const sourceFormula = String(sourceContinuationFrame?.formulaRecord?.formula || sourceContinuationFrame?.formulaRecord?.formulaText || "").trim();
      const targetFormula = String(targetContinuationFrame?.formulaRecord?.formula || targetContinuationFrame?.formulaRecord?.formulaText || "").trim();
      if (requiresStructuredContinuation && sourceFormula && targetFormula && sourceFormula !== targetFormula) {
        return buildPatientivoAdjectivalNncUnsupportedOutput({
          patientivoSurface: "",
          patientivoSource: resolvedPatientivoSource,
          sourceTenseValue,
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-patientive-contradictory-target-frame", "Patientive adjectival target formula contradicts the source patientive formula frame.")
        });
      }
      const sourceSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(sourceContinuationFrame);
      const targetSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(targetContinuationFrame);
      if (requiresStructuredContinuation && sourceSurfaces.length && targetSurfaces.length && !sourceSurfaces.includes(targetSurfaces[0])) {
        return buildPatientivoAdjectivalNncUnsupportedOutput({
          patientivoSurface: "",
          patientivoSource: resolvedPatientivoSource,
          sourceTenseValue,
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-patientive-contradictory-target-frame", "Patientive adjectival target realization contradicts the source patientive realization frame.")
        });
      }
      const surface = requiresStructuredContinuation ? targetSurfaces[0] || "" : String(patientivoSurface || "").trim();
      if (!surface) {
        return buildPatientivoAdjectivalNncUnsupportedOutput({
    ...
    function buildVncAdjectivalNncFunctionOutput({
      ...
      if (requiresStructuredContinuation && !isAdjectivalNncGeneratedOutputTypedContinuationFrame(sourceContinuationFrame)) {
        return buildVncAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-vnc-source-frame-required", "VNC adjectival function requires a typed source VNC frame; display surface strings cannot authorize Andrews 40.3.")
        });
      }
      if (requiresStructuredContinuation && !isAdjectivalNncGeneratedOutputTypedContinuationFrame(targetContinuationFrame)) {
        return buildVncAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-vnc-target-frame-required", "VNC adjectival function requires a typed target VNC frame before continuing into adjectival use.")
        });
      }
      const resolvedOperationFrame = operationFrame && typeof operationFrame === "object" ? operationFrame : getVncAdjectivalNncTargetOperationFrame(targetContinuationFrame);
      if (requiresStructuredContinuation && !isVncAdjectivalNncOperationFrame(resolvedOperationFrame, sourceContinuationFrame)) {
        return buildVncAdjectivalNncUnsupportedOutput({
          vncSurface: "",
          sourceVerb,
          sourceTenseValue,
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-vnc-structured-operation-frame-required", "VNC adjectival function requires the typed Andrews 40.3 operation frame; surface strings cannot substitute for it.")
        });
      }
      const sourceFormula = String(sourceContinuationFrame?.formulaRecord?.formula || sourceContinuationFrame?.formulaRecord?.formulaText || "").trim();
      const targetFormula = String(targetContinuationFrame?.formulaRecord?.formula || targetContinuationFrame?.formulaRecord?.formulaText || "").trim();
      if (requiresStructuredContinuation && sourceFormula && targetFormula && sourceFormula !== targetFormula) {
        return buildVncAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-vnc-contradictory-target-frame", "VNC adjectival target formula contradicts the source VNC formula frame.")
        });
      }
      const sourceSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(sourceContinuationFrame);
      const targetSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(targetContinuationFrame);
      if (requiresStructuredContinuation && sourceSurfaces.length && targetSurfaces.length && !sourceSurfaces.includes(targetSurfaces[0])) {
        return buildVncAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-vnc-contradictory-target-frame", "VNC adjectival target realization contradicts the source VNC realization frame.")
        });
      }
      const resolvedSurface = requiresStructuredContinuation ? targetSurfaces[0] || "" : String(vncSurface || surface || stem || "").trim();
      if (!resolvedSurface) {
        return buildVncAdjectivalNncUnsupportedOutput({
    ...
    function buildCompoundSourceAdjectivalNncFunctionOutput({
      ...
      if (requestedState !== "absolutive") {
        return buildCompoundSourceAdjectivalNncUnsupportedOutput({
          compoundSourceSurface: String(compoundSourceSurface || surface || stem || "").trim(),
          requestedState,
      ...
      if (requiresStructuredContinuation && !isAdjectivalNncGeneratedOutputTypedContinuationFrame(sourceContinuationFrame)) {
        return buildCompoundSourceAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-compound-source-source-frame-required", "Compound-source adjectival function requires a typed source compound NNC frame; display surface strings cannot authorize Andrews 41.2.")
        });
      }
      if (requiresStructuredContinuation && !isAdjectivalNncGeneratedOutputTypedContinuationFrame(targetContinuationFrame)) {
        return buildCompoundSourceAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-compound-source-target-frame-required", "Compound-source adjectival function requires a typed target frame before continuing into adjectival use.")
        });
      }
      const resolvedOperationFrame = operationFrame && typeof operationFrame === "object" ? operationFrame : getCompoundSourceAdjectivalNncTargetOperationFrame(targetContinuationFrame);
      if (requiresStructuredContinuation && !isCompoundSourceAdjectivalNncOperationFrame(resolvedOperationFrame, sourceContinuationFrame)) {
        return buildCompoundSourceAdjectivalNncUnsupportedOutput({
          compoundSourceSurface: "",
          requestedState,
          sourceCompoundFrame: resolvedCompoundFrame,
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-compound-source-structured-operation-frame-required", "Compound-source adjectival function requires the typed Andrews 41.2 operation frame; surface strings cannot substitute for it.")
        });
      }
      if (!resolvedCompoundFrame || typeof resolvedCompoundFrame !== "object" || String(resolvedCompoundFrame.kind || "").trim() !== "compound-frame") {
        return buildCompoundSourceAdjectivalNncUnsupportedOutput({
          compoundSourceSurface: requiresStructuredContinuation ? "" : String(compoundSourceSurface || surface || stem || "").trim(),
          requestedState,
          sourceCompoundFrame: resolvedCompoundFrame,
          nominalizationKind: resolvedNominalizationKind,
          formulaSlots,
      ...
      if (requiresStructuredContinuation && sourceFormula && targetFormula && sourceFormula !== targetFormula) {
        return buildCompoundSourceAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-compound-source-contradictory-target-frame", "Compound-source adjectival target formula contradicts the source compound formula frame.")
        });
      }
      const sourceSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(sourceContinuationFrame);
      const targetSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(targetContinuationFrame);
      if (requiresStructuredContinuation && sourceSurfaces.length && targetSurfaces.length && !sourceSurfaces.includes(targetSurfaces[0])) {
        return buildCompoundSourceAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-compound-source-contradictory-target-frame", "Compound-source adjectival target realization contradicts the source compound realization frame.")
        });
      }
      const resolvedSurface = requiresStructuredContinuation ? targetSurfaces[0] || "" : String(compoundSourceSurface || surface || stem || "").trim();
      const resolvedFormulaSlots = requiresStructuredContinuation ? targetContinuationFrame?.formulaRecord?.formulaSlots || targetContinuationFrame?.formulaSlots || sourceContinuationFrame?.formulaRecord?.formulaSlots || sourceContinuationFrame?.formulaSlots || formulaSlots || null : formulaSlots || null;
      const resolvedFormulaEcho = requiresStructuredContinuation ? targetFormula || sourceFormula || (resolvedFormulaSlots && typeof buildAdjectivalNncFormulaEchoFromSlots === "function" ? buildAdjectivalNncFormulaEchoFromSlots(resolvedFormulaSlots) : "") : String(formulaEcho || "");
      if (!resolvedSurface) {
        return buildCompoundSourceAdjectivalNncUnsupportedOutput({
          ...
          sourceCompoundFrame: resolvedCompoundFrame,
          nominalizationKind: resolvedNominalizationKind,
          formulaSlots: resolvedFormulaSlots,
          formulaEcho: resolvedFormulaEcho,
          sourceContinuationFrame,
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic(ADJECTIVAL_NNC_DIAGNOSTIC_IDS.requiresCompoundSourceSurface, "Compound-source adjectival NNC generation requires a generated compound-source NNC formula realization from #3 salida.")
        });
      }
    ...
    function buildDenominalCompoundAdjectivalNncFunctionOutput({
      ...
      if (requestedState !== "absolutive") {
        return buildDenominalCompoundAdjectivalNncUnsupportedOutput({
          denominalCompoundSurface: String(denominalCompoundSurface || surface || stem || "").trim(),
          requestedState,
      ...
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(sourceContinuationFrame)) {
        return buildDenominalCompoundAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-denominal-compound-source-frame-required", "Denominal-compound adjectival function requires a typed source preterit-agentive NNC frame; display surface strings cannot authorize Andrews 41.3.")
        });
      }
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(targetContinuationFrame)) {
        return buildDenominalCompoundAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-denominal-compound-target-frame-required", "Denominal-compound adjectival function requires a typed target frame before continuing into adjectival use.")
        });
      }
      const resolvedOperationFrame = operationFrame && typeof operationFrame === "object" ? operationFrame : getDenominalCompoundAdjectivalNncTargetOperationFrame(targetContinuationFrame);
      if (!isDenominalCompoundAdjectivalNncOperationFrame(resolvedOperationFrame, sourceContinuationFrame)) {
        return buildDenominalCompoundAdjectivalNncUnsupportedOutput({
          denominalCompoundSurface: "",
          requestedState,
          sourceDenominalCompoundFrame: resolvedFrame,
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-denominal-compound-structured-operation-frame-required", "Denominal-compound adjectival function requires the typed Andrews 41.3 operation frame; surface strings cannot substitute for it.")
        });
      }
      ...
      const sourceFormula = String(sourceContinuationFrame?.formulaRecord?.formula || sourceContinuationFrame?.formulaRecord?.formulaText || "").trim();
      const targetFormula = String(targetContinuationFrame?.formulaRecord?.formula || targetContinuationFrame?.formulaRecord?.formulaText || "").trim();
      if (sourceFormula && targetFormula && sourceFormula !== targetFormula) {
        return buildDenominalCompoundAdjectivalNncUnsupportedOutput({
          denominalCompoundSurface: "",
          requestedState,
          sourceDenominalCompoundFrame: resolvedFrame,
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-denominal-compound-contradictory-target-frame", "Denominal-compound adjectival target formula contradicts the source denominal compound formula frame.")
        });
      }
      const sourceSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(sourceContinuationFrame);
      const targetSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(targetContinuationFrame);
      if (sourceSurfaces.length && targetSurfaces.length && !sourceSurfaces.includes(targetSurfaces[0])) {
        return buildDenominalCompoundAdjectivalNncUnsupportedOutput({
          denominalCompoundSurface: "",
          requestedState,
          sourceDenominalCompoundFrame: resolvedFrame,
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-denominal-compound-contradictory-target-frame", "Denominal-compound adjectival target realization contradicts the source denominal compound realization frame.")
        });
      }
      const resolvedSurface = targetSurfaces[0] || "";
      const resolvedFormulaSlots = targetContinuationFrame?.formulaRecord?.formulaSlots || targetContinuationFrame?.formulaSlots || sourceContinuationFrame?.formulaRecord?.formulaSlots || sourceContinuationFrame?.formulaSlots || formulaSlots || null;
      const resolvedFormulaEcho = targetFormula || sourceFormula || (resolvedFormulaSlots && typeof buildAdjectivalNncFormulaEchoFromSlots === "function" ? buildAdjectivalNncFormulaEchoFromSlots(resolvedFormulaSlots) : "");
      if (!resolvedSurface) {
        return buildDenominalCompoundAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic(ADJECTIVAL_NNC_DIAGNOSTIC_IDS.requiresDenominalCompoundSurface, "Denominal-compound adjectival NNC generation requires a generated preterit-agentive NNC formula realization from #3 salida.")
        });
      }
    ...
    function buildIntensifiedAdjectivalNncFunctionFrame({
      ...
      const sourcePredicateStem = resolveAdjectivalNncFormulaSlotText(sourceFormulaSlots?.predicateStem, ["stem", "surface"]);
      return {
        version: ADJECTIVAL_NNC_GENERATION_VERSION,
    ...
    function buildIntensifiedAdjectivalNncOutput({
      ...
      const sourceSlots = sourceContinuationFrame?.formulaRecord?.formulaSlots || sourceContinuationFrame?.formulaSlots || sourceFormulaSlots || formulaSlots || null;
      const sourceEcho = sourceFormulaEcho || formulaEcho || "";
      const predicateStem = resolveAdjectivalNncFormulaSlotText(sourceSlots?.predicateStem, ["stem", "surface"]);
      const connector = resolveAdjectivalNncFormulaSlotText(sourceSlots?.num1Num2, ["connector", "surface"]);
      const resolvedOperationFrame = operationFrame && typeof operationFrame === "object" ? operationFrame : null;
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(sourceContinuationFrame)) {
        return buildIntensifiedAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-intensified-source-frame-required", "Intensified adjectival function requires a typed source formula frame; rendered source strings cannot authorize Andrews 41.1.")
        });
      }
      ...
      if (!isIntensifiedAdjectivalNncOperationFrame(resolvedOperationFrame, sourceContinuationFrame)) {
        return buildIntensifiedAdjectivalNncUnsupportedOutput({
          sourceSurface: "",
          sourceFormulaSlots: sourceSlots,
          sourceFormulaEcho: sourceEcho,
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-intensified-operation-frame-required", "Intensified adjectival function requires the typed Andrews 41.1 operation frame; surface strings cannot substitute for it.")
        });
      }
      const intensifiedFormulaSlots = resolvedOperationFrame.targetFormulaSlots;
      const intensifiedStem = String(resolvedOperationFrame.targetPredicateStem || "").trim();
      const intensifiedFormulaEcho = buildAdjectivalNncFormulaEchoFromSlots(intensifiedFormulaSlots);
      const result = String(resolvedOperationFrame.targetSurface || "");
    ...
    function buildNominalizedVncAdjectivalNncFunctionOutput({
      ...
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(sourceContinuationFrame)) {
        return buildNominalizedVncAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-nominalized-vnc-source-frame-required", "Nominalized VNC adjectival function requires a typed source nominalized NNC frame; display surface strings cannot authorize Andrews 40.5-40.8.")
        });
      }
      if (!isAdjectivalNncGeneratedOutputTypedContinuationFrame(targetContinuationFrame)) {
        return buildNominalizedVncAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-nominalized-vnc-target-frame-required", "Nominalized VNC adjectival function requires a typed target frame before continuing into adjectival use.")
        });
      }
      const resolvedOperationFrame = operationFrame && typeof operationFrame === "object" ? operationFrame : getNominalizedVncAdjectivalNncTargetOperationFrame(targetContinuationFrame);
      if (!isNominalizedVncAdjectivalNncOperationFrame(resolvedOperationFrame, sourceContinuationFrame)) {
        return buildNominalizedVncAdjectivalNncUnsupportedOutput({
          nominalizedSurface: "",
          requestedState,
          nominalizationProfile,
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-nominalized-vnc-structured-operation-frame-required", "Nominalized VNC adjectival function requires the typed Andrews 40.5-40.8 operation frame; surface strings cannot substitute for it.")
        });
      }
      if (!lessonSpec) {
        return buildNominalizedVncAdjectivalNncUnsupportedOutput({
      ...
      if (sourceFormula && targetFormula && sourceFormula !== targetFormula) {
        return buildNominalizedVncAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-nominalized-vnc-contradictory-target-frame", "Nominalized VNC adjectival target formula contradicts the source nominalized VNC formula frame.")
        });
      }
      const sourceSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(sourceContinuationFrame);
      const targetSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces(targetContinuationFrame);
      if (sourceSurfaces.length && targetSurfaces.length && !sourceSurfaces.includes(targetSurfaces[0])) {
        return buildNominalizedVncAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-nominalized-vnc-contradictory-target-frame", "Nominalized VNC adjectival target realization contradicts the source nominalized VNC realization frame.")
        });
      }
      const surface = targetSurfaces[0] || "";
      const resolvedFormulaSlots = targetContinuationFrame?.formulaRecord?.formulaSlots || targetContinuationFrame?.formulaSlots || sourceContinuationFrame?.formulaRecord?.formulaSlots || sourceContinuationFrame?.formulaSlots || formulaSlots || null;
      const resolvedFormulaEcho = targetFormula || sourceFormula || (resolvedFormulaSlots && typeof buildAdjectivalNncFormulaEchoFromSlots === "function" ? buildAdjectivalNncFormulaEchoFromSlots(resolvedFormulaSlots) : "");
      if (!surface) {
        return buildNominalizedVncAdjectivalNncUnsupportedOutput({
          ...
          targetContinuationFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic(ADJECTIVAL_NNC_DIAGNOSTIC_IDS.requiresNominalizedVncSurface, "Nominalized VNC adjectival NNC generation requires a generated NNC formula realization from #3 salida.")
        });
      }
    ...
    function generateRootPlusYaAdjectivalNncOutput({
      ...
      const resolvedSourceFrame = sourceFrame && typeof sourceFrame === "object" ? sourceFrame : null;
      const resolvedOperationFrame = operationFrame && typeof operationFrame === "object" ? operationFrame : null;
      const parsedVerb = resolvedSourceFrame?.parsedVerbSnapshot || null;
      if (!resolvedSourceFrame || resolvedSourceFrame.kind !== "root-plus-ya-adjectival-nnc-source-frame" || resolvedSourceFrame.displayStringsAuthorizeGrammar !== false || resolvedSourceFrame.consumesRenderedInput !== false) {
        return buildRootPlusYaAdjectivalNncUnsupportedOutput({
          ...
          sourceFrame: resolvedSourceFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-root-plus-ya-source-frame-required", "Root-plus-ya adjectival NNC generation requires a typed Andrews 40.9 source frame; rendered stem strings cannot authorize this route.")
        });
      }
      if (requestedState !== "absolutive") {
        return buildRootPlusYaAdjectivalNncUnsupportedOutput({
          ...
          requestedState,
          parsedVerb,
          rootPlusYaBase: resolvedSourceFrame.rootPlusYaBase,
          sourceFormationSubtype: resolvedSourceFrame.sourceFormationSubtype,
          sourceFrame: resolvedSourceFrame,
          operationFrame: resolvedOperationFrame,
      ...
      const rootPlusYaBase = resolvedSourceFrame.rootPlusYaBase;
      if (resolvedSourceFrame.sourceSupported !== true || !rootPlusYaBase) {
        const diagnosticId = resolvedSourceFrame.diagnosticId || ADJECTIVAL_NNC_DIAGNOSTIC_IDS.requiresRootPlusYa;
        const messageById = {
      ...
      if (!isRootPlusYaAdjectivalNncOperationFrame(resolvedOperationFrame, resolvedSourceFrame)) {
        return buildRootPlusYaAdjectivalNncUnsupportedOutput({
          stem,
          requestedState,
          parsedVerb,
          ...
          sourceFrame: resolvedSourceFrame,
          operationFrame: resolvedOperationFrame,
          diagnostic: buildAdjectivalNncDiagnostic("adjectival-nnc-root-plus-ya-operation-frame-required", "Root-plus-ya adjectival NNC generation requires the typed Andrews 40.9 operation frame; formula/display strings cannot substitute for it.")
        });
      }
      const formulaSlots = resolvedOperationFrame.targetFormulaSlots;
      const formulaEcho = buildAdjectivalNncFormulaEchoFromSlots(formulaSlots);
      const result = String(resolvedOperationFrame.targetSurface || "");
      const frame = buildRootPlusYaAdjectivalNncFunctionFrame({
        parsedVerb,
    ...
    Object.defineProperty(api, "LESSON40_ADJECTIVAL_NNC_VALIDATION_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_ADJECTIVAL_NNC_VALIDATION_REFS; },
    });
    Object.defineProperty(api, "LESSON40_ADJECTIVAL_NNC_PDF_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_ADJECTIVAL_NNC_PDF_REFS; },
    });
    Object.defineProperty(api, "LESSON40_ADJECTIVAL_NUCLEAR_CLAUSE_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_ADJECTIVAL_NUCLEAR_CLAUSE_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_EXCEPTIONAL_ADJECTIVAL_NNC_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_EXCEPTIONAL_ADJECTIVAL_NNC_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_NNC_VNC_AS_ADJECTIVE_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_NNC_VNC_AS_ADJECTIVE_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_DERIVED_NOUNSTEM_ADJECTIVE_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_DERIVED_NOUNSTEM_ADJECTIVE_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_NOMINALIZED_VNC_ADJECTIVE_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_NOMINALIZED_VNC_ADJECTIVE_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_CUSTOMARY_AGENTIVE_ADJECTIVE_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_CUSTOMARY_AGENTIVE_ADJECTIVE_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_CUSTOMARY_PATIENTIVE_ADJECTIVE_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_CUSTOMARY_PATIENTIVE_ADJECTIVE_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_PRETERIT_AGENTIVE_ADJECTIVE_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_PRETERIT_AGENTIVE_ADJECTIVE_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_OBSOLETE_PRETERIT_ADJECTIVE_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_OBSOLETE_PRETERIT_ADJECTIVE_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_SYNONYMOUS_PAIRS_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_SYNONYMOUS_PAIRS_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_SYNONYMOUS_TRIPLETS_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_SYNONYMOUS_TRIPLETS_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_PREDICATE_ADJECTIVE_SENTENCE_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_PREDICATE_ADJECTIVE_SENTENCE_FRAME; },
    });
    Object.defineProperty(api, "LESSON40_ADJECTIVAL_NNC_SUBSECTION_INVENTORY", {
        configurable: true,
        enumerable: true,
        get() { return LESSON40_ADJECTIVAL_NNC_SUBSECTION_INVENTORY; },
    });
    api.cloneAdjectivalNncLessonRecord = cloneAdjectivalNncLessonRecord;
    api.buildLesson41CompoundSourceObjectSlotOwnershipFrame = buildLesson41CompoundSourceObjectSlotOwnershipFrame;
    api.buildLesson41CompoundSourceRouteFrame = buildLesson41CompoundSourceRouteFrame;
    api.getLesson40AdjectivalNncSubsectionInventory = getLesson40AdjectivalNncSubsectionInventory;
    api.attachAdjectivalNncPursuitGrammarContract = attachAdjectivalNncPursuitGrammarContract;
    api.buildLesson40AdjectivalNncPursuitFrame = buildLesson40AdjectivalNncPursuitFrame;
    Object.defineProperty(api, "LESSON41_ADJECTIVAL_NNC_VALIDATION_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON41_ADJECTIVAL_NNC_VALIDATION_REFS; },
    });
    Object.defineProperty(api, "LESSON41_ADJECTIVAL_NNC_PDF_REFS", {
        configurable: true,
        enumerable: true,
        get() { return LESSON41_ADJECTIVAL_NNC_PDF_REFS; },
    });
    Object.defineProperty(api, "LESSON41_INTENSIFIED_ADJECTIVAL_NNC_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON41_INTENSIFIED_ADJECTIVAL_NNC_FRAME; },
    });
    Object.defineProperty(api, "LESSON41_COMPOUND_VERBSTEM_NOMINAL_EMBED_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON41_COMPOUND_VERBSTEM_NOMINAL_EMBED_FRAME; },
    });
    Object.defineProperty(api, "LESSON41_DENOMINAL_COMPOUND_NOUNSTEM_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON41_DENOMINAL_COMPOUND_NOUNSTEM_FRAME; },
    });
    Object.defineProperty(api, "LESSON41_ADJECTIVAL_EMBED_COMPOUND_NNC_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return LESSON41_ADJECTIVAL_EMBED_COMPOUND_NNC_FRAME; },
    });
    Object.defineProperty(api, "LESSON41_ADJECTIVAL_NNC_SUBSECTION_INVENTORY", {
        configurable: true,
        enumerable: true,
        get() { return LESSON41_ADJECTIVAL_NNC_SUBSECTION_INVENTORY; },
    });
    api.getLesson41AdjectivalNncSubsectionInventory = getLesson41AdjectivalNncSubsectionInventory;
    api.buildLesson41AdjectivalNncPursuitFrame = buildLesson41AdjectivalNncPursuitFrame;
    ...
    api.normalizeAdjectivalNncCandidateSurface = normalizeAdjectivalNncCandidateSurface;
    api.hasAdjectivalNncAndrewsSourceGate = hasAdjectivalNncAndrewsSourceGate;
    api.buildAdjectivalNncFunctionCandidateSourceFrame = buildAdjectivalNncFunctionCandidateSourceFrame;
    api.buildAdjectivalNncFunctionCandidateOperationFrame = buildAdjectivalNncFunctionCandidateOperationFrame;
    api.getAdjectivalNncFunctionCandidateOperationFrameMismatch = getAdjectivalNncFunctionCandidateOperationFrameMismatch;
    api.getAdjectivalNncFunctionCandidateBlockedDiagnostic = getAdjectivalNncFunctionCandidateBlockedDiagnostic;
    ...
    api.cloneAdjectivalNncSourceRouteFrame = cloneAdjectivalNncSourceRouteFrame;
    api.resolveAdjectivalNncSourceRouteFrame = resolveAdjectivalNncSourceRouteFrame;
    ...
    api.buildAdjectivalNncFormulaSurfacePairs = buildAdjectivalNncFormulaSurfacePairs;
    api.buildAdjectivalNncFormulaSurfacePairFields = buildAdjectivalNncFormulaSurfacePairFields;
    ...
    api.buildAdjectivalNncFormulaRealizationSegmentFrames = buildAdjectivalNncFormulaRealizationSegmentFrames;
    api.buildAdjectivalNncCanonicalFormulaRecordBundle = buildAdjectivalNncCanonicalFormulaRecordBundle;
    api.buildRootPlusYaAdjectivalNncFormulaSlots = buildRootPlusYaAdjectivalNncFormulaSlots;
    api.buildRootPlusYaAdjectivalNncSubjectFrame = buildRootPlusYaAdjectivalNncSubjectFrame;
    api.buildRootPlusYaAdjectivalNncSourceFrame = buildRootPlusYaAdjectivalNncSourceFrame;
    api.buildRootPlusYaAdjectivalNncOperationFrame = buildRootPlusYaAdjectivalNncOperationFrame;
    api.isRootPlusYaAdjectivalNncOperationFrame = isRootPlusYaAdjectivalNncOperationFrame;
    api.buildIntensifiedAdjectivalNncFormulaSlots = buildIntensifiedAdjectivalNncFormulaSlots;
    api.buildIntensifiedAdjectivalStemFromFormulaSlot = buildIntensifiedAdjectivalStemFromFormulaSlot;
    api.buildIntensifiedAdjectivalNncOperationFrame = buildIntensifiedAdjectivalNncOperationFrame;
    api.isIntensifiedAdjectivalNncOperationFrame = isIntensifiedAdjectivalNncOperationFrame;
    ...
    api.getDenominalCompoundAdjectivalNncSourceSurface = getDenominalCompoundAdjectivalNncSourceSurface;
    api.buildDenominalCompoundAdjectivalNncObjectSlotOwnershipFrame = buildDenominalCompoundAdjectivalNncObjectSlotOwnershipFrame;
    api.buildDenominalCompoundAdjectivalNncRouteFrame = buildDenominalCompoundAdjectivalNncRouteFrame;
    ...
    api.isAdjectivalNncGeneratedOutputTypedContinuationFrame = isAdjectivalNncGeneratedOutputTypedContinuationFrame;
    api.getStructuredOrdinaryAdjectivalNncSourceFormulaSlots = getStructuredOrdinaryAdjectivalNncSourceFormulaSlots;
    api.buildStructuredOrdinaryAdjectivalNncOperationFrame = buildStructuredOrdinaryAdjectivalNncOperationFrame;
    api.realizeStructuredOrdinaryAdjectivalNncSurfaceFromSlots = realizeStructuredOrdinaryAdjectivalNncSurfaceFromSlots;
    api.getAdjectivalNncTypedFrameRealizationSurfaces = getAdjectivalNncTypedFrameRealizationSurfaces;
    api.getStructuredOrdinaryAdjectivalNncTargetOperationFrame = getStructuredOrdinaryAdjectivalNncTargetOperationFrame;
    api.isStructuredOrdinaryAdjectivalNncTargetOperationFrame = isStructuredOrdinaryAdjectivalNncTargetOperationFrame;
    api.buildVncAdjectivalNncOperationFrame = buildVncAdjectivalNncOperationFrame;
    api.getVncAdjectivalNncTargetOperationFrame = getVncAdjectivalNncTargetOperationFrame;
    api.isVncAdjectivalNncOperationFrame = isVncAdjectivalNncOperationFrame;
    api.buildPatientivoAdjectivalNncOperationFrame = buildPatientivoAdjectivalNncOperationFrame;
    api.getPatientivoAdjectivalNncTargetOperationFrame = getPatientivoAdjectivalNncTargetOperationFrame;
    api.isPatientivoAdjectivalNncOperationFrame = isPatientivoAdjectivalNncOperationFrame;
    api.buildCompoundSourceAdjectivalNncOperationFrame = buildCompoundSourceAdjectivalNncOperationFrame;
    api.getCompoundSourceAdjectivalNncTargetOperationFrame = getCompoundSourceAdjectivalNncTargetOperationFrame;
    api.isCompoundSourceAdjectivalNncOperationFrame = isCompoundSourceAdjectivalNncOperationFrame;
    api.buildDenominalCompoundAdjectivalNncOperationFrame = buildDenominalCompoundAdjectivalNncOperationFrame;
    api.getDenominalCompoundAdjectivalNncTargetOperationFrame = getDenominalCompoundAdjectivalNncTargetOperationFrame;
    api.isDenominalCompoundAdjectivalNncOperationFrame = isDenominalCompoundAdjectivalNncOperationFrame;
    api.buildNominalizedVncAdjectivalNncOperationFrame = buildNominalizedVncAdjectivalNncOperationFrame;
    api.getNominalizedVncAdjectivalNncTargetOperationFrame = getNominalizedVncAdjectivalNncTargetOperationFrame;
    api.isNominalizedVncAdjectivalNncOperationFrame = isNominalizedVncAdjectivalNncOperationFrame;
    api.buildStructuredOrdinaryAdjectivalNncUnsupportedOutput = buildStructuredOrdinaryAdjectivalNncUnsupportedOutput;
    api.buildStructuredOrdinaryAdjectivalNncFunctionOutput = buildStructuredOrdinaryAdjectivalNncFunctionOutput;
...
export function installAdjectivalNncGlobals(targetObject = globalThis) {
    const api = createAdjectivalNncModule(targetObject);
