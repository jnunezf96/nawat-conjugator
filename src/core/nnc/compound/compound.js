...
const LESSON31_COMPOUND_NOUNSTEM_SUBSECTION_INVENTORY = Object.freeze([
    ...
    Object.freeze({ id: "lesson31-examples", andrewsSection: "31.5", category: "embed-class-examples", directiveEs: "Los ejemplos separan incrustados tli/in/cero, ti subclase 1 y ti subclase 2, con irregularidades ortograficas.", engineSurface: "diagnostic example-class frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson31-unique-fillers", andrewsSection: "31.6", category: "unique-compound-fillers", directiveEs: "Algunos troncos solo aparecen como fillers de incrustado o matriz; ca y yo son matrices prolificas especiales.", engineSurface: "diagnostic unique-filler frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    ...
    Object.freeze({ id: "lesson31-sex-distinction", andrewsSection: "31.9", category: "sex-distinction-compound", directiveEs: "Un nombre animado puede incorporar oquich o cihua para distinguir sexo.", engineSurface: "diagnostic special-function frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson31-progeny", andrewsSection: "31.10", category: "progeny-compound", directiveEs: "Cone o pilton como matriz pueden marcar progenie animal; cone humano tiene restriccion propia.", engineSurface: "diagnostic special-function frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson31-fellowship", andrewsSection: "31.11", category: "fellowship-compound", directiveEs: "Poh puede servir como matriz en CNN posesivas de compania, igualdad o parentesco.", engineSurface: "diagnostic special-function frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
...
const LESSON32_AFFECTIVE_NNC_SUBSECTION_INVENTORY = Object.freeze([
    ...
    Object.freeze({ id: "lesson32-pil-pol", andrewsSection: "32.2", category: "zero-class-affective-matrix", directiveEs: "Pil y pol forman matrices afectivas de clase cero, salvo lexicalizacion especial.", engineSurface: "diagnostic zero-class affective frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson32-tzin-ton", andrewsSection: "32.3", category: "class-dependent-affective-matrix", directiveEs: "Tzin y ton dejan que la clase del incrustado determine cero o tli, con usos vocativos e irregulares.", engineSurface: "diagnostic class-dependent affective frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
    Object.freeze({ id: "lesson32-zol", andrewsSection: "32.4", category: "tli-class-affective-matrix", directiveEs: "Zol forma tli con incrustados no animados y puede alimentar compuestos o rutas denominales.", engineSurface: "diagnostic zol frame", implementationState: "partial", redirectAction: "needs-nawat-evidence" }),
...
function buildLesson31CompoundNounstemPursuitFrame() {
    ...
    const remainingGaps = [
        ...
        "Confirmed Nawat/Pipil compound nounstem examples and orthographic exceptions remain evidence-needed.",
    ];
    const frame = {
...
function buildLesson32AffectiveNncPursuitFrame() {
    ...
    const remainingGaps = [
        "Current compound/affective NNC metadata is not an affective NNC generator.",
        "Affective matrix class routing for pil/pol/tzin/ton/zol and lexicalized class shifts need confirmed Nawat/Pipil evidence.",
        "Affinity-shaped affective stems, pil child/noble ambiguity, nonanimate number behavior, and flawed-subject num1 silencing need explicit route gates.",
        "Confirmed Nawat/Pipil affective examples, flawed-subject examples, and orthographic exceptions remain evidence-needed.",
    ];
    const frame = {
