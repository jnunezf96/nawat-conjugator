...
export function createParticlesApi(targetObject = globalThis) {
    ...
    const PARTICLE_FUNCTION_CLASS_FRAME = Object.freeze([Object.freeze({
    ...
    const PARTICLE_LESSON3_SEED_SOURCE_ENTRIES = Object.freeze([Object.freeze({
      id: "l3-ca",
      sourceForm: "ca",
      functionScope: PARTICLE_FUNCTION_SCOPE.clauseIntroducer,
      placementScope: PARTICLE_PLACEMENT_SCOPE.clauseInitial,
      gloss: "en verdad; de hecho",
      section: "3.2.1",
      priority: 10
    }), Object.freeze({
      id: "l3-cuix",
      ...
      id: "l3-in",
      sourceForm: "in",
      functionScope: PARTICLE_FUNCTION_SCOPE.adjunctor,
      placementScope: PARTICLE_PLACEMENT_SCOPE.clauseInitial,
      gloss: "introductor de unidad adjunta",
      section: "3.2.2",
      priority: 20
    }), Object.freeze({
      id: "l3-anca",
      ...
      functionScope: PARTICLE_FUNCTION_SCOPE.adjunctor,
      placementScope: PARTICLE_PLACEMENT_SCOPE.clauseInitial,
      gloss: "por tanto; en consecuencia",
      section: "3.2.2",
      priority: 21
    }), Object.freeze({
      id: "l3-mah",
      ...
      functionScope: PARTICLE_FUNCTION_SCOPE.adjunctor,
      placementScope: PARTICLE_PLACEMENT_SCOPE.clauseInitial,
      gloss: "como si; de tal modo que",
      section: "3.2.2",
      priority: 22
    }), Object.freeze({
      id: "l3-auh-conjunctor",
      sourceForm: "auh",
      functionScope: PARTICLE_FUNCTION_SCOPE.conjunctor,
      placementScope: PARTICLE_PLACEMENT_SCOPE.clauseInitial,
      gloss: "y; pero",
      section: "3.2.3",
      priority: 30
      ...
      id: "l3-mec",
      sourceForm: "mec",
      functionScope: PARTICLE_FUNCTION_SCOPE.adverbialModifier,
      placementScope: PARTICLE_PLACEMENT_SCOPE.floating,
      gloss: "entonces",
      section: "3.2.4",
      priority: 40
    }), Object.freeze({
      ...
      sourceForm: "o#",
      functionScope: PARTICLE_FUNCTION_SCOPE.adverbialModifier,
      placementScope: PARTICLE_PLACEMENT_SCOPE.boundToFollowing,
      gloss: "partícula de orden antecesivo",
      section: "3.2.4",
      priority: 47
    }), Object.freeze({
      id: "l3-no-adverbial",
      ...
      functionScope: PARTICLE_FUNCTION_SCOPE.adverbialModifier,
      placementScope: PARTICLE_PLACEMENT_SCOPE.floating,
      gloss: "variante de quizá; tal vez",
      section: "3.2.4",
      priority: 53
    }), Object.freeze({
      ...
      aliases: ["e"],
      functionScope: PARTICLE_FUNCTION_SCOPE.interjection,
      placementScope: PARTICLE_PLACEMENT_SCOPE.boundToPrevious,
      gloss: "vocativo",
      section: "3.2.5",
      priority: 60
    }), Object.freeze({
      ...
      id: "l3-ah-negative",
      sourceForm: "ah#",
      functionScope: PARTICLE_FUNCTION_SCOPE.negation,
      placementScope: PARTICLE_PLACEMENT_SCOPE.boundToFollowing,
      gloss: "no",
      section: "3.3",
      priority: 80
      ...
      functionScope: PARTICLE_FUNCTION_SCOPE.negation,
      placementScope: PARTICLE_PLACEMENT_SCOPE.boundToFollowing,
      gloss: "no después de ma/tla/mah",
      section: "3.3",
      priority: 81
    }), Object.freeze({
      id: "l3-ahzo",
      ...
      id: "l3-ahza-zo-oc",
      sourceForm: "ahza zo oc",
      functionScope: PARTICLE_FUNCTION_SCOPE.collocation,
      placementScope: PARTICLE_PLACEMENT_SCOPE.collocationSequence,
      gloss: "quizá todavía; quizá otro",
      section: "3.4",
      priority: 112
    }), Object.freeze({
      id: "l3-ma-za-zo",
      ...
      functionScope: PARTICLE_FUNCTION_SCOPE.collocation,
      placementScope: PARTICLE_PLACEMENT_SCOPE.collocationSequence,
      gloss: "de cualquier modo; tontamente; sin sentido",
      section: "3.4",
      priority: 114
    }), Object.freeze({
      id: "l3-zan-no",
      ...
      functionScope: PARTICLE_FUNCTION_SCOPE.collocation,
      placementScope: PARTICLE_PLACEMENT_SCOPE.collocationSequence,
      gloss: "aún más; además",
      section: "3.4",
      priority: 122
    }), Object.freeze({
      id: "l3-auh-in-tla",
      sourceForm: "auh in tla",
      functionScope: PARTICLE_FUNCTION_SCOPE.collocation,
      placementScope: PARTICLE_PLACEMENT_SCOPE.collocationSequence,
      gloss: "y si",
      section: "3.4",
      ...
      id: "l3-ma-zo-tel",
      sourceForm: "ma zo tel",
      functionScope: PARTICLE_FUNCTION_SCOPE.collocation,
      placementScope: PARTICLE_PLACEMENT_SCOPE.collocationSequence,
      gloss: "suponiendo que",
      section: "3.4",
      priority: 127
    }), Object.freeze({
      id: "l3-ihyo-ma",
      ...
      id: "l3-ihyo-iyahua",
      sourceForm: "ihyo iyahua!",
      functionScope: PARTICLE_FUNCTION_SCOPE.collocation,
      placementScope: PARTICLE_PLACEMENT_SCOPE.collocationSequence,
      gloss: "¡ay de mí!; ¡qué desgracia!",
      section: "3.4",
      priority: 129
    }), Object.freeze({
      id: "l3-ahca-zo",
      ...
      id: "l3-otzin",
      sourceForm: "otzin",
      functionScope: PARTICLE_FUNCTION_SCOPE.honorificized,
      placementScope: PARTICLE_PLACEMENT_SCOPE.floating,
      gloss: "mira; he aquí",
      section: "3.5",
      priority: 130
    ...
    function normalizeParticleInventoryLookupValue(value = "") {
      return String(value == null ? "" : value).trim().toLowerCase().replace(/[¡!]/g, "").replace(/\u2026/g, "...").replace(/\s+/g, " ");
    }
    function getAndrewsLesson3ParticleAsNawat(value = "") {
      ...
      const converter = typeof targetObject.getClassicalLettersAsNawat === "function" ? targetObject.getClassicalLettersAsNawat : typeof globalThis !== "undefined" && typeof globalThis.getClassicalLettersAsNawat === "function" ? globalThis.getClassicalLettersAsNawat : null;
    ...
    function attachParticleSeedInventoryEntryGrammarContract(entry = {}) {
      ...
      const diagnostics = Array.isArray(entry.diagnostics) && entry.diagnostics.length ? entry.diagnostics : ["particle-seed-inventory-entry", "particle-orthography-adapted", "particle-generation-disabled"];
    ...
    function buildParticleSeedInventoryEntry(sourceEntry = {}) {
      ...
      const aliases = [sourceForm, nawatForm, ...(Array.isArray(sourceEntry.aliases) ? sourceEntry.aliases : []), ...(Array.isArray(sourceEntry.aliases) ? sourceEntry.aliases.map(getAndrewsLesson3ParticleAsNawat) : [])].map(entry => String(entry || "").trim()).filter(Boolean).filter((entry, index, list) => list.indexOf(entry) === index);
      const lookupKeys = aliases.flatMap(entry => {
      ...
      const entry = {
        ...
        generationAllowed: false,
        diagnostics: ["particle-seed-inventory-entry", "particle-orthography-adapted", "particle-generation-disabled"],
        orthography: {
    ...
    function getParticleSeedInventoryEntries({
      ...
      const entries = PARTICLE_LESSON3_SEED_SOURCE_ENTRIES.map(buildParticleSeedInventoryEntry).filter(entry => !normalizedFunctionScope || entry.functionScope === normalizedFunctionScope).sort((a, b) => a.priority - b.priority || a.id.localeCompare(b.id));
    ...
    function cloneParticleInventoryGroup(group = {}) {
      return {
        ...
        entries: Array.isArray(group.entries) ? group.entries.map(cloneParticleSeedInventoryEntry) : []
      };
    }
    function getParticleLesson3InventoryGroups({
      ...
      const entries = getParticleSeedInventoryEntries().filter(entry => !normalizedExcludeEntryId || entry.id !== normalizedExcludeEntryId);
      return PARTICLE_LESSON3_INVENTORY_GROUPS.map(group => {
        const groupedEntries = entries.filter(entry => group.sectionPrefix && String(entry.section || "").startsWith(group.sectionPrefix));
    ...
    function findParticleSeedInventoryEntries(value = "") {
      ...
      return getParticleSeedInventoryEntries().filter(entry => entry.lookupKeys.includes(lookupKey) || entry.lookupKeys.includes(noQuestionKey));
    }
    function getParticleInventoryPreviewEntries({
      ...
      const normalizedFunctionScope = functionScope ? normalizeParticleFunctionScope(functionScope) : "";
      const baseEntries = getParticleSeedInventoryEntries({
        functionScope: normalizedFunctionScope
      });
      const prioritized = [matchedEntry, ...baseEntries].filter(Boolean).filter((entry, index, list) => list.findIndex(candidate => candidate.id === entry.id) === index);
    ...
    function inferParticleCandidateProfile(candidate = "") {
      ...
      const placementScope = isStemSyntax ? PARTICLE_PLACEMENT_SCOPE.unknown : hasLeftBoundary ? PARTICLE_PLACEMENT_SCOPE.boundToPrevious : hasRightBoundary ? PARTICLE_PLACEMENT_SCOPE.boundToFollowing : isCollocation ? PARTICLE_PLACEMENT_SCOPE.collocationSequence : PARTICLE_PLACEMENT_SCOPE.floating;
      const functionScope = isStemSyntax ? PARTICLE_FUNCTION_SCOPE.unknown : isCollocation ? PARTICLE_FUNCTION_SCOPE.collocation : PARTICLE_FUNCTION_SCOPE.unknown;
      return {
        raw,
        bare,
        tokens,
        ...
        boundaryMarker: hasLeftBoundary ? "left-bound-to-previous" : hasRightBoundary ? "right-bound-to-following" : "",
        placementScope,
        functionScope
      };
    }
    ...
    function classifyParticleCandidate(value = "", options = {}) {
      ...
      const outOfScopeReason = !matched && inferred.isStemSyntax ? "stem-or-nuclear-clause-syntax" : "";
      const diagnostics = matched ? ["particle-candidate-andrews-derived", "particle-orthography-adapted", "particle-generation-disabled"] : candidate ? outOfScopeReason ? ["particle-candidate-stem-syntax", "particle-mode-not-vnc-or-nnc", "particle-generation-disabled"] : ["particle-candidate-unconfirmed"] : ["particle-candidate-empty"];
    ...
    function buildParticleInventoryBoundaryMetadata() {
      ...
      const previewEntries = getParticleSeedInventoryEntries({
        limit: PARTICLE_INVENTORY_PREVIEW_LIMIT
      });
      const boundary = {
        ...
        boundaries: {
          ...
          hasVisibleParticleMode: typeof targetObject.document !== "undefined" ? !Boolean(targetObject.document.getElementById("calc-nawat-mode-particle")?.disabled) : false,
          existingParticleModeIsPlaceholder: typeof targetObject.document !== "undefined" ? Boolean(targetObject.document.getElementById("calc-nawat-mode-particle")?.disabled) : true
        },
        antiConflationRules: getParticleAntiConflationRules()
      };
    ...
    function buildParticleModeDisplayModel({
      ...
      const isOutOfScopeStemSyntax = classification.status === "out-of-scope" && classification.outOfScopeReason === "stem-or-nuclear-clause-syntax";
      ...
      const model = {
        ...
        unitProfile: {
          ...
          nuclearClauseKind: isOutOfScopeStemSyntax ? "stem-or-nuclear-clause-syntax" : "not-vnc-or-nnc",
        ...
        rows: [{
          ...
          detail: isOutOfScopeStemSyntax ? "la sintaxis con paréntesis pertenece a tallo/CN, no a Lesson 3 Partículas" : "léxico menor, invariante y sin estructura morfológica interna"
        }, {
          id: "candidate",
          label: "Candidata",
          value: candidateDisplay,
          detail: seedEntry ? `Andrews ${seedEntry.section}; fuente ${seedEntry.sourceForm}; ortografía adaptada` : isOutOfScopeStemSyntax ? "tallo o cláusula nuclear detectada; Andrews Lección 3 no la clasifica como partícula" : candidateProfile.isEmpty ? "ingresa una forma para clasificarla" : "forma no encontrada en la transferencia Andrews Lección 3"
        }, {
          id: "placement",
          label: "Posición",
          value: isOutOfScopeStemSyntax ? "fuera de Partícula" : classification.placement?.label || "unknown",
          detail: isOutOfScopeStemSyntax ? "los paréntesis marcan un tallo/predicado para otro modo" : `capa: ${classification.placement?.hostLayer || "unknown"}`
        }, {
          id: "function",
          label: "Función",
          value: isOutOfScopeStemSyntax ? "no partícula" : classification.functionClass?.label || classification.functionScope || "unknown",
          detail: seedEntry?.gloss ? `${seedEntry.gloss}; clase Andrews transferida` : isOutOfScopeStemSyntax ? "Lección 3 cubre partículas, negativas, colocaciones e interjecciones; no tallos verbales" : "clase Andrews estructural; no evidencia lexical Nawat"
        }, {
          id: "boundary",
          label: "Límite",
          value: "sin generación",
          detail: seedEntry ? "transferencia Andrews con ortografía Nawat; no VNC, no CNN/NNC" : isOutOfScopeStemSyntax ? "Partícula no analiza ni genera tallos entre paréntesis" : "no VNC, no CNN/NNC, no inventario confirmado"
        }],
        diagnostics: [...(classification.diagnostics || []), "particle-mode-diagnostic-only", "particle-mode-no-generation"],
        generationAllowed: false,
        antiConflationRules: getParticleAntiConflationRules()
      };
      return attachParticleGrammarContract(model, {
        ...
        surfaceForms: seedEntry?.displayForm ? [seedEntry.displayForm] : [],
        supported: false,
        evidenceStatus: seedEntry ? "andrews-orthography-adapted" : isOutOfScopeStemSyntax ? "not-particle-syntax" : "diagnostic-only",
        diagnostics: model.diagnostics,
        orthographyFrame: seedEntry?.orthography || null,
        nuclearClauseFrame: {
          clauseKind: isOutOfScopeStemSyntax ? "nuclear-clause-or-stem-syntax" : "not-a-nuclear-clause",
          particleMode: true,
    ...
    Object.defineProperty(api, "PARTICLE_FUNCTION_CLASS_FRAME", {
        configurable: true,
        enumerable: true,
        get() { return PARTICLE_FUNCTION_CLASS_FRAME; },
    });
    ...
    Object.defineProperty(api, "PARTICLE_LESSON3_INVENTORY_GROUPS", {
        configurable: true,
        enumerable: true,
        get() { return PARTICLE_LESSON3_INVENTORY_GROUPS; },
    });
    Object.defineProperty(api, "PARTICLE_LESSON3_SEED_SOURCE_ENTRIES", {
        configurable: true,
        enumerable: true,
        get() { return PARTICLE_LESSON3_SEED_SOURCE_ENTRIES; },
    });
    Object.defineProperty(api, "PARTICLE_INVENTORY_PREVIEW_LIMIT", {
        configurable: true,
        enumerable: true,
        get() { return PARTICLE_INVENTORY_PREVIEW_LIMIT; },
    });
    ...
    api.cloneParticleFunctionClassFrame = cloneParticleFunctionClassFrame;
    ...
    api.getParticleFunctionClassFrames = getParticleFunctionClassFrames;
    ...
    api.getParticleFunctionClassFrame = getParticleFunctionClassFrame;
    api.normalizeParticleInventoryLookupValue = normalizeParticleInventoryLookupValue;
    api.getAndrewsLesson3ParticleAsNawat = getAndrewsLesson3ParticleAsNawat;
    api.cloneParticleSeedInventoryEntry = cloneParticleSeedInventoryEntry;
    api.attachParticleSeedInventoryEntryGrammarContract = attachParticleSeedInventoryEntryGrammarContract;
    api.buildParticleSeedInventoryEntry = buildParticleSeedInventoryEntry;
    api.getParticleSeedInventoryEntries = getParticleSeedInventoryEntries;
    api.cloneParticleInventoryGroup = cloneParticleInventoryGroup;
    api.getParticleLesson3InventoryGroups = getParticleLesson3InventoryGroups;
    api.findParticleSeedInventoryEntries = findParticleSeedInventoryEntries;
    api.getParticleInventoryPreviewEntries = getParticleInventoryPreviewEntries;
    api.inferParticleCandidateProfile = inferParticleCandidateProfile;
    ...
    api.buildParticleModeDisplayModel = buildParticleModeDisplayModel;
    api.installParticleClassicGlobals = installParticleClassicGlobals;
    return api;
}
