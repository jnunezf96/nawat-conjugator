...
const LESSON27_FREQUENTATIVE_VALIDATION_REFS = Object.freeze([
    "src/tests/frequentative.test.js",
    "src/tests/registry.test.js",
    "docs/GRAMMAR_SPEC.md",
]);

const LESSON27_FREQUENTATIVE_PDF_REFS = Object.freeze([
    "Andrews Lesson 27.1",
    "Andrews Lesson 27.2",
    "Andrews Lesson 27.3",
    "Andrews Lesson 27.4",
...
function cloneFrequentativeLessonRecord(record) {
    ...
    return Object.fromEntries(
        Object.entries(record).map(([key, value]) => [key, cloneFrequentativeLessonRecord(value)])
    );
}
