...
const records = [
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "layer4_legitimate",
        purpose: "Decides the preposed 'ma ' particle for optatives and possessive-prefix selection, then delegates to buildOutputWordText.",
        current_inputs: "subjectPrefix, objectPrefix, subjectSuffix, verb, directionalChainMeta, surfaceRuleMeta, isYawiOptative",
    ...
    },
    {
        ...
        current_inputs: "subjectPrefix, objectPrefix, subjectSuffix, verb, formSpec, isYawiOptative, directionalChainMeta, surfaceRuleMeta",
        current_output: "string",
        grammatical_decision_inside: false,
        string_ops_outside_gate: false,
        recommended_action: "keep_as_is",
    ...
    // -----------------------------------------------------------------------
    {
        ...
        current_output: "null | { subjectPrefix, objectPrefix, subjectSuffix, verb, formSpec, alternateForms, directionalChainMeta, surfaceRuleMeta, isYawiOptative }",
        grammatical_decision_inside: true,
        string_ops_outside_gate: false,
        recommended_action: "keep_as_is",
