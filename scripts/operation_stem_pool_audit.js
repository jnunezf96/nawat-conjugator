...
const POOL_FAMILIES = [
    {
        id: "pf-01",
        name: "causativeAllStems / causativeAllStemSpecs",
        ...
        element_type: "string[] (causativeAllStems) + MorphStemSpec[] (causativeAllStemSpecs)",
        has_spec_parallel: true,
        spec_field: "causativeAllStemSpecs",
    ...
    {
        id: "pf-02",
        name: "applicativeAllStems / applicativeAllStemSpecs",
        source: "applySelectedForwardDerivation → runForwardDerivation → applyApplicativeDerivation",
        location: "script.js:20409 / script.js:20427",
        element_type: "string[] (applicativeAllStems) + MorphStemSpec[] (applicativeAllStemSpecs)",
        has_spec_parallel: true,
        spec_field: "applicativeAllStemSpecs",
        prefixing_applied: "none — raw derivation output stems",
        morphology_context_encoded: false,
        notes: "Same pattern as pf-01. applicativeAllStemSpecs now threads through the generate pipeline alongside applicativeAllStems. resolveStemCollectionPool prefers specs when available.",
    },
    {
        id: "pf-03",
...
const PRODUCER_STAGES = [
    {
        ...
        information_loss: "none — both stemsKey and stemSpecsKey results are now forwarded through the full generate pipeline",
    ...
    },
    {
        ...
        information_loss: "none — causativeAllStemSpecs / applicativeAllStemSpecs are now consumed and preferred when non-empty; string arrays remain as fallback",
        recommended_action: "no_change_needed",
...
const RECOMMENDATION = {
    ...
    next_tranche_scope: [
        "no further pool architecture work required",
        "future: upstream derivation redesign if stemCollectionPool construction itself needs to move earlier in the pipeline",
    ],
};
...
console.log(`\nForward spec promotion: RESOLVED`);
console.log(`  Pool is uniformly spec-first. No further pool architecture work required.\n`);
